...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlenetappkmsconfig"
...
&googlenetappkmsconfig.GoogleNetappKmsconfigConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleNetappKmsconfig.GoogleNetappKmsconfigTimeouts,
}
```
