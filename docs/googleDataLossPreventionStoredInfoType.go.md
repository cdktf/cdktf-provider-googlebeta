...
&googledatalosspreventionstoredinfotype.GoogleDataLossPreventionStoredInfoTypeDictionary {
	...
	WordList: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleDataLossPreventionStoredInfoType.GoogleDataLossPreventionStoredInfoTypeDictionaryWordListStruct,
}
```
