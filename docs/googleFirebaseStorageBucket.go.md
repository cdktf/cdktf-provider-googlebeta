...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlefirebasestoragebucket"
...
&googlefirebasestoragebucket.GoogleFirebaseStorageBucketConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleFirebaseStorageBucket.GoogleFirebaseStorageBucketTimeouts,
}
```
