...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlespannerinstanceconfig"
...
&googlespannerinstanceconfig.GoogleSpannerInstanceConfigAConfig {
	...
	Name: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleSpannerInstanceConfig.GoogleSpannerInstanceConfigTimeouts,
}
```
