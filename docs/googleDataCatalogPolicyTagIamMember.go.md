...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googledatacatalogpolicytagiammember"
...
&googledatacatalogpolicytagiammember.GoogleDataCatalogPolicyTagIamMemberConfig {
	...
	PolicyTag: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleDataCatalogPolicyTagIamMember.GoogleDataCatalogPolicyTagIamMemberCondition,
	Id: *string,
}
```
