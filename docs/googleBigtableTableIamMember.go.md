...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlebigtabletableiammember"
...
&googlebigtabletableiammember.GoogleBigtableTableIamMemberConfig {
	...
	Role: *string,
	Table: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleBigtableTableIamMember.GoogleBigtableTableIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
