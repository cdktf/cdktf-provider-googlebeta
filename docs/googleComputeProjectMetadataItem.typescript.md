...
```typescript
public readonly timeoutsInput: GoogleComputeProjectMetadataItemTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-google-beta.googleComputeProjectMetadataItem.GoogleComputeProjectMetadataItemTimeouts">GoogleComputeProjectMetadataItemTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: GoogleComputeProjectMetadataItemTimeouts | IResolvable;
```
