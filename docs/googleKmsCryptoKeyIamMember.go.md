...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlekmscryptokeyiammember"
...
&googlekmscryptokeyiammember.GoogleKmsCryptoKeyIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleKmsCryptoKeyIamMember.GoogleKmsCryptoKeyIamMemberCondition,
	Id: *string,
}
```
