...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googleendpointsserviceiambinding"
...
| <code><a href="#@cdktf/provider-google-beta.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBinding.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googleendpointsserviceiambinding.GoogleEndpointsServiceIamBindingConfig {
	...
	Role: *string,
	ServiceName: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingCondition,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
