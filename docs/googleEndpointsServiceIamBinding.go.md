...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleendpointsserviceiambinding"
...
&googleendpointsserviceiambinding.GoogleEndpointsServiceIamBindingConfig {
	...
	Role: *string,
	ServiceName: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingCondition,
	Id: *string,
}
```
