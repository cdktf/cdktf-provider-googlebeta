...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleendpointsserviceiambinding"
...
&googleendpointsserviceiambinding.GoogleEndpointsServiceIamBindingConfig {
	...
	Role: *string,
	ServiceName: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingCondition,
	Id: *string,
}
```
