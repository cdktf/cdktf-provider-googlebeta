...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googleendpointsserviceiambinding"
...
&googleendpointsserviceiambinding.GoogleEndpointsServiceIamBindingConfig {
	...
	Role: *string,
	ServiceName: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingCondition,
	Id: *string,
}
```
