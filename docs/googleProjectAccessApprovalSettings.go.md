...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleprojectaccessapprovalsettings"
...
&googleprojectaccessapprovalsettings.GoogleProjectAccessApprovalSettingsConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleProjectAccessApprovalSettings.GoogleProjectAccessApprovalSettingsTimeouts,
}
```
