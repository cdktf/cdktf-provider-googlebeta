...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlecomputediskresourcepolicyattachment"
...
&googlecomputediskresourcepolicyattachment.GoogleComputeDiskResourcePolicyAttachmentConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleComputeDiskResourcePolicyAttachment.GoogleComputeDiskResourcePolicyAttachmentTimeouts,
	Zone: *string,
}
```
