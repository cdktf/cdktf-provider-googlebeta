...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googlecomputeroute"
...
&googlecomputeroute.GoogleComputeRouteConfig {
	...
	Project: *string,
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleComputeRoute.GoogleComputeRouteTimeouts,
}
```
