...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlespannerinstance"
...
&googlespannerinstance.GoogleSpannerInstanceConfig {
	...
	ProcessingUnits: *f64,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleSpannerInstance.GoogleSpannerInstanceTimeouts,
}
```
