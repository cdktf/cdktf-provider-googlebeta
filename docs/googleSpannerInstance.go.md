...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlespannerinstance"
...
&googlespannerinstance.GoogleSpannerInstanceConfig {
	...
	ProcessingUnits: *f64,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleSpannerInstance.GoogleSpannerInstanceTimeouts,
}
```
