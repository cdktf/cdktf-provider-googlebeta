...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlesqlsourcerepresentationinstance"
...
&googlesqlsourcerepresentationinstance.GoogleSqlSourceRepresentationInstanceConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleSqlSourceRepresentationInstance.GoogleSqlSourceRepresentationInstanceTimeouts,
	Username: *string,
}
```
