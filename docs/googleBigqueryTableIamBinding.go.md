...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlebigquerytableiambinding"
...
&googlebigquerytableiambinding.GoogleBigqueryTableIamBindingConfig {
	...
	Role: *string,
	TableId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleBigqueryTableIamBinding.GoogleBigqueryTableIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
