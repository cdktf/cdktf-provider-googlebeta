...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputebackendbucketsignedurlkey"
...
&googlecomputebackendbucketsignedurlkey.GoogleComputeBackendBucketSignedUrlKeyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputeBackendBucketSignedUrlKey.GoogleComputeBackendBucketSignedUrlKeyTimeouts,
}
```
