...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleresourcemanagerlien"
...
&googleresourcemanagerlien.GoogleResourceManagerLienConfig {
	...
	Restrictions: *[]*string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleResourceManagerLien.GoogleResourceManagerLienTimeouts,
}
```
