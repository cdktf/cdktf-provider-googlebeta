...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlechronicledataaccesslabel"
...
&googlechronicledataaccesslabel.GoogleChronicleDataAccessLabelConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleChronicleDataAccessLabel.GoogleChronicleDataAccessLabelTimeouts,
}
```
