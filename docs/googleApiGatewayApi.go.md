...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googleapigatewayapi"
...
&googleapigatewayapi.GoogleApiGatewayApiConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleApiGatewayApi.GoogleApiGatewayApiTimeouts,
}
```
