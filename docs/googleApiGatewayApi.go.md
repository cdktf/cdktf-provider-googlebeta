...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googleapigatewayapi"
...
&googleapigatewayapi.GoogleApiGatewayApiConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleApiGatewayApi.GoogleApiGatewayApiTimeouts,
}
```
