...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleapigatewayapi"
...
&googleapigatewayapi.GoogleApiGatewayApiConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleApiGatewayApi.GoogleApiGatewayApiTimeouts,
}
```
