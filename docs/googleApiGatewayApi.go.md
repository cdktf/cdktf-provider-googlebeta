...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleapigatewayapi"
...
&googleapigatewayapi.GoogleApiGatewayApiConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleApiGatewayApi.GoogleApiGatewayApiTimeouts,
}
```
