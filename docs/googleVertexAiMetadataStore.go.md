...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlevertexaimetadatastore"
...
&googlevertexaimetadatastore.GoogleVertexAiMetadataStoreConfig {
	...
	Description: *string,
	EncryptionSpec: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleVertexAiMetadataStore.GoogleVertexAiMetadataStoreEncryptionSpec,
	Id: *string,
	Name: *string,
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleVertexAiMetadataStore.GoogleVertexAiMetadataStoreTimeouts,
}
```
