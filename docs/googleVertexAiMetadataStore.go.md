...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlevertexaimetadatastore"
...
&googlevertexaimetadatastore.GoogleVertexAiMetadataStoreConfig {
	...
	Description: *string,
	EncryptionSpec: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleVertexAiMetadataStore.GoogleVertexAiMetadataStoreEncryptionSpec,
	Id: *string,
	Name: *string,
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleVertexAiMetadataStore.GoogleVertexAiMetadataStoreTimeouts,
}
```
