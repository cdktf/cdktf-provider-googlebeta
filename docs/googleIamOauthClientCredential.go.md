...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googleiamoauthclientcredential"
...
&googleiamoauthclientcredential.GoogleIamOauthClientCredentialConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleIamOauthClientCredential.GoogleIamOauthClientCredentialTimeouts,
}
```
