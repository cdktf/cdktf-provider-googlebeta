...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googleiapclient"
...
&googleiapclient.GoogleIapClientConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleIapClient.GoogleIapClientTimeouts,
}
```
