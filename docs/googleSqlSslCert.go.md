...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlesqlsslcert"
...
&googlesqlsslcert.GoogleSqlSslCertConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleSqlSslCert.GoogleSqlSslCertTimeouts,
}
```
