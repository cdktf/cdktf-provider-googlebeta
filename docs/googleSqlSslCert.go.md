...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlesqlsslcert"
...
&googlesqlsslcert.GoogleSqlSslCertConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleSqlSslCert.GoogleSqlSslCertTimeouts,
}
```
