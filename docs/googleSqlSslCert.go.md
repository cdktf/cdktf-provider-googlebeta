...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlesqlsslcert"
...
&googlesqlsslcert.GoogleSqlSslCertConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleSqlSslCert.GoogleSqlSslCertTimeouts,
}
```
