...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlesqlsslcert"
...
&googlesqlsslcert.GoogleSqlSslCertConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleSqlSslCert.GoogleSqlSslCertTimeouts,
}
```
