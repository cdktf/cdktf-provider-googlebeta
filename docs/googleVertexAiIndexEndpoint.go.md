...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlevertexaiindexendpoint"
...
&googlevertexaiindexendpoint.GoogleVertexAiIndexEndpointConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleVertexAiIndexEndpoint.GoogleVertexAiIndexEndpointTimeouts,
}
```
