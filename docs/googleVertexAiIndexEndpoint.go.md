...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlevertexaiindexendpoint"
...
&googlevertexaiindexendpoint.GoogleVertexAiIndexEndpointConfig {
	...
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleVertexAiIndexEndpoint.GoogleVertexAiIndexEndpointTimeouts,
}
```
