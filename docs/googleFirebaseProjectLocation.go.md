...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlefirebaseprojectlocation"
...
&googlefirebaseprojectlocation.GoogleFirebaseProjectLocationConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleFirebaseProjectLocation.GoogleFirebaseProjectLocationTimeouts,
}
```
