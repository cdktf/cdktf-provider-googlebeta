...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputemachineimageiambinding"
...
&googlecomputemachineimageiambinding.GoogleComputeMachineImageIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeMachineImageIamBinding.GoogleComputeMachineImageIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
