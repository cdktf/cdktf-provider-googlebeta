...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlepubsubschemaiambinding"
...
&googlepubsubschemaiambinding.GooglePubsubSchemaIamBindingConfig {
	...
	Role: *string,
	Schema: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googlePubsubSchemaIamBinding.GooglePubsubSchemaIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
