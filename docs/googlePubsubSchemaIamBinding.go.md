...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlepubsubschemaiambinding"
...
&googlepubsubschemaiambinding.GooglePubsubSchemaIamBindingConfig {
	...
	Role: *string,
	Schema: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googlePubsubSchemaIamBinding.GooglePubsubSchemaIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
