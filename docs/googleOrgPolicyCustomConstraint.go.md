...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleorgpolicycustomconstraint"
...
&googleorgpolicycustomconstraint.GoogleOrgPolicyCustomConstraintConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleOrgPolicyCustomConstraint.GoogleOrgPolicyCustomConstraintTimeouts,
}
```
