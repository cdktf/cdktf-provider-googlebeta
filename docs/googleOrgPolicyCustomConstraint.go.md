...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleorgpolicycustomconstraint"
...
&googleorgpolicycustomconstraint.GoogleOrgPolicyCustomConstraintConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleOrgPolicyCustomConstraint.GoogleOrgPolicyCustomConstraintTimeouts,
}
```
