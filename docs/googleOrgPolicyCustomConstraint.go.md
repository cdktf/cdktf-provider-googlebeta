...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleorgpolicycustomconstraint"
...
&googleorgpolicycustomconstraint.GoogleOrgPolicyCustomConstraintConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleOrgPolicyCustomConstraint.GoogleOrgPolicyCustomConstraintTimeouts,
}
```
