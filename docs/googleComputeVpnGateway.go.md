...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputevpngateway"
...
&googlecomputevpngateway.GoogleComputeVpnGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputeVpnGateway.GoogleComputeVpnGatewayTimeouts,
}
```
