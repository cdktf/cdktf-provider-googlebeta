...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlecomputevpngateway"
...
&googlecomputevpngateway.GoogleComputeVpnGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleComputeVpnGateway.GoogleComputeVpnGatewayTimeouts,
}
```
