...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlecomputeinstancegroupnamedport"
...
&googlecomputeinstancegroupnamedport.GoogleComputeInstanceGroupNamedPortAConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleComputeInstanceGroupNamedPort.GoogleComputeInstanceGroupNamedPortTimeouts,
	Zone: *string,
}
```
