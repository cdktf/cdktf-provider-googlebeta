...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlenetappbackuppolicy"
...
&googlenetappbackuppolicy.GoogleNetappBackupPolicyConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleNetappBackupPolicy.GoogleNetappBackupPolicyTimeouts,
}
```
