...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlefirebasedataconnectservice"
...
&googlefirebasedataconnectservice.GoogleFirebaseDataConnectServiceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleFirebaseDataConnectService.GoogleFirebaseDataConnectServiceTimeouts,
}
```
