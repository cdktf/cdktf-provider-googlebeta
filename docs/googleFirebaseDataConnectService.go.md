...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlefirebasedataconnectservice"
...
&googlefirebasedataconnectservice.GoogleFirebaseDataConnectServiceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleFirebaseDataConnectService.GoogleFirebaseDataConnectServiceTimeouts,
}
```
