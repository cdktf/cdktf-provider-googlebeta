...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlefirebasedataconnectservice"
...
&googlefirebasedataconnectservice.GoogleFirebaseDataConnectServiceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleFirebaseDataConnectService.GoogleFirebaseDataConnectServiceTimeouts,
}
```
