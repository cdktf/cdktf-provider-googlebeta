...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googleidentityplatformtenantoauthidpconfig"
...
googleidentityplatformtenantoauthidpconfig.GoogleIdentityPlatformTenantOauthIdpConfig_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
&googleidentityplatformtenantoauthidpconfig.GoogleIdentityPlatformTenantOauthIdpConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleIdentityPlatformTenantOauthIdpConfig.GoogleIdentityPlatformTenantOauthIdpConfigTimeouts,
}
```
