...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlehealthcareconsentstoreiambinding"
...
&googlehealthcareconsentstoreiambinding.GoogleHealthcareConsentStoreIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleHealthcareConsentStoreIamBinding.GoogleHealthcareConsentStoreIamBindingCondition,
	Id: *string,
}
```
