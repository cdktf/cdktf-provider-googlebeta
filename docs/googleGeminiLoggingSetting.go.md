...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlegeminiloggingsetting"
...
&googlegeminiloggingsetting.GoogleGeminiLoggingSettingConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingTimeouts,
}
```
