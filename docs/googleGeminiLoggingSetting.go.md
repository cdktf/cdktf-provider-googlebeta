...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlegeminiloggingsetting"
...
&googlegeminiloggingsetting.GoogleGeminiLoggingSettingConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingTimeouts,
}
```
