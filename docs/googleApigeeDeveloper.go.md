...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googleapigeedeveloper"
...
&googleapigeedeveloper.GoogleApigeeDeveloperConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleApigeeDeveloper.GoogleApigeeDeveloperTimeouts,
}
```
