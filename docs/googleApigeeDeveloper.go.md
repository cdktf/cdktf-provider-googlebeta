...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleapigeedeveloper"
...
&googleapigeedeveloper.GoogleApigeeDeveloperConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleApigeeDeveloper.GoogleApigeeDeveloperTimeouts,
}
```
