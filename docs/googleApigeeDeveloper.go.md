...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleapigeedeveloper"
...
&googleapigeedeveloper.GoogleApigeeDeveloperConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleApigeeDeveloper.GoogleApigeeDeveloperTimeouts,
}
```
