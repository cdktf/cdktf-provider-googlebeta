...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googleosloginsshpublickey"
...
&googleosloginsshpublickey.GoogleOsLoginSshPublicKeyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleOsLoginSshPublicKey.GoogleOsLoginSshPublicKeyTimeouts,
}
```
