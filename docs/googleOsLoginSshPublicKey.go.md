...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleosloginsshpublickey"
...
&googleosloginsshpublickey.GoogleOsLoginSshPublicKeyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleOsLoginSshPublicKey.GoogleOsLoginSshPublicKeyTimeouts,
}
```
