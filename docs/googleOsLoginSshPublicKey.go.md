...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleosloginsshpublickey"
...
&googleosloginsshpublickey.GoogleOsLoginSshPublicKeyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleOsLoginSshPublicKey.GoogleOsLoginSshPublicKeyTimeouts,
}
```
