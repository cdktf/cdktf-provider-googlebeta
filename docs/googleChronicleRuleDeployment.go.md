...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlechronicleruledeployment"
...
&googlechronicleruledeployment.GoogleChronicleRuleDeploymentConfig {
	...
	Project: *string,
	RunFrequency: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleChronicleRuleDeployment.GoogleChronicleRuleDeploymentTimeouts,
}
```
