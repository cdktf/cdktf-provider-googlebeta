...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlemonitoringgroup"
...
&googlemonitoringgroup.GoogleMonitoringGroupConfig {
	...
	ParentName: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleMonitoringGroup.GoogleMonitoringGroupTimeouts,
}
```
