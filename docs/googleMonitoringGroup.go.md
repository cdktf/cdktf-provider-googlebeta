...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlemonitoringgroup"
...
&googlemonitoringgroup.GoogleMonitoringGroupConfig {
	...
	ParentName: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleMonitoringGroup.GoogleMonitoringGroupTimeouts,
}
```
