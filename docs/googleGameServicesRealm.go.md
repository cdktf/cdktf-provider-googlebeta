...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlegameservicesrealm"
...
&googlegameservicesrealm.GoogleGameServicesRealmConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleGameServicesRealm.GoogleGameServicesRealmTimeouts,
}
```
