...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlegameservicesrealm"
...
&googlegameservicesrealm.GoogleGameServicesRealmConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleGameServicesRealm.GoogleGameServicesRealmTimeouts,
}
```
