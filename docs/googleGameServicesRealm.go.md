...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlegameservicesrealm"
...
&googlegameservicesrealm.GoogleGameServicesRealmConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleGameServicesRealm.GoogleGameServicesRealmTimeouts,
}
```
