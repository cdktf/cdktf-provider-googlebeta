...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleapigeeendpointattachment"
...
&googleapigeeendpointattachment.GoogleApigeeEndpointAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachmentTimeouts,
}
```
