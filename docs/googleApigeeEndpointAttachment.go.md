...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleapigeeendpointattachment"
...
&googleapigeeendpointattachment.GoogleApigeeEndpointAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachmentTimeouts,
}
```
