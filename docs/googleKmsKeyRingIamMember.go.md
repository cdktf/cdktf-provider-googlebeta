...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlekmskeyringiammember"
...
&googlekmskeyringiammember.GoogleKmsKeyRingIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMemberCondition,
	Id: *string,
}
```
