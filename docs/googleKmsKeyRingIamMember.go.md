...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlekmskeyringiammember"
...
&googlekmskeyringiammember.GoogleKmsKeyRingIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMemberCondition,
	Id: *string,
}
```
