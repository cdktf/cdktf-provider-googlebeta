...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlekmskeyringiammember"
...
&googlekmskeyringiammember.GoogleKmsKeyRingIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMemberCondition,
	Id: *string,
}
```
