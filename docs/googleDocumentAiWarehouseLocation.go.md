...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googledocumentaiwarehouselocation"
...
&googledocumentaiwarehouselocation.GoogleDocumentAiWarehouseLocationConfig {
	...
	Id: *string,
	KmsKey: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleDocumentAiWarehouseLocation.GoogleDocumentAiWarehouseLocationTimeouts,
}
```
