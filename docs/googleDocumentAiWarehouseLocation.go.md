...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googledocumentaiwarehouselocation"
...
&googledocumentaiwarehouselocation.GoogleDocumentAiWarehouseLocationConfig {
	...
	Id: *string,
	KmsKey: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleDocumentAiWarehouseLocation.GoogleDocumentAiWarehouseLocationTimeouts,
}
```
