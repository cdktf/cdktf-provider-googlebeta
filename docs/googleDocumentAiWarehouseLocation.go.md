...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googledocumentaiwarehouselocation"
...
&googledocumentaiwarehouselocation.GoogleDocumentAiWarehouseLocationConfig {
	...
	Id: *string,
	KmsKey: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleDocumentAiWarehouseLocation.GoogleDocumentAiWarehouseLocationTimeouts,
}
```
