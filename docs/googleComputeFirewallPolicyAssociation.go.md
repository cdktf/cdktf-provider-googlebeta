...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googlecomputefirewallpolicyassociation"
...
&googlecomputefirewallpolicyassociation.GoogleComputeFirewallPolicyAssociationConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleComputeFirewallPolicyAssociation.GoogleComputeFirewallPolicyAssociationTimeouts,
}
```
