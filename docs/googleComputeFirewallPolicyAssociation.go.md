...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlecomputefirewallpolicyassociation"
...
&googlecomputefirewallpolicyassociation.GoogleComputeFirewallPolicyAssociationConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleComputeFirewallPolicyAssociation.GoogleComputeFirewallPolicyAssociationTimeouts,
}
```
