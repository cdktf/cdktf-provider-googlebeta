...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlekmssecretciphertext"
...
&googlekmssecretciphertext.GoogleKmsSecretCiphertextConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextTimeouts,
}
```
