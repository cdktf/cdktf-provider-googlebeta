...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlekmssecretciphertext"
...
&googlekmssecretciphertext.GoogleKmsSecretCiphertextConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextTimeouts,
}
```
