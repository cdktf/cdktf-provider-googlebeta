...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlekmssecretciphertext"
...
| <code><a href="#@cdktf/provider-google-beta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertext.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googlekmssecretciphertext.GoogleKmsSecretCiphertextConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
