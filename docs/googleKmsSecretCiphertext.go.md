...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlekmssecretciphertext"
...
&googlekmssecretciphertext.GoogleKmsSecretCiphertextConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextTimeouts,
}
```
