...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlefirebasehostingrelease"
...
&googlefirebasehostingrelease.GoogleFirebaseHostingReleaseConfig {
	...
	Id: *string,
	Message: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleFirebaseHostingRelease.GoogleFirebaseHostingReleaseTimeouts,
	Type: *string,
	VersionName: *string,
}
```
