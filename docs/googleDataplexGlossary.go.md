...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googledataplexglossary"
...
&googledataplexglossary.GoogleDataplexGlossaryConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleDataplexGlossary.GoogleDataplexGlossaryTimeouts,
}
```
