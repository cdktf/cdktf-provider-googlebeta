...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlehealthcaredatasetiammember"
...
&googlehealthcaredatasetiammember.GoogleHealthcareDatasetIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMemberCondition,
	Id: *string,
}
```
