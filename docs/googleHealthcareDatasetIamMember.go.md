...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlehealthcaredatasetiammember"
...
&googlehealthcaredatasetiammember.GoogleHealthcareDatasetIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMemberCondition,
	Id: *string,
}
```
