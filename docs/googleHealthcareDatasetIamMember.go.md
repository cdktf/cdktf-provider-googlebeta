...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlehealthcaredatasetiammember"
...
&googlehealthcaredatasetiammember.GoogleHealthcareDatasetIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMemberCondition,
	Id: *string,
}
```
