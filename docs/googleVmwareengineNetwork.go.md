...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlevmwareenginenetwork"
...
&googlevmwareenginenetwork.GoogleVmwareengineNetworkConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleVmwareengineNetwork.GoogleVmwareengineNetworkTimeouts,
}
```
