...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecomputeaddress"
...
&googlecomputeaddress.GoogleComputeAddressConfig {
	...
	Region: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputeAddress.GoogleComputeAddressTimeouts,
}
```
