...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlespannerinstanceiammember"
...
&googlespannerinstanceiammember.GoogleSpannerInstanceIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
