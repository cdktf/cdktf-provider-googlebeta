...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecertificatemanagercertificatemap"
...
&googlecertificatemanagercertificatemap.GoogleCertificateManagerCertificateMapConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleCertificateManagerCertificateMap.GoogleCertificateManagerCertificateMapTimeouts,
}
```
