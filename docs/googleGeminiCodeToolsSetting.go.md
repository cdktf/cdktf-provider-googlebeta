...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlegeminicodetoolssetting"
...
&googlegeminicodetoolssetting.GoogleGeminiCodeToolsSettingConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSettingTimeouts,
}
```
