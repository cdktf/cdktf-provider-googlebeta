...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlegeminicodetoolssetting"
...
&googlegeminicodetoolssetting.GoogleGeminiCodeToolsSettingConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSettingTimeouts,
}
```
