...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlefolderaccessapprovalsettings"
...
&googlefolderaccessapprovalsettings.GoogleFolderAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleFolderAccessApprovalSettings.GoogleFolderAccessApprovalSettingsTimeouts,
}
```
