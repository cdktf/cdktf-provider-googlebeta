...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googledatacatalogentrygroup"
...
&googledatacatalogentrygroup.GoogleDataCatalogEntryGroupConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleDataCatalogEntryGroup.GoogleDataCatalogEntryGroupTimeouts,
}
```
