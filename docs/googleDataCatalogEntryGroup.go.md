...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googledatacatalogentrygroup"
...
&googledatacatalogentrygroup.GoogleDataCatalogEntryGroupConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleDataCatalogEntryGroup.GoogleDataCatalogEntryGroupTimeouts,
}
```
