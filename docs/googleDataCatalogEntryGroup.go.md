...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googledatacatalogentrygroup"
...
&googledatacatalogentrygroup.GoogleDataCatalogEntryGroupConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleDataCatalogEntryGroup.GoogleDataCatalogEntryGroupTimeouts,
}
```
