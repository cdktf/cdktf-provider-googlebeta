...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlehealthcarefhirstoreiambinding"
...
&googlehealthcarefhirstoreiambinding.GoogleHealthcareFhirStoreIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleHealthcareFhirStoreIamBinding.GoogleHealthcareFhirStoreIamBindingCondition,
	Id: *string,
}
```
