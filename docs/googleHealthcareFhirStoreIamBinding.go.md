...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlehealthcarefhirstoreiambinding"
...
&googlehealthcarefhirstoreiambinding.GoogleHealthcareFhirStoreIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleHealthcareFhirStoreIamBinding.GoogleHealthcareFhirStoreIamBindingCondition,
	Id: *string,
}
```
