...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlealloydbbackup"
...
&googlealloydbbackup.GoogleAlloydbBackupConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleAlloydbBackup.GoogleAlloydbBackupTimeouts,
}
```
