...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlebinaryauthorizationattestoriambinding"
...
&googlebinaryauthorizationattestoriambinding.GoogleBinaryAuthorizationAttestorIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleBinaryAuthorizationAttestorIamBinding.GoogleBinaryAuthorizationAttestorIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
