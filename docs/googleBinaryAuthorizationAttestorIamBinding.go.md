...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlebinaryauthorizationattestoriambinding"
...
&googlebinaryauthorizationattestoriambinding.GoogleBinaryAuthorizationAttestorIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleBinaryAuthorizationAttestorIamBinding.GoogleBinaryAuthorizationAttestorIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
