...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlestoragehmackey"
...
&googlestoragehmackey.GoogleStorageHmacKeyConfig {
	...
	Project: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleStorageHmacKey.GoogleStorageHmacKeyTimeouts,
}
```
