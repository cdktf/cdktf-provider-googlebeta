...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlestoragehmackey"
...
&googlestoragehmackey.GoogleStorageHmacKeyConfig {
	...
	Project: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleStorageHmacKey.GoogleStorageHmacKeyTimeouts,
}
```
