...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleservicedirectorynamespace"
...
&googleservicedirectorynamespace.GoogleServiceDirectoryNamespaceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleServiceDirectoryNamespace.GoogleServiceDirectoryNamespaceTimeouts,
}
```
