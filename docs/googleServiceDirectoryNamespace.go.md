...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googleservicedirectorynamespace"
...
&googleservicedirectorynamespace.GoogleServiceDirectoryNamespaceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleServiceDirectoryNamespace.GoogleServiceDirectoryNamespaceTimeouts,
}
```
