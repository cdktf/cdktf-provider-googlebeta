...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleservicedirectorynamespace"
...
&googleservicedirectorynamespace.GoogleServiceDirectoryNamespaceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleServiceDirectoryNamespace.GoogleServiceDirectoryNamespaceTimeouts,
}
```
