...
| <code><a href="#@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTable.Initializer.parameter.allowResourceTagsOnDeletion">allow_resource_tags_on_deletion</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | Whether or not to allow table deletion when there are still resource tags attached. |
...
| <code><a href="#@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTable.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_bigquery_table#id GoogleBigqueryTable#id}. |
...
##### `allow_resource_tags_on_deletion`<sup>Optional</sup> <a name="allow_resource_tags_on_deletion" id="@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTable.Initializer.parameter.allowResourceTagsOnDeletion"></a>
...
| <code><a href="#@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTable.resetAllowResourceTagsOnDeletion">reset_allow_resource_tags_on_deletion</a></code> | *No description.* |
...
##### `reset_allow_resource_tags_on_deletion` <a name="reset_allow_resource_tags_on_deletion" id="@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTable.resetAllowResourceTagsOnDeletion"></a>
...
| <code><a href="#@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTable.property.allowResourceTagsOnDeletionInput">allow_resource_tags_on_deletion_input</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTable.property.allowResourceTagsOnDeletion">allow_resource_tags_on_deletion</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | *No description.* |
...
##### `allow_resource_tags_on_deletion_input`<sup>Optional</sup> <a name="allow_resource_tags_on_deletion_input" id="@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTable.property.allowResourceTagsOnDeletionInput"></a>
...
##### `allow_resource_tags_on_deletion`<sup>Required</sup> <a name="allow_resource_tags_on_deletion" id="@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTable.property.allowResourceTagsOnDeletion"></a>
...
| <code><a href="#@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTableConfig.property.allowResourceTagsOnDeletion">allow_resource_tags_on_deletion</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | Whether or not to allow table deletion when there are still resource tags attached. |
...
| <code><a href="#@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTableConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_bigquery_table#id GoogleBigqueryTable#id}. |
...
##### `allow_resource_tags_on_deletion`<sup>Optional</sup> <a name="allow_resource_tags_on_deletion" id="@cdktf/provider-google-beta.googleBigqueryTable.GoogleBigqueryTableConfig.property.allowResourceTagsOnDeletion"></a>
