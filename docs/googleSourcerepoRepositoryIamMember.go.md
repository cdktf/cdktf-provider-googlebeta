...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlesourcereporepositoryiammember"
...
&googlesourcereporepositoryiammember.GoogleSourcerepoRepositoryIamMemberConfig {
	...
	Repository: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleSourcerepoRepositoryIamMember.GoogleSourcerepoRepositoryIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
