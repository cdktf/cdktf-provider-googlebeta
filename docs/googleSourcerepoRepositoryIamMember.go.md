...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlesourcereporepositoryiammember"
...
&googlesourcereporepositoryiammember.GoogleSourcerepoRepositoryIamMemberConfig {
	...
	Repository: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleSourcerepoRepositoryIamMember.GoogleSourcerepoRepositoryIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
