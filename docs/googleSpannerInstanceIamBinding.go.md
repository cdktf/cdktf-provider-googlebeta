...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlespannerinstanceiambinding"
...
&googlespannerinstanceiambinding.GoogleSpannerInstanceIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleSpannerInstanceIamBinding.GoogleSpannerInstanceIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
