...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlelogginglogscope"
...
&googlelogginglogscope.GoogleLoggingLogScopeConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleLoggingLogScope.GoogleLoggingLogScopeTimeouts,
}
```
