...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlelogginglogscope"
...
&googlelogginglogscope.GoogleLoggingLogScopeConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleLoggingLogScope.GoogleLoggingLogScopeTimeouts,
}
```
