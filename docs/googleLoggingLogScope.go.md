...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlelogginglogscope"
...
&googlelogginglogscope.GoogleLoggingLogScopeConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleLoggingLogScope.GoogleLoggingLogScopeTimeouts,
}
```
