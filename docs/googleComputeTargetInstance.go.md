...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputetargetinstance"
...
&googlecomputetargetinstance.GoogleComputeTargetInstanceConfig {
	...
	Network: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputeTargetInstance.GoogleComputeTargetInstanceTimeouts,
	Zone: *string,
}
```
