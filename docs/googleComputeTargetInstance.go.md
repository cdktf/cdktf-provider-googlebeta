...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googlecomputetargetinstance"
...
&googlecomputetargetinstance.GoogleComputeTargetInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleComputeTargetInstance.GoogleComputeTargetInstanceTimeouts,
	Zone: *string,
}
```
