...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlegkehubscopeiambinding"
...
&googlegkehubscopeiambinding.GoogleGkeHubScopeIamBindingConfig {
	...
	Role: *string,
	ScopeId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleGkeHubScopeIamBinding.GoogleGkeHubScopeIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
