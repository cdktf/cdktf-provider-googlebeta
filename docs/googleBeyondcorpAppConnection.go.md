...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlebeyondcorpappconnection"
...
&googlebeyondcorpappconnection.GoogleBeyondcorpAppConnectionConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleBeyondcorpAppConnection.GoogleBeyondcorpAppConnectionTimeouts,
	Type: *string,
}
```
