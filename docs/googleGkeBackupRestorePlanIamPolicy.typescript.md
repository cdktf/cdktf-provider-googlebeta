...
```typescript
import { googleGkeBackupRestorePlanIamPolicy } from '@cdktf/provider-google-beta'

new googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy(scope: Construct, id: string, config: GoogleGkeBackupRestorePlanIamPolicyConfig)
```
...
googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy.isConstruct(x: any)
```
...
googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy.isTerraformElement(x: any)
```
...
googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy.isTerraformResource(x: any)
```
...
googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-google-beta.googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicy.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
const googleGkeBackupRestorePlanIamPolicyConfig: googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicyConfig = { ... }
```
...
| <code><a href="#@cdktf/provider-google-beta.googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicyConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicyConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleGkeBackupRestorePlanIamPolicy.GoogleGkeBackupRestorePlanIamPolicyConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
