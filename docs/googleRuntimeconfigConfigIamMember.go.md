...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleruntimeconfigconfigiammember"
...
&googleruntimeconfigconfigiammember.GoogleRuntimeconfigConfigIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleRuntimeconfigConfigIamMember.GoogleRuntimeconfigConfigIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
