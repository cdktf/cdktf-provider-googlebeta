...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googletagstagvalue"
...
&googletagstagvalue.GoogleTagsTagValueConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleTagsTagValue.GoogleTagsTagValueTimeouts,
}
```
