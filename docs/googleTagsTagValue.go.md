...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googletagstagvalue"
...
&googletagstagvalue.GoogleTagsTagValueConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleTagsTagValue.GoogleTagsTagValueTimeouts,
}
```
