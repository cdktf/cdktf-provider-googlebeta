...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlenetworkservicesmesh"
...
&googlenetworkservicesmesh.GoogleNetworkServicesMeshConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleNetworkServicesMesh.GoogleNetworkServicesMeshTimeouts,
}
```
