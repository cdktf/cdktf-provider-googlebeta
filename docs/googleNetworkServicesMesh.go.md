...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlenetworkservicesmesh"
...
&googlenetworkservicesmesh.GoogleNetworkServicesMeshConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleNetworkServicesMesh.GoogleNetworkServicesMeshTimeouts,
}
```
