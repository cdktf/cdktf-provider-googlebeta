...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googleapigeecontrolplaneaccess"
...
&googleapigeecontrolplaneaccess.GoogleApigeeControlPlaneAccessConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleApigeeControlPlaneAccess.GoogleApigeeControlPlaneAccessTimeouts,
}
```
