...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googletagstagkeyiammember"
...
&googletagstagkeyiammember.GoogleTagsTagKeyIamMemberConfig {
	...
	Role: *string,
	TagKey: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleTagsTagKeyIamMember.GoogleTagsTagKeyIamMemberCondition,
	Id: *string,
}
```
