...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googletagstagkeyiammember"
...
&googletagstagkeyiammember.GoogleTagsTagKeyIamMemberConfig {
	...
	Role: *string,
	TagKey: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleTagsTagKeyIamMember.GoogleTagsTagKeyIamMemberCondition,
	Id: *string,
}
```
