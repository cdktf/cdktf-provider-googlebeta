...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googletagstagkeyiammember"
...
&googletagstagkeyiammember.GoogleTagsTagKeyIamMemberConfig {
	...
	Role: *string,
	TagKey: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleTagsTagKeyIamMember.GoogleTagsTagKeyIamMemberCondition,
	Id: *string,
}
```
