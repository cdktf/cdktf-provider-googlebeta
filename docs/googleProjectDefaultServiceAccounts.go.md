...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googleprojectdefaultserviceaccounts"
...
&googleprojectdefaultserviceaccounts.GoogleProjectDefaultServiceAccountsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleProjectDefaultServiceAccounts.GoogleProjectDefaultServiceAccountsTimeouts,
}
```
