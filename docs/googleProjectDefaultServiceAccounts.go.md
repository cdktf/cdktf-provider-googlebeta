...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleprojectdefaultserviceaccounts"
...
&googleprojectdefaultserviceaccounts.GoogleProjectDefaultServiceAccountsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleProjectDefaultServiceAccounts.GoogleProjectDefaultServiceAccountsTimeouts,
}
```
