...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleprojectdefaultserviceaccounts"
...
&googleprojectdefaultserviceaccounts.GoogleProjectDefaultServiceAccountsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleProjectDefaultServiceAccounts.GoogleProjectDefaultServiceAccountsTimeouts,
}
```
