...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleactivedirectorypeering"
...
&googleactivedirectorypeering.GoogleActiveDirectoryPeeringConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleActiveDirectoryPeering.GoogleActiveDirectoryPeeringTimeouts,
}
```
