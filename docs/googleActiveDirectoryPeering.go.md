...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleactivedirectorypeering"
...
&googleactivedirectorypeering.GoogleActiveDirectoryPeeringConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleActiveDirectoryPeering.GoogleActiveDirectoryPeeringTimeouts,
}
```
