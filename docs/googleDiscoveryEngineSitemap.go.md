...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlediscoveryenginesitemap"
...
&googlediscoveryenginesitemap.GoogleDiscoveryEngineSitemapConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapTimeouts,
	Uri: *string,
}
```
