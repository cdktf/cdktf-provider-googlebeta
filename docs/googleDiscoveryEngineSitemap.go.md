...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlediscoveryenginesitemap"
...
&googlediscoveryenginesitemap.GoogleDiscoveryEngineSitemapConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapTimeouts,
	Uri: *string,
}
```
