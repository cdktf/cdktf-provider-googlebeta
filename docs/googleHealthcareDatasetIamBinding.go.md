...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlehealthcaredatasetiambinding"
...
&googlehealthcaredatasetiambinding.GoogleHealthcareDatasetIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleHealthcareDatasetIamBinding.GoogleHealthcareDatasetIamBindingCondition,
	Id: *string,
}
```
