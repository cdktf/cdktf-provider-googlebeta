...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlehealthcaredatasetiambinding"
...
&googlehealthcaredatasetiambinding.GoogleHealthcareDatasetIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleHealthcareDatasetIamBinding.GoogleHealthcareDatasetIamBindingCondition,
	Id: *string,
}
```
