...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlehealthcaredatasetiambinding"
...
&googlehealthcaredatasetiambinding.GoogleHealthcareDatasetIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleHealthcareDatasetIamBinding.GoogleHealthcareDatasetIamBindingCondition,
	Id: *string,
}
```
