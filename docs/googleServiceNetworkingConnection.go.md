...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleservicenetworkingconnection"
...
&googleservicenetworkingconnection.GoogleServiceNetworkingConnectionConfig {
	...
	Service: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleServiceNetworkingConnection.GoogleServiceNetworkingConnectionTimeouts,
}
```
