...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleservicenetworkingconnection"
...
&googleservicenetworkingconnection.GoogleServiceNetworkingConnectionConfig {
	...
	Service: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleServiceNetworkingConnection.GoogleServiceNetworkingConnectionTimeouts,
}
```
