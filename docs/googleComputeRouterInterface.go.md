...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlecomputerouterinterface"
...
&googlecomputerouterinterface.GoogleComputeRouterInterfaceConfig {
	...
	Region: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleComputeRouterInterface.GoogleComputeRouterInterfaceTimeouts,
	VpnTunnel: *string,
}
```
