...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputerouterinterface"
...
&googlecomputerouterinterface.GoogleComputeRouterInterfaceConfig {
	...
	Region: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeRouterInterface.GoogleComputeRouterInterfaceTimeouts,
	VpnTunnel: *string,
}
```
