...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecomputefirewallpolicy"
...
&googlecomputefirewallpolicy.GoogleComputeFirewallPolicyConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputeFirewallPolicy.GoogleComputeFirewallPolicyTimeouts,
}
```
