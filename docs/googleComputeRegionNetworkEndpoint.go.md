...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecomputeregionnetworkendpoint"
...
&googlecomputeregionnetworkendpoint.GoogleComputeRegionNetworkEndpointConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputeRegionNetworkEndpoint.GoogleComputeRegionNetworkEndpointTimeouts,
}
```
