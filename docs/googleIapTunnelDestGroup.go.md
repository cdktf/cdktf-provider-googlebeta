...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleiaptunneldestgroup"
...
&googleiaptunneldestgroup.GoogleIapTunnelDestGroupConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleIapTunnelDestGroup.GoogleIapTunnelDestGroupTimeouts,
}
```
