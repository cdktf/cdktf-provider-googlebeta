...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googleiaptunneldestgroup"
...
&googleiaptunneldestgroup.GoogleIapTunnelDestGroupConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleIapTunnelDestGroup.GoogleIapTunnelDestGroupTimeouts,
}
```
