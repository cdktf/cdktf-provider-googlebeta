...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googleiaptunneldestgroup"
...
&googleiaptunneldestgroup.GoogleIapTunnelDestGroupConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleIapTunnelDestGroup.GoogleIapTunnelDestGroupTimeouts,
}
```
