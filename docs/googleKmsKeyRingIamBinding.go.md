...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlekmskeyringiambinding"
...
&googlekmskeyringiambinding.GoogleKmsKeyRingIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleKmsKeyRingIamBinding.GoogleKmsKeyRingIamBindingCondition,
	Id: *string,
}
```
