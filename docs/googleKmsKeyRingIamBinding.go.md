...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlekmskeyringiambinding"
...
&googlekmskeyringiambinding.GoogleKmsKeyRingIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleKmsKeyRingIamBinding.GoogleKmsKeyRingIamBindingCondition,
	Id: *string,
}
```
