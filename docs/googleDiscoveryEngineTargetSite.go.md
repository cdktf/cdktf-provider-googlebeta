...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlediscoveryenginetargetsite"
...
&googlediscoveryenginetargetsite.GoogleDiscoveryEngineTargetSiteConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleDiscoveryEngineTargetSite.GoogleDiscoveryEngineTargetSiteTimeouts,
	Type: *string,
}
```
