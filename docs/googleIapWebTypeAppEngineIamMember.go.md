...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleiapwebtypeappengineiammember"
...
&googleiapwebtypeappengineiammember.GoogleIapWebTypeAppEngineIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleIapWebTypeAppEngineIamMember.GoogleIapWebTypeAppEngineIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
