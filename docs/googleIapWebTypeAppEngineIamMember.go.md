...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleiapwebtypeappengineiammember"
...
&googleiapwebtypeappengineiammember.GoogleIapWebTypeAppEngineIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleIapWebTypeAppEngineIamMember.GoogleIapWebTypeAppEngineIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
