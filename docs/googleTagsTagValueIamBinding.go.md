...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googletagstagvalueiambinding"
...
&googletagstagvalueiambinding.GoogleTagsTagValueIamBindingConfig {
	...
	Role: *string,
	TagValue: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleTagsTagValueIamBinding.GoogleTagsTagValueIamBindingCondition,
	Id: *string,
}
```
