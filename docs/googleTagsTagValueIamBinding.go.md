...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googletagstagvalueiambinding"
...
&googletagstagvalueiambinding.GoogleTagsTagValueIamBindingConfig {
	...
	Role: *string,
	TagValue: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleTagsTagValueIamBinding.GoogleTagsTagValueIamBindingCondition,
	Id: *string,
}
```
