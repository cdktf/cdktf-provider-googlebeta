...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googletagstagvalueiambinding"
...
&googletagstagvalueiambinding.GoogleTagsTagValueIamBindingConfig {
	...
	Role: *string,
	TagValue: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleTagsTagValueIamBinding.GoogleTagsTagValueIamBindingCondition,
	Id: *string,
}
```
