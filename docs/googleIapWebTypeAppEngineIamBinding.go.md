...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleiapwebtypeappengineiambinding"
...
&googleiapwebtypeappengineiambinding.GoogleIapWebTypeAppEngineIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleIapWebTypeAppEngineIamBinding.GoogleIapWebTypeAppEngineIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
