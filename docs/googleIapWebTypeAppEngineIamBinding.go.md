...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleiapwebtypeappengineiambinding"
...
&googleiapwebtypeappengineiambinding.GoogleIapWebTypeAppEngineIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleIapWebTypeAppEngineIamBinding.GoogleIapWebTypeAppEngineIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
