...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleiapwebtypeappengineiambinding"
...
&googleiapwebtypeappengineiambinding.GoogleIapWebTypeAppEngineIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleIapWebTypeAppEngineIamBinding.GoogleIapWebTypeAppEngineIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
