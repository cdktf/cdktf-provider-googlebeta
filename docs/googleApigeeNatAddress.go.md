...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleapigeenataddress"
...
&googleapigeenataddress.GoogleApigeeNatAddressConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleApigeeNatAddress.GoogleApigeeNatAddressTimeouts,
}
```
