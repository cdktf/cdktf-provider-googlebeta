...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googleapigeenataddress"
...
&googleapigeenataddress.GoogleApigeeNatAddressConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleApigeeNatAddress.GoogleApigeeNatAddressTimeouts,
}
```
