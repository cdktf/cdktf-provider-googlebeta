...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googleloggingfoldersink"
...
| <code><a href="#@cdktf/provider-google-beta.googleLoggingFolderSink.GoogleLoggingFolderSink.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googleloggingfoldersink.GoogleLoggingFolderSinkConfig {
	...
	Folder: *string,
	Name: *string,
	BigqueryOptions: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleLoggingFolderSink.GoogleLoggingFolderSinkBigqueryOptions,
	Description: *string,
	Disabled: interface{},
...
| <code><a href="#@cdktf/provider-google-beta.googleLoggingFolderSink.GoogleLoggingFolderSinkConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleLoggingFolderSink.GoogleLoggingFolderSinkConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_logging_folder_sink#id GoogleLoggingFolderSink#id}. |
