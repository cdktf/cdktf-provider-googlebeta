...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googledatastoreindex"
...
&googledatastoreindex.GoogleDatastoreIndexConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleDatastoreIndex.GoogleDatastoreIndexTimeouts,
}
```
