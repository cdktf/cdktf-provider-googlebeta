...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlecomputemanagedsslcertificate"
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificate.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificate.property.certificateIdInput">CertificateIdInput</a></code> | <code>*f64</code> | *No description.* |
...
&googlecomputemanagedsslcertificate.GoogleComputeManagedSslCertificateConfig {
	...
	Description: *string,
	Id: *string,
	Managed: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificateManaged,
	Name: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificateTimeouts,
	Type: *string,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificateConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificateConfig.property.certificateId">CertificateId</a></code> | <code>*f64</code> | The unique identifier for the resource. |
