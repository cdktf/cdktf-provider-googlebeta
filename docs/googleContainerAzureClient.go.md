...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlecontainerazureclient"
...
&googlecontainerazureclient.GoogleContainerAzureClientConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleContainerAzureClient.GoogleContainerAzureClientTimeouts,
}
```
