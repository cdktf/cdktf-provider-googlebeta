...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlecontainerazureclient"
...
&googlecontainerazureclient.GoogleContainerAzureClientConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleContainerAzureClient.GoogleContainerAzureClientTimeouts,
}
```
