...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecontainerazureclient"
...
&googlecontainerazureclient.GoogleContainerAzureClientConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleContainerAzureClient.GoogleContainerAzureClientTimeouts,
}
```
