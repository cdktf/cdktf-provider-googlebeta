...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputeforwardingrule"
...
&googlecomputeforwardingrule.GoogleComputeForwardingRuleConfig {
	...
	Subnetwork: *string,
	Target: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputeForwardingRule.GoogleComputeForwardingRuleTimeouts,
}
```
