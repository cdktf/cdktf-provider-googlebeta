...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputeforwardingrule"
...
&googlecomputeforwardingrule.GoogleComputeForwardingRuleConfig {
	...
	Subnetwork: *string,
	Target: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeForwardingRule.GoogleComputeForwardingRuleTimeouts,
}
```
