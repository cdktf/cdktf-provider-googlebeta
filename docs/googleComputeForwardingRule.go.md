...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlecomputeforwardingrule"
...
&googlecomputeforwardingrule.GoogleComputeForwardingRuleConfig {
	...
	Project: *string,
	Region: *string,
	ServiceDirectoryRegistrations: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleComputeForwardingRule.GoogleComputeForwardingRuleServiceDirectoryRegistrations,
	ServiceLabel: *string,
	SourceIpRanges: *[]*string,
	Subnetwork: *string,
	Target: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleComputeForwardingRule.GoogleComputeForwardingRuleTimeouts,
}
```
