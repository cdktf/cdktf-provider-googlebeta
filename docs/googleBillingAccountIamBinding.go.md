...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlebillingaccountiambinding"
...
&googlebillingaccountiambinding.GoogleBillingAccountIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleBillingAccountIamBinding.GoogleBillingAccountIamBindingCondition,
	Id: *string,
}
```
