...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlebillingaccountiambinding"
...
&googlebillingaccountiambinding.GoogleBillingAccountIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleBillingAccountIamBinding.GoogleBillingAccountIamBindingCondition,
	Id: *string,
}
```
