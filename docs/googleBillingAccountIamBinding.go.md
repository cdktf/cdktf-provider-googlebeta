...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlebillingaccountiambinding"
...
&googlebillingaccountiambinding.GoogleBillingAccountIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleBillingAccountIamBinding.GoogleBillingAccountIamBindingCondition,
	Id: *string,
}
```
