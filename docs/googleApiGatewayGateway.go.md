...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleapigatewaygateway"
...
&googleapigatewaygateway.GoogleApiGatewayGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleApiGatewayGateway.GoogleApiGatewayGatewayTimeouts,
}
```
