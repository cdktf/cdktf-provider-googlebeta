...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googleapigatewaygateway"
...
| <code><a href="#@cdktf/provider-google-beta.googleApiGatewayGateway.GoogleApiGatewayGateway.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googleapigatewaygateway.GoogleApiGatewayGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleApiGatewayGateway.GoogleApiGatewayGatewayTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleApiGatewayGateway.GoogleApiGatewayGatewayConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
