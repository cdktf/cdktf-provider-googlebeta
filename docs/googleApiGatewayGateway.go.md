...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googleapigatewaygateway"
...
&googleapigatewaygateway.GoogleApiGatewayGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleApiGatewayGateway.GoogleApiGatewayGatewayTimeouts,
}
```
