...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleapigatewaygateway"
...
&googleapigatewaygateway.GoogleApiGatewayGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleApiGatewayGateway.GoogleApiGatewayGatewayTimeouts,
}
```
