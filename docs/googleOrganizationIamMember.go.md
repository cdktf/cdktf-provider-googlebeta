...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleorganizationiammember"
...
&googleorganizationiammember.GoogleOrganizationIamMemberConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleOrganizationIamMember.GoogleOrganizationIamMemberCondition,
	Id: *string,
}
```
