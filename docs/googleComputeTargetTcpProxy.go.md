...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputetargettcpproxy"
...
&googlecomputetargettcpproxy.GoogleComputeTargetTcpProxyConfig {
	...
	ProxyBind: interface{},
	ProxyHeader: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxyTimeouts,
}
```
