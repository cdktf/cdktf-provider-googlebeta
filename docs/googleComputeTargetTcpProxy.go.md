...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputetargettcpproxy"
...
&googlecomputetargettcpproxy.GoogleComputeTargetTcpProxyConfig {
	...
	ProxyBind: interface{},
	ProxyHeader: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxyTimeouts,
}
```
