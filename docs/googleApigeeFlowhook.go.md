...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleapigeeflowhook"
...
&googleapigeeflowhook.GoogleApigeeFlowhookConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleApigeeFlowhook.GoogleApigeeFlowhookTimeouts,
}
```
