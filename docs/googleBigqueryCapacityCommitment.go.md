...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlebigquerycapacitycommitment"
...
&googlebigquerycapacitycommitment.GoogleBigqueryCapacityCommitmentConfig {
	...
	Project: *string,
	RenewalPlan: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleBigqueryCapacityCommitment.GoogleBigqueryCapacityCommitmentTimeouts,
}
```
