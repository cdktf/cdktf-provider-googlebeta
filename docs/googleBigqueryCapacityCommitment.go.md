...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googlebigquerycapacitycommitment"
...
&googlebigquerycapacitycommitment.GoogleBigqueryCapacityCommitmentConfig {
	...
	Project: *string,
	RenewalPlan: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleBigqueryCapacityCommitment.GoogleBigqueryCapacityCommitmentTimeouts,
}
```
