...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlebigquerycapacitycommitment"
...
&googlebigquerycapacitycommitment.GoogleBigqueryCapacityCommitmentConfig {
	...
	Project: *string,
	RenewalPlan: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleBigqueryCapacityCommitment.GoogleBigqueryCapacityCommitmentTimeouts,
}
```
