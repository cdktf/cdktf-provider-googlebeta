...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googleloggingfoldersettings"
...
&googleloggingfoldersettings.GoogleLoggingFolderSettingsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleLoggingFolderSettings.GoogleLoggingFolderSettingsTimeouts,
}
```
