...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googledataplexentrygroup"
...
&googledataplexentrygroup.GoogleDataplexEntryGroupConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleDataplexEntryGroup.GoogleDataplexEntryGroupTimeouts,
}
```
