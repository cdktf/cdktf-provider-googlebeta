...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecomputepublicadvertisedprefix"
...
&googlecomputepublicadvertisedprefix.GoogleComputePublicAdvertisedPrefixConfig {
	...
	PdpScope: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputePublicAdvertisedPrefix.GoogleComputePublicAdvertisedPrefixTimeouts,
}
```
