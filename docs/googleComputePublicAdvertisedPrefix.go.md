...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputepublicadvertisedprefix"
...
&googlecomputepublicadvertisedprefix.GoogleComputePublicAdvertisedPrefixConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputePublicAdvertisedPrefix.GoogleComputePublicAdvertisedPrefixTimeouts,
}
```
