...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlesccnotificationconfig"
...
&googlesccnotificationconfig.GoogleSccNotificationConfigConfig {
	...
	Organization: *string,
	PubsubTopic: *string,
	StreamingConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleSccNotificationConfig.GoogleSccNotificationConfigStreamingConfig,
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleSccNotificationConfig.GoogleSccNotificationConfigTimeouts,
}
```
