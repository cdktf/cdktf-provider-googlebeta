...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlesccnotificationconfig"
...
&googlesccnotificationconfig.GoogleSccNotificationConfigConfig {
	...
	Organization: *string,
	PubsubTopic: *string,
	StreamingConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleSccNotificationConfig.GoogleSccNotificationConfigStreamingConfig,
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleSccNotificationConfig.GoogleSccNotificationConfigTimeouts,
}
```
