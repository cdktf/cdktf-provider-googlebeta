...
&googlegkeonpremvmwarenodepool.GoogleGkeonpremVmwareNodePoolConfigA {
	...
	Replicas: *f64,
	Taints: interface{},
	VsphereConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleGkeonpremVmwareNodePool.GoogleGkeonpremVmwareNodePoolConfigVsphereConfig,
}
```
