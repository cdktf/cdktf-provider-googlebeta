...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlegkehubmembershipbinding"
...
&googlegkehubmembershipbinding.GoogleGkeHubMembershipBindingConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleGkeHubMembershipBinding.GoogleGkeHubMembershipBindingTimeouts,
}
```
