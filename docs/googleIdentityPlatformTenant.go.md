...
Refer to the Terraform Registory for docs: [`google_identity_platform_tenant`](https://registry.terraform.io/providers/hashicorp/google-beta/4.72.1/docs/resources/google_identity_platform_tenant).
...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleidentityplatformtenant"
...
&googleidentityplatformtenant.GoogleIdentityPlatformTenantConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleIdentityPlatformTenant.GoogleIdentityPlatformTenantTimeouts,
}
```
