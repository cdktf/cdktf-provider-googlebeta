...
Refer to the Terraform Registory for docs: [`google_service_account_iam_policy`](https://registry.terraform.io/providers/hashicorp/google-beta/4.69.1/docs/resources/google_service_account_iam_policy).
...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleserviceaccountiampolicy"
