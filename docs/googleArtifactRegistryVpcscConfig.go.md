...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googleartifactregistryvpcscconfig"
...
&googleartifactregistryvpcscconfig.GoogleArtifactRegistryVpcscConfigConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleArtifactRegistryVpcscConfig.GoogleArtifactRegistryVpcscConfigTimeouts,
	VpcscPolicy: *string,
}
```
