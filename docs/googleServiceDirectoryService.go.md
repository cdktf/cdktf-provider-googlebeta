...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleservicedirectoryservice"
...
&googleservicedirectoryservice.GoogleServiceDirectoryServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleServiceDirectoryService.GoogleServiceDirectoryServiceTimeouts,
}
```
