...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecomputesslcertificate"
...
&googlecomputesslcertificate.GoogleComputeSslCertificateConfig {
	...
	NamePrefix: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputeSslCertificate.GoogleComputeSslCertificateTimeouts,
}
```
