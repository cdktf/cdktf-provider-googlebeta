...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputesslcertificate"
...
&googlecomputesslcertificate.GoogleComputeSslCertificateConfig {
	...
	NamePrefix: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputeSslCertificate.GoogleComputeSslCertificateTimeouts,
}
```
