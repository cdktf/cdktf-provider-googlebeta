...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlecomputesslcertificate"
...
&googlecomputesslcertificate.GoogleComputeSslCertificateConfig {
	...
	NamePrefix: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleComputeSslCertificate.GoogleComputeSslCertificateTimeouts,
}
```
