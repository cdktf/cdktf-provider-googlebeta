...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlecomputesslcertificate"
...
&googlecomputesslcertificate.GoogleComputeSslCertificateConfig {
	...
	NamePrefix: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleComputeSslCertificate.GoogleComputeSslCertificateTimeouts,
}
```
