...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleactivedirectorydomaintrust"
...
&googleactivedirectorydomaintrust.GoogleActiveDirectoryDomainTrustConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleActiveDirectoryDomainTrust.GoogleActiveDirectoryDomainTrustTimeouts,
}
```
