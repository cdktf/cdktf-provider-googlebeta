...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlebiglakedatabase"
...
&googlebiglakedatabase.GoogleBiglakeDatabaseConfig {
	...
	Catalog: *string,
	HiveOptions: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleBiglakeDatabase.GoogleBiglakeDatabaseHiveOptions,
	Name: *string,
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleBiglakeDatabase.GoogleBiglakeDatabaseTimeouts,
}
```
