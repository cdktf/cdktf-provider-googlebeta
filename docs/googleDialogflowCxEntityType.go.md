...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googledialogflowcxentitytype"
...
&googledialogflowcxentitytype.GoogleDialogflowCxEntityTypeConfig {
	...
	Parent: *string,
	Redact: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleDialogflowCxEntityType.GoogleDialogflowCxEntityTypeTimeouts,
}
```
