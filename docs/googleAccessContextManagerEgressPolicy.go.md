...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleaccesscontextmanageregresspolicy"
...
&googleaccesscontextmanageregresspolicy.GoogleAccessContextManagerEgressPolicyConfig {
	...
	Resource: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleAccessContextManagerEgressPolicy.GoogleAccessContextManagerEgressPolicyTimeouts,
}
```
