...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleaccesscontextmanageregresspolicy"
...
&googleaccesscontextmanageregresspolicy.GoogleAccessContextManagerEgressPolicyConfig {
	...
	Resource: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleAccessContextManagerEgressPolicy.GoogleAccessContextManagerEgressPolicyTimeouts,
}
```
