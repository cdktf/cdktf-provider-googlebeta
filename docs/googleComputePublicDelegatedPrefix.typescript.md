...
```typescript
public readonly timeoutsInput: GoogleComputePublicDelegatedPrefixTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-google-beta.googleComputePublicDelegatedPrefix.GoogleComputePublicDelegatedPrefixTimeouts">GoogleComputePublicDelegatedPrefixTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: GoogleComputePublicDelegatedPrefixTimeouts | IResolvable;
```
