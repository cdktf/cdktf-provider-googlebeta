...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlesourcereporepository"
...
&googlesourcereporepository.GoogleSourcerepoRepositoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleSourcerepoRepository.GoogleSourcerepoRepositoryTimeouts,
}
```
