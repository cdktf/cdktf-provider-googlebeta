...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlesourcereporepository"
...
&googlesourcereporepository.GoogleSourcerepoRepositoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleSourcerepoRepository.GoogleSourcerepoRepositoryTimeouts,
}
```
