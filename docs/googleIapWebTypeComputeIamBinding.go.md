...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleiapwebtypecomputeiambinding"
...
&googleiapwebtypecomputeiambinding.GoogleIapWebTypeComputeIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleIapWebTypeComputeIamBinding.GoogleIapWebTypeComputeIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
