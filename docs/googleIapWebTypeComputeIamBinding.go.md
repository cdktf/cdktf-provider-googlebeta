...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleiapwebtypecomputeiambinding"
...
&googleiapwebtypecomputeiambinding.GoogleIapWebTypeComputeIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleIapWebTypeComputeIamBinding.GoogleIapWebTypeComputeIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
