...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googletagstagkeyiambinding"
...
&googletagstagkeyiambinding.GoogleTagsTagKeyIamBindingConfig {
	...
	Role: *string,
	TagKey: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBindingCondition,
	Id: *string,
}
```
