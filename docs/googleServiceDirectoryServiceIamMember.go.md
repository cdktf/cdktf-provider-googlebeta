...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleservicedirectoryserviceiammember"
...
&googleservicedirectoryserviceiammember.GoogleServiceDirectoryServiceIamMemberConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleServiceDirectoryServiceIamMember.GoogleServiceDirectoryServiceIamMemberCondition,
	Id: *string,
}
```
