...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googledatacatalogtaxonomy"
...
&googledatacatalogtaxonomy.GoogleDataCatalogTaxonomyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleDataCatalogTaxonomy.GoogleDataCatalogTaxonomyTimeouts,
}
```
