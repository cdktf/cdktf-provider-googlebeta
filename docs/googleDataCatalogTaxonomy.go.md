...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googledatacatalogtaxonomy"
...
&googledatacatalogtaxonomy.GoogleDataCatalogTaxonomyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleDataCatalogTaxonomy.GoogleDataCatalogTaxonomyTimeouts,
}
```
