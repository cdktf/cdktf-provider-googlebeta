...
Refer to the Terraform Registory for docs: [`google_public_ca_external_account_key`](https://registry.terraform.io/providers/hashicorp/google-beta/4.78.0/docs/resources/google_public_ca_external_account_key).
