...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlehealthcareconsentstoreiammember"
...
&googlehealthcareconsentstoreiammember.GoogleHealthcareConsentStoreIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleHealthcareConsentStoreIamMember.GoogleHealthcareConsentStoreIamMemberCondition,
	Id: *string,
}
```
