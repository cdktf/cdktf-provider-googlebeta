...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googleloggingprojectsink"
...
&googleloggingprojectsink.GoogleLoggingProjectSinkConfig {
	...
	Destination: *string,
	Name: *string,
	BigqueryOptions: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleLoggingProjectSink.GoogleLoggingProjectSinkBigqueryOptions,
	Description: *string,
	Disabled: interface{},
