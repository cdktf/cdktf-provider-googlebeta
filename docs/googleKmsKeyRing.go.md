...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlekmskeyring"
...
&googlekmskeyring.GoogleKmsKeyRingConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleKmsKeyRing.GoogleKmsKeyRingTimeouts,
}
```
