...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googlekmskeyring"
...
&googlekmskeyring.GoogleKmsKeyRingConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleKmsKeyRing.GoogleKmsKeyRingTimeouts,
}
```
