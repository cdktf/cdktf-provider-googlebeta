...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleidentityplatformoauthidpconfig"
...
&googleidentityplatformoauthidpconfig.GoogleIdentityPlatformOauthIdpConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleIdentityPlatformOauthIdpConfig.GoogleIdentityPlatformOauthIdpConfigTimeouts,
}
```
