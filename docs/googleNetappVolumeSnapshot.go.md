...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlenetappvolumesnapshot"
...
&googlenetappvolumesnapshot.GoogleNetappVolumeSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleNetappVolumeSnapshot.GoogleNetappVolumeSnapshotTimeouts,
}
```
