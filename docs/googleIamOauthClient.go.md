...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleiamoauthclient"
...
&googleiamoauthclient.GoogleIamOauthClientConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleIamOauthClient.GoogleIamOauthClientTimeouts,
}
```
