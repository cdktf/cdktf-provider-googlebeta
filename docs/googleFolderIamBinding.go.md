...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlefolderiambinding"
...
&googlefolderiambinding.GoogleFolderIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleFolderIamBinding.GoogleFolderIamBindingCondition,
	Id: *string,
}
```
