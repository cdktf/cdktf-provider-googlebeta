...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlefolderiambinding"
...
&googlefolderiambinding.GoogleFolderIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleFolderIamBinding.GoogleFolderIamBindingCondition,
	Id: *string,
}
```
