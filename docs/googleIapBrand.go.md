...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googleiapbrand"
...
&googleiapbrand.GoogleIapBrandConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleIapBrand.GoogleIapBrandTimeouts,
}
```
