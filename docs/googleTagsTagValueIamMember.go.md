...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googletagstagvalueiammember"
...
&googletagstagvalueiammember.GoogleTagsTagValueIamMemberConfig {
	...
	Role: *string,
	TagValue: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleTagsTagValueIamMember.GoogleTagsTagValueIamMemberCondition,
	Id: *string,
}
```
