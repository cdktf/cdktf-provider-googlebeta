...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleapigeeenvgroup"
...
&googleapigeeenvgroup.GoogleApigeeEnvgroupConfig {
	...
	Hostnames: *[]*string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleApigeeEnvgroup.GoogleApigeeEnvgroupTimeouts,
}
```
