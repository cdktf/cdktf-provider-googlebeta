...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleapigeeenvgroup"
...
&googleapigeeenvgroup.GoogleApigeeEnvgroupConfig {
	...
	Hostnames: *[]*string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleApigeeEnvgroup.GoogleApigeeEnvgroupTimeouts,
}
```
