...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlepubliccaexternalaccountkey"
...
&googlepubliccaexternalaccountkey.GooglePublicCaExternalAccountKeyConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googlePublicCaExternalAccountKey.GooglePublicCaExternalAccountKeyTimeouts,
}
```
