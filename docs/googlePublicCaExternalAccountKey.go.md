...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlepubliccaexternalaccountkey"
...
&googlepubliccaexternalaccountkey.GooglePublicCaExternalAccountKeyConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googlePublicCaExternalAccountKey.GooglePublicCaExternalAccountKeyTimeouts,
}
```
