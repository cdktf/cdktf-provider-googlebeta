...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputenetworkendpointgroup"
...
&googlecomputenetworkendpointgroup.GoogleComputeNetworkEndpointGroupConfig {
	...
	Project: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputeNetworkEndpointGroup.GoogleComputeNetworkEndpointGroupTimeouts,
	Zone: *string,
}
```
