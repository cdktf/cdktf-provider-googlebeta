...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlenotebookslocation"
...
&googlenotebookslocation.GoogleNotebooksLocationConfig {
	...
	Name: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleNotebooksLocation.GoogleNotebooksLocationTimeouts,
}
```
