...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlenotebookslocation"
...
&googlenotebookslocation.GoogleNotebooksLocationConfig {
	...
	Name: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleNotebooksLocation.GoogleNotebooksLocationTimeouts,
}
```
