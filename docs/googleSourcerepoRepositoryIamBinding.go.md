...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlesourcereporepositoryiambinding"
...
googlesourcereporepositoryiambinding.GoogleSourcerepoRepositoryIamBinding_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
&googlesourcereporepositoryiambinding.GoogleSourcerepoRepositoryIamBindingConfig {
	...
	Repository: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleSourcerepoRepositoryIamBinding.GoogleSourcerepoRepositoryIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
