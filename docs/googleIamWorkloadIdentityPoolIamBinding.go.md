...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googleiamworkloadidentitypooliambinding"
...
&googleiamworkloadidentitypooliambinding.GoogleIamWorkloadIdentityPoolIamBindingConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleIamWorkloadIdentityPoolIamBinding.GoogleIamWorkloadIdentityPoolIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
