...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlechroniclerule"
...
&googlechroniclerule.GoogleChronicleRuleConfig {
	...
	Scope: *string,
	Text: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleChronicleRule.GoogleChronicleRuleTimeouts,
}
```
