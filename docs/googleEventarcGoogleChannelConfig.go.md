...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleeventarcgooglechannelconfig"
...
&googleeventarcgooglechannelconfig.GoogleEventarcGoogleChannelConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleEventarcGoogleChannelConfig.GoogleEventarcGoogleChannelConfigTimeouts,
}
```
