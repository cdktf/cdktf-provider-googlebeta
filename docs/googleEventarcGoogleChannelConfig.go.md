...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googleeventarcgooglechannelconfig"
...
&googleeventarcgooglechannelconfig.GoogleEventarcGoogleChannelConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleEventarcGoogleChannelConfig.GoogleEventarcGoogleChannelConfigTimeouts,
}
```
