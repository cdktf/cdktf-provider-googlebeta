...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlefirebaserulesrelease"
...
&googlefirebaserulesrelease.GoogleFirebaserulesReleaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleFirebaserulesRelease.GoogleFirebaserulesReleaseTimeouts,
}
```
