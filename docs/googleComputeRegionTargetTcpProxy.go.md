...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecomputeregiontargettcpproxy"
...
&googlecomputeregiontargettcpproxy.GoogleComputeRegionTargetTcpProxyConfig {
	...
	ProxyHeader: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputeRegionTargetTcpProxy.GoogleComputeRegionTargetTcpProxyTimeouts,
}
```
