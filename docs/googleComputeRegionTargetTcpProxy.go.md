...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlecomputeregiontargettcpproxy"
...
&googlecomputeregiontargettcpproxy.GoogleComputeRegionTargetTcpProxyConfig {
	...
	ProxyHeader: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleComputeRegionTargetTcpProxy.GoogleComputeRegionTargetTcpProxyTimeouts,
}
```
