...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlelogginglogviewiambinding"
...
&googlelogginglogviewiambinding.GoogleLoggingLogViewIamBindingConfig {
	...
	Parent: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleLoggingLogViewIamBinding.GoogleLoggingLogViewIamBindingCondition,
	Id: *string,
	Location: *string,
}
```
