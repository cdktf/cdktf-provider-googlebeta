...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlelogginglogviewiambinding"
...
&googlelogginglogviewiambinding.GoogleLoggingLogViewIamBindingConfig {
	...
	Parent: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleLoggingLogViewIamBinding.GoogleLoggingLogViewIamBindingCondition,
	Id: *string,
	Location: *string,
}
```
