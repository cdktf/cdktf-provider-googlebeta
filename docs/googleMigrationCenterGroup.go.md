...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googlemigrationcentergroup"
...
&googlemigrationcentergroup.GoogleMigrationCenterGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleMigrationCenterGroup.GoogleMigrationCenterGroupTimeouts,
}
```
