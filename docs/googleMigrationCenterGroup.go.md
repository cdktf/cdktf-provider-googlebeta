...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlemigrationcentergroup"
...
&googlemigrationcentergroup.GoogleMigrationCenterGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleMigrationCenterGroup.GoogleMigrationCenterGroupTimeouts,
}
```
