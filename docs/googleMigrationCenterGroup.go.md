...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlemigrationcentergroup"
...
&googlemigrationcentergroup.GoogleMigrationCenterGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleMigrationCenterGroup.GoogleMigrationCenterGroupTimeouts,
}
```
