...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleapigeeenvreferences"
...
&googleapigeeenvreferences.GoogleApigeeEnvReferencesConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleApigeeEnvReferences.GoogleApigeeEnvReferencesTimeouts,
}
```
