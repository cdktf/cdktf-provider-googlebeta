...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleapigeeenvreferences"
...
&googleapigeeenvreferences.GoogleApigeeEnvReferencesConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleApigeeEnvReferences.GoogleApigeeEnvReferencesTimeouts,
}
```
