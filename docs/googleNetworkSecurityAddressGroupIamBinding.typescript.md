...
```typescript
import { googleNetworkSecurityAddressGroupIamBinding } from '@cdktf/provider-google-beta'

new googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding(scope: Construct, id: string, config: GoogleNetworkSecurityAddressGroupIamBindingConfig)
```
...
```typescript
public putCondition(value: GoogleNetworkSecurityAddressGroupIamBindingCondition): void
```
...
googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.isConstruct(x: any)
```
...
googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.isTerraformElement(x: any)
```
...
googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.isTerraformResource(x: any)
```
...
googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.property.lifecycle">lifecycle</a></code> | <code>cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.property.provider">provider</a></code> | <code>cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBinding.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: GoogleNetworkSecurityAddressGroupIamBindingConditionOutputReference;
```
...
```typescript
public readonly conditionInput: GoogleNetworkSecurityAddressGroupIamBindingCondition;
```
...
const googleNetworkSecurityAddressGroupIamBindingCondition: googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingCondition = { ... }
```
...
const googleNetworkSecurityAddressGroupIamBindingConfig: googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingConfig.property.lifecycle">lifecycle</a></code> | <code>cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingConfig.property.provider">provider</a></code> | <code>cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: GoogleNetworkSecurityAddressGroupIamBindingCondition;
```
...
new googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingConditionOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google-beta.googleNetworkSecurityAddressGroupIamBinding.GoogleNetworkSecurityAddressGroupIamBindingConditionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: GoogleNetworkSecurityAddressGroupIamBindingCondition;
```
