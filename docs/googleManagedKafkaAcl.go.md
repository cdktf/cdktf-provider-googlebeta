...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlemanagedkafkaacl"
...
&googlemanagedkafkaacl.GoogleManagedKafkaAclConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleManagedKafkaAcl.GoogleManagedKafkaAclTimeouts,
}
```
