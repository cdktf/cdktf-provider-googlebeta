...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlemanagedkafkaacl"
...
&googlemanagedkafkaacl.GoogleManagedKafkaAclConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleManagedKafkaAcl.GoogleManagedKafkaAclTimeouts,
}
```
