...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlespannerdatabaseiambinding"
...
&googlespannerdatabaseiambinding.GoogleSpannerDatabaseIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleSpannerDatabaseIamBinding.GoogleSpannerDatabaseIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
