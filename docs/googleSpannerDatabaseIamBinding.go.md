...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlespannerdatabaseiambinding"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.46.0/docs/resources/google_spanner_database_iam_binding#import import section} in the documentation of this resource for the id to use
...
&googlespannerdatabaseiambinding.GoogleSpannerDatabaseIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleSpannerDatabaseIamBinding.GoogleSpannerDatabaseIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
