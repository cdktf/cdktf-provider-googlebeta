...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googledatastreamprivateconnection"
...
```go
func PutPscInterfaceConfig(value GoogleDatastreamPrivateConnectionPscInterfaceConfig)
```
...
```go
func PscInterfaceConfig() GoogleDatastreamPrivateConnectionPscInterfaceConfigOutputReference
```
...
```go
func PscInterfaceConfigInput() GoogleDatastreamPrivateConnectionPscInterfaceConfig
```
...
&googledatastreamprivateconnection.GoogleDatastreamPrivateConnectionConfig {
	...
	Project: *string,
	PscInterfaceConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleDatastreamPrivateConnection.GoogleDatastreamPrivateConnectionPscInterfaceConfig,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleDatastreamPrivateConnection.GoogleDatastreamPrivateConnectionTimeouts,
	VpcPeeringConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleDatastreamPrivateConnection.GoogleDatastreamPrivateConnectionVpcPeeringConfig,
}
```
...
```go
PscInterfaceConfig GoogleDatastreamPrivateConnectionPscInterfaceConfig
```
...
googledatastreamprivateconnection.NewGoogleDatastreamPrivateConnectionPscInterfaceConfigOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) GoogleDatastreamPrivateConnectionPscInterfaceConfigOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google-beta.googleDatastreamPrivateConnection.GoogleDatastreamPrivateConnectionPscInterfaceConfigOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.IInterpolatingParent</code> | The parent resource. |
...
```go
func InternalValue() GoogleDatastreamPrivateConnectionPscInterfaceConfig
```
