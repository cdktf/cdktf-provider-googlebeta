...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlecomputesslpolicy"
...
&googlecomputesslpolicy.GoogleComputeSslPolicyConfig {
	...
	Profile: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleComputeSslPolicy.GoogleComputeSslPolicyTimeouts,
}
```
