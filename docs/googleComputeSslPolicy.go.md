...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecomputesslpolicy"
...
&googlecomputesslpolicy.GoogleComputeSslPolicyConfig {
	...
	Profile: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputeSslPolicy.GoogleComputeSslPolicyTimeouts,
}
```
