...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlecomputeregionsslpolicy"
...
&googlecomputeregionsslpolicy.GoogleComputeRegionSslPolicyConfig {
	...
	Profile: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleComputeRegionSslPolicy.GoogleComputeRegionSslPolicyTimeouts,
}
```
