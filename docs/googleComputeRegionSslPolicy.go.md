...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlecomputeregionsslpolicy"
...
&googlecomputeregionsslpolicy.GoogleComputeRegionSslPolicyConfig {
	...
	Profile: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleComputeRegionSslPolicy.GoogleComputeRegionSslPolicyTimeouts,
}
```
