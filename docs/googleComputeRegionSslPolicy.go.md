...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlecomputeregionsslpolicy"
...
&googlecomputeregionsslpolicy.GoogleComputeRegionSslPolicyConfig {
	...
	Profile: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleComputeRegionSslPolicy.GoogleComputeRegionSslPolicyTimeouts,
}
```
