...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecomputeregionsslpolicy"
...
&googlecomputeregionsslpolicy.GoogleComputeRegionSslPolicyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputeRegionSslPolicy.GoogleComputeRegionSslPolicyTimeouts,
}
```
