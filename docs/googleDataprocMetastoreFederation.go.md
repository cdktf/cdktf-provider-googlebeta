...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googledataprocmetastorefederation"
...
&googledataprocmetastorefederation.GoogleDataprocMetastoreFederationConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleDataprocMetastoreFederation.GoogleDataprocMetastoreFederationTimeouts,
}
```
