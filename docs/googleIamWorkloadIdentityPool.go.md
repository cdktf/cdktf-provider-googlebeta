...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleiamworkloadidentitypool"
...
&googleiamworkloadidentitypool.GoogleIamWorkloadIdentityPoolConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleIamWorkloadIdentityPool.GoogleIamWorkloadIdentityPoolTimeouts,
}
```
