...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleiamworkloadidentitypool"
...
&googleiamworkloadidentitypool.GoogleIamWorkloadIdentityPoolConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleIamWorkloadIdentityPool.GoogleIamWorkloadIdentityPoolTimeouts,
}
```
