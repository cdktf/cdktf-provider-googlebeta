...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlecomputeglobalforwardingrule"
...
&googlecomputeglobalforwardingrule.GoogleComputeGlobalForwardingRuleConfig {
	...
	Subnetwork: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleComputeGlobalForwardingRule.GoogleComputeGlobalForwardingRuleTimeouts,
}
```
