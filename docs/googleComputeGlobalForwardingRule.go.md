...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputeglobalforwardingrule"
...
&googlecomputeglobalforwardingrule.GoogleComputeGlobalForwardingRuleConfig {
	...
	PortRange: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeGlobalForwardingRule.GoogleComputeGlobalForwardingRuleTimeouts,
}
```
