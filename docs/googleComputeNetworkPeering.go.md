...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlecomputenetworkpeering"
...
&googlecomputenetworkpeering.GoogleComputeNetworkPeeringConfig {
	...
	StackType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleComputeNetworkPeering.GoogleComputeNetworkPeeringTimeouts,
}
```
