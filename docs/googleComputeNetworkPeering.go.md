...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlecomputenetworkpeering"
...
&googlecomputenetworkpeering.GoogleComputeNetworkPeeringConfig {
	...
	StackType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleComputeNetworkPeering.GoogleComputeNetworkPeeringTimeouts,
}
```
