...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlecomputenetworkpeering"
...
&googlecomputenetworkpeering.GoogleComputeNetworkPeeringConfig {
	...
	StackType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleComputeNetworkPeering.GoogleComputeNetworkPeeringTimeouts,
}
```
