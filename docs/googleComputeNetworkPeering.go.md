...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputenetworkpeering"
...
&googlecomputenetworkpeering.GoogleComputeNetworkPeeringConfig {
	...
	StackType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputeNetworkPeering.GoogleComputeNetworkPeeringTimeouts,
}
```
