...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlecomputenetworkpeering"
...
&googlecomputenetworkpeering.GoogleComputeNetworkPeeringConfig {
	...
	StackType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleComputeNetworkPeering.GoogleComputeNetworkPeeringTimeouts,
}
```
