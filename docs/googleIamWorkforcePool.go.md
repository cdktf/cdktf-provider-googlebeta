...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleiamworkforcepool"
...
&googleiamworkforcepool.GoogleIamWorkforcePoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleIamWorkforcePool.GoogleIamWorkforcePoolTimeouts,
}
```
