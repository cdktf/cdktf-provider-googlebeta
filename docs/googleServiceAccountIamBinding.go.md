...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleserviceaccountiambinding"
...
&googleserviceaccountiambinding.GoogleServiceAccountIamBindingConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingCondition,
	Id: *string,
}
```
