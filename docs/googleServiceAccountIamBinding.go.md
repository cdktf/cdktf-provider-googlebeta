...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleserviceaccountiambinding"
...
&googleserviceaccountiambinding.GoogleServiceAccountIamBindingConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingCondition,
	Id: *string,
}
```
