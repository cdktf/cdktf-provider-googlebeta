...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googleserviceaccountiambinding"
...
&googleserviceaccountiambinding.GoogleServiceAccountIamBindingConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingCondition,
	Id: *string,
}
```
