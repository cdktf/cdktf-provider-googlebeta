...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googleserviceaccountiambinding"
...
&googleserviceaccountiambinding.GoogleServiceAccountIamBindingConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingCondition,
	Id: *string,
}
```
