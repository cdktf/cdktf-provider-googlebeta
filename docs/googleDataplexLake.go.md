...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googledataplexlake"
...
&googledataplexlake.GoogleDataplexLakeConfig {
	...
	Metastore: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleDataplexLake.GoogleDataplexLakeMetastore,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleDataplexLake.GoogleDataplexLakeTimeouts,
}
```
