...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googledataplexlake"
...
&googledataplexlake.GoogleDataplexLakeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleDataplexLake.GoogleDataplexLakeTimeouts,
}
```
