...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlealloydbuser"
...
&googlealloydbuser.GoogleAlloydbUserConfig {
	...
	Id: *string,
	Password: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleAlloydbUser.GoogleAlloydbUserTimeouts,
}
```
