...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlealloydbuser"
...
&googlealloydbuser.GoogleAlloydbUserConfig {
	...
	Id: *string,
	Password: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleAlloydbUser.GoogleAlloydbUserTimeouts,
}
```
