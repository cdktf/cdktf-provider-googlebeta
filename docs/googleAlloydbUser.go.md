...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlealloydbuser"
...
&googlealloydbuser.GoogleAlloydbUserConfig {
	...
	Id: *string,
	Password: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleAlloydbUser.GoogleAlloydbUserTimeouts,
}
```
