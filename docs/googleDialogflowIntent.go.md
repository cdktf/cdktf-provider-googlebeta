...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googledialogflowintent"
...
&googledialogflowintent.GoogleDialogflowIntentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleDialogflowIntent.GoogleDialogflowIntentTimeouts,
	WebhookState: *string,
}
```
