...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googledialogflowintent"
...
&googledialogflowintent.GoogleDialogflowIntentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleDialogflowIntent.GoogleDialogflowIntentTimeouts,
	WebhookState: *string,
}
```
