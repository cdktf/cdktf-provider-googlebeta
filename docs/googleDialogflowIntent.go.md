...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googledialogflowintent"
...
&googledialogflowintent.GoogleDialogflowIntentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleDialogflowIntent.GoogleDialogflowIntentTimeouts,
	WebhookState: *string,
}
```
