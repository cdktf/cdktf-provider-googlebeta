...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googledialogflowintent"
...
&googledialogflowintent.GoogleDialogflowIntentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleDialogflowIntent.GoogleDialogflowIntentTimeouts,
	WebhookState: *string,
}
```
