...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googledialogflowintent"
...
&googledialogflowintent.GoogleDialogflowIntentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleDialogflowIntent.GoogleDialogflowIntentTimeouts,
	WebhookState: *string,
}
```
