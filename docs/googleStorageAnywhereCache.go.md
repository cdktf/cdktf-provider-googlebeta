...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlestorageanywherecache"
...
&googlestorageanywherecache.GoogleStorageAnywhereCacheConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleStorageAnywhereCache.GoogleStorageAnywhereCacheTimeouts,
	Ttl: *string,
}
```
