...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googleprojectusageexportbucket"
...
&googleprojectusageexportbucket.GoogleProjectUsageExportBucketConfig {
	...
	Prefix: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketTimeouts,
}
```
