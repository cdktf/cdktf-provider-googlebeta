...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleprojectusageexportbucket"
...
| <code><a href="#@cdktf/provider-google-beta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucket.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googleprojectusageexportbucket.GoogleProjectUsageExportBucketConfig {
	...
	Prefix: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
