...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleprojectusageexportbucket"
...
&googleprojectusageexportbucket.GoogleProjectUsageExportBucketConfig {
	...
	Prefix: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketTimeouts,
}
```
