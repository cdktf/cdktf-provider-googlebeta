...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlecomputenetworkfirewallpolicy"
...
&googlecomputenetworkfirewallpolicy.GoogleComputeNetworkFirewallPolicyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleComputeNetworkFirewallPolicy.GoogleComputeNetworkFirewallPolicyTimeouts,
}
```
