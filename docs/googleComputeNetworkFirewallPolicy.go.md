...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlecomputenetworkfirewallpolicy"
...
&googlecomputenetworkfirewallpolicy.GoogleComputeNetworkFirewallPolicyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleComputeNetworkFirewallPolicy.GoogleComputeNetworkFirewallPolicyTimeouts,
}
```
