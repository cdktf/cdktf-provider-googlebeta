...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlefirebaseappleapp"
...
&googlefirebaseappleapp.GoogleFirebaseAppleAppConfig {
	...
	Project: *string,
	TeamId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleFirebaseAppleApp.GoogleFirebaseAppleAppTimeouts,
}
```
