...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlefirebaseappleapp"
...
&googlefirebaseappleapp.GoogleFirebaseAppleAppConfig {
	...
	Project: *string,
	TeamId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleFirebaseAppleApp.GoogleFirebaseAppleAppTimeouts,
}
```
