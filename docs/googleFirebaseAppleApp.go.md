...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlefirebaseappleapp"
...
&googlefirebaseappleapp.GoogleFirebaseAppleAppConfig {
	...
	Project: *string,
	TeamId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleFirebaseAppleApp.GoogleFirebaseAppleAppTimeouts,
}
```
