...
Refer to the Terraform Registory for docs: [`google_vmwareengine_network`](https://registry.terraform.io/providers/hashicorp/google-beta/4.70.0/docs/resources/google_vmwareengine_network).
