...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlefirestoredatabase"
...
&googlefirestoredatabase.GoogleFirestoreDatabaseConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleFirestoreDatabase.GoogleFirestoreDatabaseTimeouts,
}
```
