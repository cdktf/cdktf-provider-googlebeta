...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlefirestoredatabase"
...
&googlefirestoredatabase.GoogleFirestoreDatabaseConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleFirestoreDatabase.GoogleFirestoreDatabaseTimeouts,
}
```
