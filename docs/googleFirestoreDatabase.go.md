...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlefirestoredatabase"
...
&googlefirestoredatabase.GoogleFirestoreDatabaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleFirestoreDatabase.GoogleFirestoreDatabaseTimeouts,
}
```
