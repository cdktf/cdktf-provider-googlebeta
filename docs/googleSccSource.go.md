...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlesccsource"
...
&googlesccsource.GoogleSccSourceConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleSccSource.GoogleSccSourceTimeouts,
}
```
