...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlepubsubschema"
...
&googlepubsubschema.GooglePubsubSchemaConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googlePubsubSchema.GooglePubsubSchemaTimeouts,
	Type: *string,
}
```
