...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlefirebasehostingchannel"
...
&googlefirebasehostingchannel.GoogleFirebaseHostingChannelConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleFirebaseHostingChannel.GoogleFirebaseHostingChannelTimeouts,
	Ttl: *string,
}
```
