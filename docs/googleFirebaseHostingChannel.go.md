...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlefirebasehostingchannel"
...
&googlefirebasehostingchannel.GoogleFirebaseHostingChannelConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleFirebaseHostingChannel.GoogleFirebaseHostingChannelTimeouts,
	Ttl: *string,
}
```
