...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlecomputeglobaladdress"
...
&googlecomputeglobaladdress.GoogleComputeGlobalAddressConfig {
	...
	Project: *string,
	Purpose: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleComputeGlobalAddress.GoogleComputeGlobalAddressTimeouts,
}
```
