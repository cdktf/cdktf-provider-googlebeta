...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlecomputeglobaladdress"
...
&googlecomputeglobaladdress.GoogleComputeGlobalAddressConfig {
	...
	Project: *string,
	Purpose: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleComputeGlobalAddress.GoogleComputeGlobalAddressTimeouts,
}
```
