...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleprojectiammember"
...
&googleprojectiammember.GoogleProjectIamMemberConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleProjectIamMember.GoogleProjectIamMemberCondition,
	Id: *string,
}
```
