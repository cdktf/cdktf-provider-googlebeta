...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleprojectiammember"
...
&googleprojectiammember.GoogleProjectIamMemberConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleProjectIamMember.GoogleProjectIamMemberCondition,
	Id: *string,
}
```
