...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googleprojectiammember"
...
&googleprojectiammember.GoogleProjectIamMemberConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleProjectIamMember.GoogleProjectIamMemberCondition,
	Id: *string,
}
```
