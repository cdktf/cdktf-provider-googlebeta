...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googleprojectiammember"
...
&googleprojectiammember.GoogleProjectIamMemberConfig {
	...
	Project: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleProjectIamMember.GoogleProjectIamMemberCondition,
	Id: *string,
}
```
