...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputeimage"
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeImage.GoogleComputeImage.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googlecomputeimage.GoogleComputeImageConfig {
	...
	Id: *string,
	ImageEncryptionKey: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeImage.GoogleComputeImageImageEncryptionKey,
	Labels: *map[string]*string,
	Licenses: *[]*string,
	Project: *string,
	RawDisk: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeImage.GoogleComputeImageRawDisk,
	SourceDisk: *string,
	SourceImage: *string,
	SourceSnapshot: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeImage.GoogleComputeImageTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeImage.GoogleComputeImageConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
