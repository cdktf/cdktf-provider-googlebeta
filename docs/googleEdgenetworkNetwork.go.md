...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleedgenetworknetwork"
...
&googleedgenetworknetwork.GoogleEdgenetworkNetworkConfig {
	...
	Mtu: *f64,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleEdgenetworkNetwork.GoogleEdgenetworkNetworkTimeouts,
}
```
