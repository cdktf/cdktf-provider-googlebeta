...
```typescript
public readonly timeoutsInput: GoogleComputePublicAdvertisedPrefixTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-google-beta.googleComputePublicAdvertisedPrefix.GoogleComputePublicAdvertisedPrefixTimeouts">GoogleComputePublicAdvertisedPrefixTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: GoogleComputePublicAdvertisedPrefixTimeouts | IResolvable;
```
