...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleapigeeinstance"
...
&googleapigeeinstance.GoogleApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleApigeeInstance.GoogleApigeeInstanceTimeouts,
}
```
