...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googleapigeeinstance"
...
&googleapigeeinstance.GoogleApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleApigeeInstance.GoogleApigeeInstanceTimeouts,
}
```
