...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleapigeeinstance"
...
&googleapigeeinstance.GoogleApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleApigeeInstance.GoogleApigeeInstanceTimeouts,
}
```
