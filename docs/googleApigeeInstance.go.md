...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleapigeeinstance"
...
&googleapigeeinstance.GoogleApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleApigeeInstance.GoogleApigeeInstanceTimeouts,
}
```
