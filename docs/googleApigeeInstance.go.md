...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleapigeeinstance"
...
&googleapigeeinstance.GoogleApigeeInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleApigeeInstance.GoogleApigeeInstanceTimeouts,
}
```
