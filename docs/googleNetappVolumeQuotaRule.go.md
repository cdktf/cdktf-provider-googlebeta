...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlenetappvolumequotarule"
...
&googlenetappvolumequotarule.GoogleNetappVolumeQuotaRuleConfig {
	...
	Project: *string,
	Target: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleNetappVolumeQuotaRule.GoogleNetappVolumeQuotaRuleTimeouts,
}
```
