...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlenetappvolumequotarule"
...
&googlenetappvolumequotarule.GoogleNetappVolumeQuotaRuleConfig {
	...
	Project: *string,
	Target: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleNetappVolumeQuotaRule.GoogleNetappVolumeQuotaRuleTimeouts,
}
```
