...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlefirebaseapphostingdefaultdomain"
...
&googlefirebaseapphostingdefaultdomain.GoogleFirebaseAppHostingDefaultDomainConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleFirebaseAppHostingDefaultDomain.GoogleFirebaseAppHostingDefaultDomainTimeouts,
}
```
