...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlesccfoldersccbigqueryexport"
...
&googlesccfoldersccbigqueryexport.GoogleSccFolderSccBigQueryExportConfig {
	...
	Folder: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleSccFolderSccBigQueryExport.GoogleSccFolderSccBigQueryExportTimeouts,
}
```
