...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlecloudiotregistry"
...
&googlecloudiotregistry.GoogleCloudiotRegistryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleCloudiotRegistry.GoogleCloudiotRegistryTimeouts,
}
```
