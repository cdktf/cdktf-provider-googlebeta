...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlecloudiotregistry"
...
&googlecloudiotregistry.GoogleCloudiotRegistryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleCloudiotRegistry.GoogleCloudiotRegistryTimeouts,
}
```
