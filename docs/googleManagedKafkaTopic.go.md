...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlemanagedkafkatopic"
...
&googlemanagedkafkatopic.GoogleManagedKafkaTopicConfig {
	...
	PartitionCount: *f64,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleManagedKafkaTopic.GoogleManagedKafkaTopicTimeouts,
}
```
