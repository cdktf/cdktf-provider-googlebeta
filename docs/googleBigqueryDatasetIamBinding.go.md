...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlebigquerydatasetiambinding"
...
&googlebigquerydatasetiambinding.GoogleBigqueryDatasetIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleBigqueryDatasetIamBinding.GoogleBigqueryDatasetIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
