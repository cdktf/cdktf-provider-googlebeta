...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlebigquerydatasetiambinding"
...
&googlebigquerydatasetiambinding.GoogleBigqueryDatasetIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleBigqueryDatasetIamBinding.GoogleBigqueryDatasetIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
