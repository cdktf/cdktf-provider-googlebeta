...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputeserviceattachment"
...
&googlecomputeserviceattachment.GoogleComputeServiceAttachmentConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeServiceAttachment.GoogleComputeServiceAttachmentTimeouts,
}
```
