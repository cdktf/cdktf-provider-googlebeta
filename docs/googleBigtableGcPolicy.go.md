...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlebigtablegcpolicy"
...
&googlebigtablegcpolicy.GoogleBigtableGcPolicyConfig {
	...
	GcRules: *string,
	Id: *string,
	MaxAge: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleBigtableGcPolicy.GoogleBigtableGcPolicyMaxAge,
	MaxVersion: interface{},
	Mode: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleBigtableGcPolicy.GoogleBigtableGcPolicyTimeouts,
}
```
