...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlebigtabletable"
...
&googlebigtabletable.GoogleBigtableTableConfig {
	...
	Project: *string,
	SplitKeys: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleBigtableTable.GoogleBigtableTableTimeouts,
}
```
