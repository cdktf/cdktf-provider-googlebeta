...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlebigtabletable"
...
&googlebigtabletable.GoogleBigtableTableConfig {
	...
	Project: *string,
	SplitKeys: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleBigtableTable.GoogleBigtableTableTimeouts,
}
```
