...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googleapigeeenvironmentiambinding"
...
&googleapigeeenvironmentiambinding.GoogleApigeeEnvironmentIamBindingConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleApigeeEnvironmentIamBinding.GoogleApigeeEnvironmentIamBindingCondition,
	Id: *string,
}
```
