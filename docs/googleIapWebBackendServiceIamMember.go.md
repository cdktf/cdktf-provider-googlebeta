...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleiapwebbackendserviceiammember"
...
&googleiapwebbackendserviceiammember.GoogleIapWebBackendServiceIamMemberConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleIapWebBackendServiceIamMember.GoogleIapWebBackendServiceIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
