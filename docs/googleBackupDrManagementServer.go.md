...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlebackupdrmanagementserver"
...
&googlebackupdrmanagementserver.GoogleBackupDrManagementServerConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleBackupDrManagementServer.GoogleBackupDrManagementServerTimeouts,
	Type: *string,
}
```
