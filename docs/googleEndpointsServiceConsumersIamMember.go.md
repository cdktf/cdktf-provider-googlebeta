...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleendpointsserviceconsumersiammember"
...
&googleendpointsserviceconsumersiammember.GoogleEndpointsServiceConsumersIamMemberConfig {
	...
	Role: *string,
	ServiceName: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleEndpointsServiceConsumersIamMember.GoogleEndpointsServiceConsumersIamMemberCondition,
	Id: *string,
}
```
