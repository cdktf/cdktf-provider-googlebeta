...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlecomputeprojectdefaultnetworktier"
...
&googlecomputeprojectdefaultnetworktier.GoogleComputeProjectDefaultNetworkTierConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleComputeProjectDefaultNetworkTier.GoogleComputeProjectDefaultNetworkTierTimeouts,
}
```
