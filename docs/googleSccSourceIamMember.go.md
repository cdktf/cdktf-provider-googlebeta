...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlesccsourceiammember"
...
&googlesccsourceiammember.GoogleSccSourceIamMemberConfig {
	...
	Role: *string,
	Source: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleSccSourceIamMember.GoogleSccSourceIamMemberCondition,
	Id: *string,
}
```
