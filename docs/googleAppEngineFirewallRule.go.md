...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googleappenginefirewallrule"
...
&googleappenginefirewallrule.GoogleAppEngineFirewallRuleConfig {
	...
	Priority: *f64,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleAppEngineFirewallRule.GoogleAppEngineFirewallRuleTimeouts,
}
```
