...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleappenginefirewallrule"
...
&googleappenginefirewallrule.GoogleAppEngineFirewallRuleConfig {
	...
	Priority: *f64,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleAppEngineFirewallRule.GoogleAppEngineFirewallRuleTimeouts,
}
```
