...
Refer to the Terraform Registory for docs: [`data_google_dataproc_metastore_service`](https://registry.terraform.io/providers/hashicorp/google-beta/4.62.0/docs/data-sources/google_dataproc_metastore_service).
...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/datagoogledataprocmetastoreservice"
