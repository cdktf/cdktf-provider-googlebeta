...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlelogginglinkeddataset"
...
&googlelogginglinkeddataset.GoogleLoggingLinkedDatasetConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleLoggingLinkedDataset.GoogleLoggingLinkedDatasetTimeouts,
}
```
