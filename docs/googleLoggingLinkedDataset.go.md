...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlelogginglinkeddataset"
...
&googlelogginglinkeddataset.GoogleLoggingLinkedDatasetConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleLoggingLinkedDataset.GoogleLoggingLinkedDatasetTimeouts,
}
```
