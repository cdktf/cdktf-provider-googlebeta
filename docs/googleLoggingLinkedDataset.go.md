...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlelogginglinkeddataset"
...
&googlelogginglinkeddataset.GoogleLoggingLinkedDatasetConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleLoggingLinkedDataset.GoogleLoggingLinkedDatasetTimeouts,
}
```
