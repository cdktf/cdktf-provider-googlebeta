...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googletagstagbinding"
...
&googletagstagbinding.GoogleTagsTagBindingConfig {
	...
	TagValue: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleTagsTagBinding.GoogleTagsTagBindingTimeouts,
}
```
