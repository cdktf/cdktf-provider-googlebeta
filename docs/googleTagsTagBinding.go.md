...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googletagstagbinding"
...
&googletagstagbinding.GoogleTagsTagBindingConfig {
	...
	TagValue: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleTagsTagBinding.GoogleTagsTagBindingTimeouts,
}
```
