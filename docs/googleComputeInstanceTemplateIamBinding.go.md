...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlecomputeinstancetemplateiambinding"

googlecomputeinstancetemplateiambinding.NewGoogleComputeInstanceTemplateIamBinding(scope Construct, id *string, config GoogleComputeInstanceTemplateIamBindingConfig) GoogleComputeInstanceTemplateIamBinding
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
```go
func PutCondition(value GoogleComputeInstanceTemplateIamBindingCondition)
```
...
googlecomputeinstancetemplateiambinding.GoogleComputeInstanceTemplateIamBinding_IsConstruct(x interface{}) *bool
```
...
googlecomputeinstancetemplateiambinding.GoogleComputeInstanceTemplateIamBinding_IsTerraformElement(x interface{}) *bool
```
...
googlecomputeinstancetemplateiambinding.GoogleComputeInstanceTemplateIamBinding_IsTerraformResource(x interface{}) *bool
```
...
googlecomputeinstancetemplateiambinding.GoogleComputeInstanceTemplateIamBinding_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.property.cdktfStack">CdktfStack</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.property.forEach">ForEach</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.property.lifecycle">Lifecycle</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.property.provider">Provider</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBinding.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
```go
func Condition() GoogleComputeInstanceTemplateIamBindingConditionOutputReference
```
...
```go
func ConditionInput() GoogleComputeInstanceTemplateIamBindingCondition
```
...
&googlecomputeinstancetemplateiambinding.GoogleComputeInstanceTemplateIamBindingCondition {
	Expression: *string,
	Title: *string,
	Description: *string,
}
...
&googlecomputeinstancetemplateiambinding.GoogleComputeInstanceTemplateIamBindingConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/hashicorp/terraform-cdk-go/cdktf.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingConfig.property.forEach">ForEach</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingConfig.property.lifecycle">Lifecycle</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingConfig.property.provider">Provider</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingConfig.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
```go
Condition GoogleComputeInstanceTemplateIamBindingCondition
```
...
googlecomputeinstancetemplateiambinding.NewGoogleComputeInstanceTemplateIamBindingConditionOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) GoogleComputeInstanceTemplateIamBindingConditionOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google-beta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingConditionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.IInterpolatingParent</code> | The parent resource. |
...
```go
func InternalValue() GoogleComputeInstanceTemplateIamBindingCondition
```
