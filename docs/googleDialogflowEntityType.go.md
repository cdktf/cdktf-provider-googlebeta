...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googledialogflowentitytype"
...
&googledialogflowentitytype.GoogleDialogflowEntityTypeConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleDialogflowEntityType.GoogleDialogflowEntityTypeTimeouts,
}
```
