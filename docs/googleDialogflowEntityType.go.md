...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googledialogflowentitytype"
...
&googledialogflowentitytype.GoogleDialogflowEntityTypeConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleDialogflowEntityType.GoogleDialogflowEntityTypeTimeouts,
}
```
