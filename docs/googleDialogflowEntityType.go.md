...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googledialogflowentitytype"
...
googledialogflowentitytype.GoogleDialogflowEntityType_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
&googledialogflowentitytype.GoogleDialogflowEntityTypeConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleDialogflowEntityType.GoogleDialogflowEntityTypeTimeouts,
}
```
