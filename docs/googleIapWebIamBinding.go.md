...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleiapwebiambinding"
...
&googleiapwebiambinding.GoogleIapWebIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleIapWebIamBinding.GoogleIapWebIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
