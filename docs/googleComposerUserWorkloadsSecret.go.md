...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlecomposeruserworkloadssecret"
...
&googlecomposeruserworkloadssecret.GoogleComposerUserWorkloadsSecretConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleComposerUserWorkloadsSecret.GoogleComposerUserWorkloadsSecretTimeouts,
}
```
