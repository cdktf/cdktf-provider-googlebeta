...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlesecretmanagersecretiambinding"
...
&googlesecretmanagersecretiambinding.GoogleSecretManagerSecretIamBindingConfig {
	...
	Role: *string,
	SecretId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleSecretManagerSecretIamBinding.GoogleSecretManagerSecretIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
