...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlesecretmanagersecretiambinding"
...
&googlesecretmanagersecretiambinding.GoogleSecretManagerSecretIamBindingConfig {
	...
	Role: *string,
	SecretId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleSecretManagerSecretIamBinding.GoogleSecretManagerSecretIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
