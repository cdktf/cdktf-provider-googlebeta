...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlekmskeyhandle"
...
&googlekmskeyhandle.GoogleKmsKeyHandleConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleKmsKeyHandle.GoogleKmsKeyHandleTimeouts,
}
```
