...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googledialogflowcxversion"
...
&googledialogflowcxversion.GoogleDialogflowCxVersionConfig {
	...
	Id: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleDialogflowCxVersion.GoogleDialogflowCxVersionTimeouts,
}
```
