...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googledialogflowcxversion"
...
&googledialogflowcxversion.GoogleDialogflowCxVersionConfig {
	...
	Id: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleDialogflowCxVersion.GoogleDialogflowCxVersionTimeouts,
}
```
