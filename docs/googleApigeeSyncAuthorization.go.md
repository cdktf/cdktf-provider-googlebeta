...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleapigeesyncauthorization"
...
&googleapigeesyncauthorization.GoogleApigeeSyncAuthorizationConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleApigeeSyncAuthorization.GoogleApigeeSyncAuthorizationTimeouts,
}
```
