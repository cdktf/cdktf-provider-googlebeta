...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleapigeesyncauthorization"
...
&googleapigeesyncauthorization.GoogleApigeeSyncAuthorizationConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleApigeeSyncAuthorization.GoogleApigeeSyncAuthorizationTimeouts,
}
```
