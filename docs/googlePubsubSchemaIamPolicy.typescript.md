...
```typescript
import { googlePubsubSchemaIamPolicy } from '@cdktf/provider-google-beta'

new googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy(scope: Construct, id: string, config: GooglePubsubSchemaIamPolicyConfig)
```
...
googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy.isConstruct(x: any)
```
...
googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy.isTerraformElement(x: any)
```
...
googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy.isTerraformResource(x: any)
```
...
googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-google-beta.googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicy.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
const googlePubsubSchemaIamPolicyConfig: googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicyConfig = { ... }
```
...
| <code><a href="#@cdktf/provider-google-beta.googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicyConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicyConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googlePubsubSchemaIamPolicy.GooglePubsubSchemaIamPolicyConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
