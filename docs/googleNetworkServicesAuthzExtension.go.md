...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlenetworkservicesauthzextension"
...
&googlenetworkservicesauthzextension.GoogleNetworkServicesAuthzExtensionConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleNetworkServicesAuthzExtension.GoogleNetworkServicesAuthzExtensionTimeouts,
	WireFormat: *string,
}
```
