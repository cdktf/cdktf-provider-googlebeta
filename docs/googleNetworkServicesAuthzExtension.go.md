...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlenetworkservicesauthzextension"
...
&googlenetworkservicesauthzextension.GoogleNetworkServicesAuthzExtensionConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleNetworkServicesAuthzExtension.GoogleNetworkServicesAuthzExtensionTimeouts,
	WireFormat: *string,
}
```
