...
```typescript
import { googleDataprocMetastoreTableIamMember } from '@cdktf/provider-google-beta'

new googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember(scope: Construct, id: string, config: GoogleDataprocMetastoreTableIamMemberConfig)
```
...
```typescript
public putCondition(value: GoogleDataprocMetastoreTableIamMemberCondition): void
```
...
googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember.isConstruct(x: any)
```
...
googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember.isTerraformElement(x: any)
```
...
googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember.isTerraformResource(x: any)
```
...
googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMember.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: GoogleDataprocMetastoreTableIamMemberConditionOutputReference;
```
...
```typescript
public readonly conditionInput: GoogleDataprocMetastoreTableIamMemberCondition;
```
...
const googleDataprocMetastoreTableIamMemberCondition: googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMemberCondition = { ... }
```
...
const googleDataprocMetastoreTableIamMemberConfig: googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMemberConfig = { ... }
```
...
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMemberConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMemberConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMemberConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMemberConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: GoogleDataprocMetastoreTableIamMemberCondition;
```
...
new googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMemberConditionOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google-beta.googleDataprocMetastoreTableIamMember.GoogleDataprocMetastoreTableIamMemberConditionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: GoogleDataprocMetastoreTableIamMemberCondition;
```
