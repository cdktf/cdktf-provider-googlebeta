...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlehealthcaredicomstoreiammember"
...
&googlehealthcaredicomstoreiammember.GoogleHealthcareDicomStoreIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleHealthcareDicomStoreIamMember.GoogleHealthcareDicomStoreIamMemberCondition,
	Id: *string,
}
```
