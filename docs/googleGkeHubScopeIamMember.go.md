...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlegkehubscopeiammember"
...
&googlegkehubscopeiammember.GoogleGkeHubScopeIamMemberConfig {
	...
	Role: *string,
	ScopeId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleGkeHubScopeIamMember.GoogleGkeHubScopeIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
