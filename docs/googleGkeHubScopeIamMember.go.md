...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlegkehubscopeiammember"
...
&googlegkehubscopeiammember.GoogleGkeHubScopeIamMemberConfig {
	...
	Role: *string,
	ScopeId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleGkeHubScopeIamMember.GoogleGkeHubScopeIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
