...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlefilestoresnapshot"
...
&googlefilestoresnapshot.GoogleFilestoreSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeouts,
}
```
