...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlefilestoresnapshot"
...
&googlefilestoresnapshot.GoogleFilestoreSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeouts,
}
```
