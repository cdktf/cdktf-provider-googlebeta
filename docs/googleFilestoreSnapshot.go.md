...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlefilestoresnapshot"
...
&googlefilestoresnapshot.GoogleFilestoreSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeouts,
}
```
