...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlefilestoresnapshot"
...
&googlefilestoresnapshot.GoogleFilestoreSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeouts,
}
```
