...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecertificatemanagerdnsauthorization"
...
&googlecertificatemanagerdnsauthorization.GoogleCertificateManagerDnsAuthorizationConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleCertificateManagerDnsAuthorization.GoogleCertificateManagerDnsAuthorizationTimeouts,
	Type: *string,
}
```
