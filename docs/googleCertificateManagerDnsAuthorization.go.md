...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlecertificatemanagerdnsauthorization"
...
&googlecertificatemanagerdnsauthorization.GoogleCertificateManagerDnsAuthorizationConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleCertificateManagerDnsAuthorization.GoogleCertificateManagerDnsAuthorizationTimeouts,
	Type: *string,
}
```
