...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputeattacheddisk"
...
&googlecomputeattacheddisk.GoogleComputeAttachedDiskConfig {
	...
	Mode: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeAttachedDisk.GoogleComputeAttachedDiskTimeouts,
	Zone: *string,
}
```
