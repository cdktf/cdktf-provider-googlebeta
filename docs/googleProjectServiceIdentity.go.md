...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleprojectserviceidentity"
...
&googleprojectserviceidentity.GoogleProjectServiceIdentityConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleProjectServiceIdentity.GoogleProjectServiceIdentityTimeouts,
}
```
