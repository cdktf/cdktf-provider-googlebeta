...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlefirebasehostingsite"
...
&googlefirebasehostingsite.GoogleFirebaseHostingSiteConfig {
	...
	Project: *string,
	SiteId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleFirebaseHostingSite.GoogleFirebaseHostingSiteTimeouts,
}
```
