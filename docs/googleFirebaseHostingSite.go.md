...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlefirebasehostingsite"
...
&googlefirebasehostingsite.GoogleFirebaseHostingSiteConfig {
	...
	Project: *string,
	SiteId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleFirebaseHostingSite.GoogleFirebaseHostingSiteTimeouts,
}
```
