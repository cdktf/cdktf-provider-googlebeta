...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlefirebasehostingsite"
...
&googlefirebasehostingsite.GoogleFirebaseHostingSiteConfig {
	...
	Project: *string,
	SiteId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleFirebaseHostingSite.GoogleFirebaseHostingSiteTimeouts,
}
```
