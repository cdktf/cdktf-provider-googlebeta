...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlelustreinstance"
...
&googlelustreinstance.GoogleLustreInstanceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleLustreInstance.GoogleLustreInstanceTimeouts,
}
```
