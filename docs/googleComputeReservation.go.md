...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputereservation"
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeReservation.GoogleComputeReservation.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googlecomputereservation.GoogleComputeReservationConfig {
	...
	Name: *string,
	SpecificReservation: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeReservation.GoogleComputeReservationSpecificReservation,
	Zone: *string,
	Description: *string,
	Id: *string,
	Project: *string,
	ShareSettings: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeReservation.GoogleComputeReservationShareSettings,
	SpecificReservationRequired: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeReservation.GoogleComputeReservationTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleComputeReservation.GoogleComputeReservationConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googlecomputereservation.GoogleComputeReservationSpecificReservation {
	Count: *f64,
	InstanceProperties: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeReservation.GoogleComputeReservationSpecificReservationInstanceProperties,
}
```
