...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlecloudtasksqueue"
...
| <code><a href="#@cdktf/provider-google-beta.googleCloudTasksQueue.GoogleCloudTasksQueue.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googlecloudtasksqueue.GoogleCloudTasksQueueConfig {
	...
	Location: *string,
	AppEngineRoutingOverride: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleCloudTasksQueue.GoogleCloudTasksQueueAppEngineRoutingOverride,
	Id: *string,
	Name: *string,
	Project: *string,
	RateLimits: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleCloudTasksQueue.GoogleCloudTasksQueueRateLimits,
	RetryConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleCloudTasksQueue.GoogleCloudTasksQueueRetryConfig,
	StackdriverLoggingConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleCloudTasksQueue.GoogleCloudTasksQueueStackdriverLoggingConfig,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleCloudTasksQueue.GoogleCloudTasksQueueTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleCloudTasksQueue.GoogleCloudTasksQueueConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
