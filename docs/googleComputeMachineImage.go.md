...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlecomputemachineimage"
...
&googlecomputemachineimage.GoogleComputeMachineImageConfig {
	...
	Id: *string,
	MachineImageEncryptionKey: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeMachineImage.GoogleComputeMachineImageMachineImageEncryptionKey,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleComputeMachineImage.GoogleComputeMachineImageTimeouts,
}
```
