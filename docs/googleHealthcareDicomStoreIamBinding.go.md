...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlehealthcaredicomstoreiambinding"
...
&googlehealthcaredicomstoreiambinding.GoogleHealthcareDicomStoreIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleHealthcareDicomStoreIamBinding.GoogleHealthcareDicomStoreIamBindingCondition,
	Id: *string,
}
```
