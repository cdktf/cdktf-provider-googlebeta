...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlecomputeinstancesettings"
...
&googlecomputeinstancesettings.GoogleComputeInstanceSettingsConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleComputeInstanceSettings.GoogleComputeInstanceSettingsTimeouts,
}
```
