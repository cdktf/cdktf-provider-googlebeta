...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleidentityplatformconfig"
...
&googleidentityplatformconfig.GoogleIdentityPlatformConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleIdentityPlatformConfig.GoogleIdentityPlatformConfigTimeouts,
}
```
