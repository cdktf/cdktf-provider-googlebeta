...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleappengineservicesplittraffic"
...
| <code><a href="#@cdktf/provider-google-beta.googleAppEngineServiceSplitTraffic.GoogleAppEngineServiceSplitTraffic.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googleappengineservicesplittraffic.GoogleAppEngineServiceSplitTrafficConfig {
	...
	Service: *string,
	Split: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleAppEngineServiceSplitTraffic.GoogleAppEngineServiceSplitTrafficSplit,
	Id: *string,
	MigrateTraffic: interface{},
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleAppEngineServiceSplitTraffic.GoogleAppEngineServiceSplitTrafficTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleAppEngineServiceSplitTraffic.GoogleAppEngineServiceSplitTrafficConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
