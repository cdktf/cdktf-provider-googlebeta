...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlebigquerydatasetiammember"
...
&googlebigquerydatasetiammember.GoogleBigqueryDatasetIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleBigqueryDatasetIamMember.GoogleBigqueryDatasetIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
