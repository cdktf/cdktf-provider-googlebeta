...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlebigquerydatasetiammember"
...
&googlebigquerydatasetiammember.GoogleBigqueryDatasetIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleBigqueryDatasetIamMember.GoogleBigqueryDatasetIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
