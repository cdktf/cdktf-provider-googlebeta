...
```typescript
import { googleDnsManagedZoneIamPolicy } from '@cdktf/provider-google-beta'

new googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy(scope: Construct, id: string, config: GoogleDnsManagedZoneIamPolicyConfig)
```
...
googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy.isConstruct(x: any)
```
...
googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy.isTerraformElement(x: any)
```
...
googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy.isTerraformResource(x: any)
```
...
googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-google-beta.googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicy.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
const googleDnsManagedZoneIamPolicyConfig: googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicyConfig = { ... }
```
...
| <code><a href="#@cdktf/provider-google-beta.googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicyConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleDnsManagedZoneIamPolicy.GoogleDnsManagedZoneIamPolicyConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
