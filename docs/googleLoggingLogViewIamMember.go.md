...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlelogginglogviewiammember"
...
&googlelogginglogviewiammember.GoogleLoggingLogViewIamMemberConfig {
	...
	Parent: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleLoggingLogViewIamMember.GoogleLoggingLogViewIamMemberCondition,
	Id: *string,
	Location: *string,
}
```
