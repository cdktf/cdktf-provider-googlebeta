...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlelogginglogviewiammember"
...
&googlelogginglogviewiammember.GoogleLoggingLogViewIamMemberConfig {
	...
	Parent: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleLoggingLogViewIamMember.GoogleLoggingLogViewIamMemberCondition,
	Id: *string,
	Location: *string,
}
```
