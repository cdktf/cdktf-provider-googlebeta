...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecomputerouterroutepolicy"
...
&googlecomputerouterroutepolicy.GoogleComputeRouterRoutePolicyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputeRouterRoutePolicy.GoogleComputeRouterRoutePolicyTimeouts,
	Type: *string,
}
```
...
&googlecomputerouterroutepolicy.GoogleComputeRouterRoutePolicyTerms {
	Priority: *f64,
	Actions: interface{},
	Match: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputeRouterRoutePolicy.GoogleComputeRouterRoutePolicyTermsMatch,
}
```
