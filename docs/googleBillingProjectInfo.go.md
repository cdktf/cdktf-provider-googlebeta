...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlebillingprojectinfo"
...
&googlebillingprojectinfo.GoogleBillingProjectInfoConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleBillingProjectInfo.GoogleBillingProjectInfoTimeouts,
}
```
