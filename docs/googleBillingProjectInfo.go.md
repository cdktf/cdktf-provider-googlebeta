...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlebillingprojectinfo"
...
&googlebillingprojectinfo.GoogleBillingProjectInfoConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleBillingProjectInfo.GoogleBillingProjectInfoTimeouts,
}
```
