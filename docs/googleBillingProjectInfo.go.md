...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlebillingprojectinfo"
...
&googlebillingprojectinfo.GoogleBillingProjectInfoConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleBillingProjectInfo.GoogleBillingProjectInfoTimeouts,
}
```
