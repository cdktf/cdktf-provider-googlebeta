...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googleapigeeenvgroupattachment"
...
&googleapigeeenvgroupattachment.GoogleApigeeEnvgroupAttachmentConfig {
	...
	Environment: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleApigeeEnvgroupAttachment.GoogleApigeeEnvgroupAttachmentTimeouts,
}
```
