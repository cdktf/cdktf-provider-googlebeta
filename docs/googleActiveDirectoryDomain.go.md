...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleactivedirectorydomain"
...
&googleactivedirectorydomain.GoogleActiveDirectoryDomainConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleActiveDirectoryDomain.GoogleActiveDirectoryDomainTimeouts,
}
```
