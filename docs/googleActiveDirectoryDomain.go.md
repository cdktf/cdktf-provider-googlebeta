...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleactivedirectorydomain"
...
&googleactivedirectorydomain.GoogleActiveDirectoryDomainConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleActiveDirectoryDomain.GoogleActiveDirectoryDomainTimeouts,
}
```
