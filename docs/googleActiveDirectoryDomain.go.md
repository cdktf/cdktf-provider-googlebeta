...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleactivedirectorydomain"
...
&googleactivedirectorydomain.GoogleActiveDirectoryDomainConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleActiveDirectoryDomain.GoogleActiveDirectoryDomainTimeouts,
}
```
