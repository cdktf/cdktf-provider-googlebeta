...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleworkstationsworkstation"
...
&googleworkstationsworkstation.GoogleWorkstationsWorkstationConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleWorkstationsWorkstation.GoogleWorkstationsWorkstationTimeouts,
}
```
