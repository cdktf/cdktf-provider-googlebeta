...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleworkstationsworkstation"
...
&googleworkstationsworkstation.GoogleWorkstationsWorkstationConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleWorkstationsWorkstation.GoogleWorkstationsWorkstationTimeouts,
}
```
