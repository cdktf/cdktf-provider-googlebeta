...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlepubsublitereservation"
...
&googlepubsublitereservation.GooglePubsubLiteReservationConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googlePubsubLiteReservation.GooglePubsubLiteReservationTimeouts,
}
```
