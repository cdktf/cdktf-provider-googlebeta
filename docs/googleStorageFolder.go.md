...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlestoragefolder"
...
&googlestoragefolder.GoogleStorageFolderConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleStorageFolder.GoogleStorageFolderTimeouts,
}
```
