...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlestoragefolder"
...
&googlestoragefolder.GoogleStorageFolderConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleStorageFolder.GoogleStorageFolderTimeouts,
}
```
