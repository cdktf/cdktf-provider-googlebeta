...
Refer to the Terraform Registory for docs: [`google_iap_web_iam_policy`](https://registry.terraform.io/providers/hashicorp/google-beta/4.68.0/docs/resources/google_iap_web_iam_policy).
...
| <code><a href="#@cdktf/provider-google-beta.googleIapWebIamPolicy.GoogleIapWebIamPolicyConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.68.0/docs/resources/google_iap_web_iam_policy#id GoogleIapWebIamPolicy#id}. |
