...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlehealthcareconsentstore"
...
&googlehealthcareconsentstore.GoogleHealthcareConsentStoreConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleHealthcareConsentStore.GoogleHealthcareConsentStoreTimeouts,
}
```
