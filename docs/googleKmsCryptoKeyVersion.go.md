...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlekmscryptokeyversion"
...
&googlekmscryptokeyversion.GoogleKmsCryptoKeyVersionConfig {
	...
	Id: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleKmsCryptoKeyVersion.GoogleKmsCryptoKeyVersionTimeouts,
}
```
