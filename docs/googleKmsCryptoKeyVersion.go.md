...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlekmscryptokeyversion"
...
&googlekmscryptokeyversion.GoogleKmsCryptoKeyVersionConfig {
	...
	CryptoKey: *string,
	ExternalProtectionLevelOptions: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleKmsCryptoKeyVersion.GoogleKmsCryptoKeyVersionExternalProtectionLevelOptions,
	Id: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleKmsCryptoKeyVersion.GoogleKmsCryptoKeyVersionTimeouts,
}
```
