...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleapigatewayapiconfigiambinding"
...
&googleapigatewayapiconfigiambinding.GoogleApiGatewayApiConfigIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleApiGatewayApiConfigIamBinding.GoogleApiGatewayApiConfigIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
