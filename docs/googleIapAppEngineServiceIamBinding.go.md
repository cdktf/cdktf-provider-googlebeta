...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleiapappengineserviceiambinding"
...
&googleiapappengineserviceiambinding.GoogleIapAppEngineServiceIamBindingConfig {
	...
	Role: *string,
	Service: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleIapAppEngineServiceIamBinding.GoogleIapAppEngineServiceIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
