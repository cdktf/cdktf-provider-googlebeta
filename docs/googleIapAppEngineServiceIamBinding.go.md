...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googleiapappengineserviceiambinding"
...
googleiapappengineserviceiambinding.GoogleIapAppEngineServiceIamBinding_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
&googleiapappengineserviceiambinding.GoogleIapAppEngineServiceIamBindingConfig {
	...
	Role: *string,
	Service: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleIapAppEngineServiceIamBinding.GoogleIapAppEngineServiceIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
