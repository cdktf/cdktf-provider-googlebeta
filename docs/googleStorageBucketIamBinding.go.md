...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlestoragebucketiambinding"
...
&googlestoragebucketiambinding.GoogleStorageBucketIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleStorageBucketIamBinding.GoogleStorageBucketIamBindingCondition,
	Id: *string,
}
```
