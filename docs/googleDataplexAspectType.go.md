...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googledataplexaspecttype"
...
&googledataplexaspecttype.GoogleDataplexAspectTypeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleDataplexAspectType.GoogleDataplexAspectTypeTimeouts,
}
```
