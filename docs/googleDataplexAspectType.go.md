...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googledataplexaspecttype"
...
&googledataplexaspecttype.GoogleDataplexAspectTypeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataplexAspectType.GoogleDataplexAspectTypeTimeouts,
}
```
