...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlenetworkconnectivityhub"
...
&googlenetworkconnectivityhub.GoogleNetworkConnectivityHubConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubTimeouts,
}
```
