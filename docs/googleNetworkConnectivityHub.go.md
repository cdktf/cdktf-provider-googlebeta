...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlenetworkconnectivityhub"
...
&googlenetworkconnectivityhub.GoogleNetworkConnectivityHubConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubTimeouts,
}
```
