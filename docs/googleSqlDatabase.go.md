...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlesqldatabase"
...
&googlesqldatabase.GoogleSqlDatabaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleSqlDatabase.GoogleSqlDatabaseTimeouts,
}
```
