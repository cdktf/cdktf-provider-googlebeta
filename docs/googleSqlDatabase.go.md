...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlesqldatabase"
...
&googlesqldatabase.GoogleSqlDatabaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleSqlDatabase.GoogleSqlDatabaseTimeouts,
}
```
