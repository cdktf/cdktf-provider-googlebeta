...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlesqldatabase"
...
&googlesqldatabase.GoogleSqlDatabaseConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleSqlDatabase.GoogleSqlDatabaseTimeouts,
}
```
