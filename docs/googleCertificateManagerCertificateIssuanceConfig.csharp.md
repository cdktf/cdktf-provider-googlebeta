...
Refer to the Terraform Registory for docs: [`google_certificate_manager_certificate_issuance_config`](https://registry.terraform.io/providers/hashicorp/google-beta/4.72.0/docs/resources/google_certificate_manager_certificate_issuance_config).
