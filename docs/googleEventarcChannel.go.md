...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleeventarcchannel"
...
| <code><a href="#@cdktf/provider-google-beta.googleEventarcChannel.GoogleEventarcChannel.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googleeventarcchannel.GoogleEventarcChannelConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleEventarcChannel.GoogleEventarcChannelTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleEventarcChannel.GoogleEventarcChannelConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
