...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlefolder"
...
&googlefolder.GoogleFolderConfig {
	...
	Parent: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleFolder.GoogleFolderTimeouts,
}
```
