...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlefolder"
...
&googlefolder.GoogleFolderConfig {
	...
	Parent: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleFolder.GoogleFolderTimeouts,
}
```
