...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlefolder"
...
&googlefolder.GoogleFolderConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleFolder.GoogleFolderTimeouts,
}
```
