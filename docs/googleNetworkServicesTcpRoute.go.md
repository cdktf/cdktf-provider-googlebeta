...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlenetworkservicestcproute"
...
&googlenetworkservicestcproute.GoogleNetworkServicesTcpRouteConfig {
	...
	Meshes: *[]*string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleNetworkServicesTcpRoute.GoogleNetworkServicesTcpRouteTimeouts,
}
```
...
&googlenetworkservicestcproute.GoogleNetworkServicesTcpRouteRules {
	Action: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleNetworkServicesTcpRoute.GoogleNetworkServicesTcpRouteRulesAction,
	Matches: interface{},
}
```
