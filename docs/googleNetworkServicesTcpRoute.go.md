...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlenetworkservicestcproute"
...
&googlenetworkservicestcproute.GoogleNetworkServicesTcpRouteConfig {
	...
	Meshes: *[]*string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleNetworkServicesTcpRoute.GoogleNetworkServicesTcpRouteTimeouts,
}
```
...
&googlenetworkservicestcproute.GoogleNetworkServicesTcpRouteRules {
	Action: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleNetworkServicesTcpRoute.GoogleNetworkServicesTcpRouteRulesAction,
	Matches: interface{},
}
```
