...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleapigeeenvkeystore"
...
&googleapigeeenvkeystore.GoogleApigeeEnvKeystoreConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleApigeeEnvKeystore.GoogleApigeeEnvKeystoreTimeouts,
}
```
