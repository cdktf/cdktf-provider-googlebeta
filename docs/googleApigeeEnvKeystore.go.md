...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googleapigeeenvkeystore"
...
&googleapigeeenvkeystore.GoogleApigeeEnvKeystoreConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleApigeeEnvKeystore.GoogleApigeeEnvKeystoreTimeouts,
}
```
