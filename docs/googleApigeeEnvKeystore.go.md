...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleapigeeenvkeystore"
...
&googleapigeeenvkeystore.GoogleApigeeEnvKeystoreConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleApigeeEnvKeystore.GoogleApigeeEnvKeystoreTimeouts,
}
```
