...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlenetworksecurityaddressgroup"
...
&googlenetworksecurityaddressgroup.GoogleNetworkSecurityAddressGroupConfig {
	...
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleNetworkSecurityAddressGroup.GoogleNetworkSecurityAddressGroupTimeouts,
}
```
