...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlenetworksecurityaddressgroup"
...
&googlenetworksecurityaddressgroup.GoogleNetworkSecurityAddressGroupConfig {
	...
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleNetworkSecurityAddressGroup.GoogleNetworkSecurityAddressGroupTimeouts,
}
```
