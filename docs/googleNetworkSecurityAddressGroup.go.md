...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlenetworksecurityaddressgroup"
...
&googlenetworksecurityaddressgroup.GoogleNetworkSecurityAddressGroupConfig {
	...
	Parent: *string,
	Purpose: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleNetworkSecurityAddressGroup.GoogleNetworkSecurityAddressGroupTimeouts,
}
```
