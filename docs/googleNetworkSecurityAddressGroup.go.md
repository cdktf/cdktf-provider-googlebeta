...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlenetworksecurityaddressgroup"
...
&googlenetworksecurityaddressgroup.GoogleNetworkSecurityAddressGroupConfig {
	...
	Parent: *string,
	Purpose: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleNetworkSecurityAddressGroup.GoogleNetworkSecurityAddressGroupTimeouts,
}
```
