...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlecomputenetworkendpoints"
...
&googlecomputenetworkendpoints.GoogleComputeNetworkEndpointsConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleComputeNetworkEndpoints.GoogleComputeNetworkEndpointsTimeouts,
	Zone: *string,
}
```
