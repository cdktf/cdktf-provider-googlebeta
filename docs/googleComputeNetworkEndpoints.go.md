...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlecomputenetworkendpoints"
...
&googlecomputenetworkendpoints.GoogleComputeNetworkEndpointsConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleComputeNetworkEndpoints.GoogleComputeNetworkEndpointsTimeouts,
	Zone: *string,
}
```
