...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlemanagedkafkacluster"
...
&googlemanagedkafkacluster.GoogleManagedKafkaClusterConfig {
	...
	CapacityConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleManagedKafkaCluster.GoogleManagedKafkaClusterCapacityConfig,
	ClusterId: *string,
	GcpConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleManagedKafkaCluster.GoogleManagedKafkaClusterGcpConfig,
	Location: *string,
	Id: *string,
	Labels: *map[string]*string,
	Project: *string,
	RebalanceConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleManagedKafkaCluster.GoogleManagedKafkaClusterRebalanceConfig,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleManagedKafkaCluster.GoogleManagedKafkaClusterTimeouts,
}
```
...
&googlemanagedkafkacluster.GoogleManagedKafkaClusterGcpConfig {
	AccessConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleManagedKafkaCluster.GoogleManagedKafkaClusterGcpConfigAccessConfig,
	KmsKey: *string,
}
```
