...
googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSetting(
  ...
  enabled_tool: IResolvable | typing.List[GoogleGeminiCodeToolsSettingEnabledTool],
  id: str = None,
...
| <code><a href="#@cdktf/provider-google-beta.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSetting.Initializer.parameter.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSetting.Initializer.parameter.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSetting.Initializer.parameter.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
...
- *Type:* cdktf.IResolvable | typing.List[<a href="#@cdktf/provider-google-beta.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSettingEnabledTool">GoogleGeminiCodeToolsSettingEnabledTool</a>]
...
def put_enabled_tool(
  value: IResolvable | typing.List[GoogleGeminiCodeToolsSettingEnabledTool]
) -> None
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_gemini_code_tools_setting#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-google-beta.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSetting.property.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSetting.property.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
...
```python
enabled_tool_input: IResolvable | typing.List[GoogleGeminiCodeToolsSettingEnabledTool]
```
...
```python
timeouts_input: IResolvable | GoogleGeminiCodeToolsSettingTimeouts
```
...
| <code><a href="#@cdktf/provider-google-beta.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSettingConfig.property.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSettingConfig.property.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
...
googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSettingEnabledTool(
  ...
  config: IResolvable | typing.List[GoogleGeminiCodeToolsSettingEnabledToolConfig] = None,
...
```python
config: IResolvable | typing.List[GoogleGeminiCodeToolsSettingEnabledToolConfig]
```

- *Type:* cdktf.IResolvable | typing.List[<a href="#@cdktf/provider-google-beta.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSettingEnabledToolConfig">GoogleGeminiCodeToolsSettingEnabledToolConfig</a>]
...
```python
internal_value: IResolvable | typing.List[GoogleGeminiCodeToolsSettingEnabledToolConfig]
```
...
```python
internal_value: IResolvable | GoogleGeminiCodeToolsSettingEnabledToolConfig
```
...
```python
internal_value: IResolvable | typing.List[GoogleGeminiCodeToolsSettingEnabledTool]
```
...
```python
def put_config(
  value: IResolvable | typing.List[GoogleGeminiCodeToolsSettingEnabledToolConfig]
) -> None
```
...
```python
config_input: IResolvable | typing.List[GoogleGeminiCodeToolsSettingEnabledToolConfig]
```
...
```python
internal_value: IResolvable | GoogleGeminiCodeToolsSettingEnabledTool
```
...
```python
internal_value: IResolvable | GoogleGeminiCodeToolsSettingTimeouts
```
