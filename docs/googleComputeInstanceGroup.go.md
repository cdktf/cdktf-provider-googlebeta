...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputeinstancegroup"
...
&googlecomputeinstancegroup.GoogleComputeInstanceGroupConfig {
	...
	Network: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputeInstanceGroup.GoogleComputeInstanceGroupTimeouts,
	Zone: *string,
}
```
