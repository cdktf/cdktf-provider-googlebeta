...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleapigeesharedflowdeployment"
...
&googleapigeesharedflowdeployment.GoogleApigeeSharedflowDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleApigeeSharedflowDeployment.GoogleApigeeSharedflowDeploymentTimeouts,
}
```
