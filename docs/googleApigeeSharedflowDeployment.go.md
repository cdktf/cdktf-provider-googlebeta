...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googleapigeesharedflowdeployment"
...
&googleapigeesharedflowdeployment.GoogleApigeeSharedflowDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleApigeeSharedflowDeployment.GoogleApigeeSharedflowDeploymentTimeouts,
}
```
