...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleapigeesharedflowdeployment"
...
&googleapigeesharedflowdeployment.GoogleApigeeSharedflowDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleApigeeSharedflowDeployment.GoogleApigeeSharedflowDeploymentTimeouts,
}
```
