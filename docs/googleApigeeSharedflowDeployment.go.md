...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleapigeesharedflowdeployment"
...
&googleapigeesharedflowdeployment.GoogleApigeeSharedflowDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleApigeeSharedflowDeployment.GoogleApigeeSharedflowDeploymentTimeouts,
}
```
