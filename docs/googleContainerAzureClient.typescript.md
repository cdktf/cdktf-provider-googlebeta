...
| <code><a href="#@cdktf/provider-google-beta.googleContainerAzureClient.GoogleContainerAzureClient.property.count">count</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly timeoutsInput: GoogleContainerAzureClientTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-google-beta.googleContainerAzureClient.GoogleContainerAzureClientTimeouts">GoogleContainerAzureClientTimeouts</a> | cdktf.IResolvable
...
| <code><a href="#@cdktf/provider-google-beta.googleContainerAzureClient.GoogleContainerAzureClientConfig.property.count">count</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleContainerAzureClient.GoogleContainerAzureClientConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_container_azure_client#id GoogleContainerAzureClient#id}. |
...
```typescript
public readonly internalValue: GoogleContainerAzureClientTimeouts | IResolvable;
```
