...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlefirebasedatabaseinstance"
...
&googlefirebasedatabaseinstance.GoogleFirebaseDatabaseInstanceConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleFirebaseDatabaseInstance.GoogleFirebaseDatabaseInstanceTimeouts,
	Type: *string,
}
```
