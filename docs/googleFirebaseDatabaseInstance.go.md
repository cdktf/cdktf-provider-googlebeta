...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlefirebasedatabaseinstance"
...
&googlefirebasedatabaseinstance.GoogleFirebaseDatabaseInstanceConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleFirebaseDatabaseInstance.GoogleFirebaseDatabaseInstanceTimeouts,
	Type: *string,
}
```
