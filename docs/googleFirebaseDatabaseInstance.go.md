...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlefirebasedatabaseinstance"
...
&googlefirebasedatabaseinstance.GoogleFirebaseDatabaseInstanceConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleFirebaseDatabaseInstance.GoogleFirebaseDatabaseInstanceTimeouts,
	Type: *string,
}
```
