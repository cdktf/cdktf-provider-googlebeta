...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlefirebasedatabaseinstance"
...
&googlefirebasedatabaseinstance.GoogleFirebaseDatabaseInstanceConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleFirebaseDatabaseInstance.GoogleFirebaseDatabaseInstanceTimeouts,
	Type: *string,
}
```
