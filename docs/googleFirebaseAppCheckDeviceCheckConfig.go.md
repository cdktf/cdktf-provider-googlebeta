...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlefirebaseappcheckdevicecheckconfig"
...
&googlefirebaseappcheckdevicecheckconfig.GoogleFirebaseAppCheckDeviceCheckConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleFirebaseAppCheckDeviceCheckConfig.GoogleFirebaseAppCheckDeviceCheckConfigTimeouts,
	TokenTtl: *string,
}
```
