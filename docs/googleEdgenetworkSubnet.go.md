...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleedgenetworksubnet"
...
&googleedgenetworksubnet.GoogleEdgenetworkSubnetConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleEdgenetworkSubnet.GoogleEdgenetworkSubnetTimeouts,
	VlanId: *f64,
}
```
