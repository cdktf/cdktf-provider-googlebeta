...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlefirebaseproject"
...
&googlefirebaseproject.GoogleFirebaseProjectConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleFirebaseProject.GoogleFirebaseProjectTimeouts,
}
```
