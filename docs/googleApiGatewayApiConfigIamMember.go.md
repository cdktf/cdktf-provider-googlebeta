...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleapigatewayapiconfigiammember"
...
&googleapigatewayapiconfigiammember.GoogleApiGatewayApiConfigIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleApiGatewayApiConfigIamMember.GoogleApiGatewayApiConfigIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
