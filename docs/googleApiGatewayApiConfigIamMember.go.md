...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleapigatewayapiconfigiammember"
...
&googleapigatewayapiconfigiammember.GoogleApiGatewayApiConfigIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleApiGatewayApiConfigIamMember.GoogleApiGatewayApiConfigIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
