...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlebinaryauthorizationpolicy"
...
&googlebinaryauthorizationpolicy.GoogleBinaryAuthorizationPolicyConfig {
	...
	DefaultAdmissionRule: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleBinaryAuthorizationPolicy.GoogleBinaryAuthorizationPolicyDefaultAdmissionRule,
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleBinaryAuthorizationPolicy.GoogleBinaryAuthorizationPolicyTimeouts,
}
```
