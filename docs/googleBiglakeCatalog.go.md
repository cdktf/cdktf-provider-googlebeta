...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlebiglakecatalog"
...
&googlebiglakecatalog.GoogleBiglakeCatalogConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleBiglakeCatalog.GoogleBiglakeCatalogTimeouts,
}
```
