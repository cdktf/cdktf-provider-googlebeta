...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlebiglakecatalog"
...
&googlebiglakecatalog.GoogleBiglakeCatalogConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleBiglakeCatalog.GoogleBiglakeCatalogTimeouts,
}
```
