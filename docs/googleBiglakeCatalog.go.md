...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlebiglakecatalog"
...
&googlebiglakecatalog.GoogleBiglakeCatalogConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleBiglakeCatalog.GoogleBiglakeCatalogTimeouts,
}
```
