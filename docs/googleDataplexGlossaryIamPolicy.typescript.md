...
```typescript
import { googleDataplexGlossaryIamPolicy } from '@cdktf/provider-google-beta'

new googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy(scope: Construct, id: string, config: GoogleDataplexGlossaryIamPolicyConfig)
```
...
googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy.isConstruct(x: any)
```
...
googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy.isTerraformElement(x: any)
```
...
googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy.isTerraformResource(x: any)
```
...
googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicy.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
const googleDataplexGlossaryIamPolicyConfig: googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicyConfig = { ... }
```
...
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicyConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicyConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicyConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicyConfig.property.glossaryId">glossaryId</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.47.0/docs/resources/google_dataplex_glossary_iam_policy#glossary_id GoogleDataplexGlossaryIamPolicy#glossary_id}. |
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicyConfig.property.policyData">policyData</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.47.0/docs/resources/google_dataplex_glossary_iam_policy#policy_data GoogleDataplexGlossaryIamPolicy#policy_data}. |
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicyConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.47.0/docs/resources/google_dataplex_glossary_iam_policy#id GoogleDataplexGlossaryIamPolicy#id}. |
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicyConfig.property.location">location</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.47.0/docs/resources/google_dataplex_glossary_iam_policy#location GoogleDataplexGlossaryIamPolicy#location}. |
| <code><a href="#@cdktf/provider-google-beta.googleDataplexGlossaryIamPolicy.GoogleDataplexGlossaryIamPolicyConfig.property.project">project</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.47.0/docs/resources/google_dataplex_glossary_iam_policy#project GoogleDataplexGlossaryIamPolicy#project}. |
