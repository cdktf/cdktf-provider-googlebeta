...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleiapappengineversioniambinding"
...
&googleiapappengineversioniambinding.GoogleIapAppEngineVersionIamBindingConfig {
	...
	Service: *string,
	VersionId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleIapAppEngineVersionIamBinding.GoogleIapAppEngineVersionIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
