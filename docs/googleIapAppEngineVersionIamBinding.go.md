...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleiapappengineversioniambinding"
...
&googleiapappengineversioniambinding.GoogleIapAppEngineVersionIamBindingConfig {
	...
	Service: *string,
	VersionId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleIapAppEngineVersionIamBinding.GoogleIapAppEngineVersionIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
