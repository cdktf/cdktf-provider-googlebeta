...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlecomputenetwork"
...
&googlecomputenetwork.GoogleComputeNetworkConfig {
	...
	Project: *string,
	RoutingMode: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleComputeNetwork.GoogleComputeNetworkTimeouts,
}
```
