...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlesecuresourcemanagerbranchrule"
...
&googlesecuresourcemanagerbranchrule.GoogleSecureSourceManagerBranchRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleSecureSourceManagerBranchRule.GoogleSecureSourceManagerBranchRuleTimeouts,
}
```
