...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googledatabasemigrationserviceprivateconnection"
...
&googledatabasemigrationserviceprivateconnection.GoogleDatabaseMigrationServicePrivateConnectionConfig {
	...
	VpcPeeringConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDatabaseMigrationServicePrivateConnection.GoogleDatabaseMigrationServicePrivateConnectionVpcPeeringConfig,
	DisplayName: *string,
	Id: *string,
	Labels: *map[string]*string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDatabaseMigrationServicePrivateConnection.GoogleDatabaseMigrationServicePrivateConnectionTimeouts,
}
```
