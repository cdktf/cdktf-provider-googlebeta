...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlebigquerybireservation"
...
&googlebigquerybireservation.GoogleBigqueryBiReservationConfig {
	...
	Project: *string,
	Size: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleBigqueryBiReservation.GoogleBigqueryBiReservationTimeouts,
}
```
