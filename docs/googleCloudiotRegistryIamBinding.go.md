...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecloudiotregistryiambinding"
...
&googlecloudiotregistryiambinding.GoogleCloudiotRegistryIamBindingConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleCloudiotRegistryIamBinding.GoogleCloudiotRegistryIamBindingCondition,
	Id: *string,
	Project: *string,
	Region: *string,
}
