...
Refer to the Terraform Registory for docs: [`google_spanner_database_iam_policy`](https://registry.terraform.io/providers/hashicorp/google-beta/4.68.0/docs/resources/google_spanner_database_iam_policy).
