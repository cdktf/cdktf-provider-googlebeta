...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlefirebaseappcheckdebugtoken"
...
&googlefirebaseappcheckdebugtoken.GoogleFirebaseAppCheckDebugTokenConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleFirebaseAppCheckDebugToken.GoogleFirebaseAppCheckDebugTokenTimeouts,
}
```
