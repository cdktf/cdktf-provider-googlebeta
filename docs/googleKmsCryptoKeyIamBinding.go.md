...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlekmscryptokeyiambinding"
...
&googlekmscryptokeyiambinding.GoogleKmsCryptoKeyIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleKmsCryptoKeyIamBinding.GoogleKmsCryptoKeyIamBindingCondition,
	Id: *string,
}
```
