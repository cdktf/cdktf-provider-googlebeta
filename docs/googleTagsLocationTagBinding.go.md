...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googletagslocationtagbinding"
...
&googletagslocationtagbinding.GoogleTagsLocationTagBindingConfig {
	...
	Id: *string,
	Location: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleTagsLocationTagBinding.GoogleTagsLocationTagBindingTimeouts,
}
```
