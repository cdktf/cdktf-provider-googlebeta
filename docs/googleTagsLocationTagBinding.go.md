...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googletagslocationtagbinding"
...
&googletagslocationtagbinding.GoogleTagsLocationTagBindingConfig {
	...
	Id: *string,
	Location: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleTagsLocationTagBinding.GoogleTagsLocationTagBindingTimeouts,
}
```
