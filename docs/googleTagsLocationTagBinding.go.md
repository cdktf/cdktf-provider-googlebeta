...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googletagslocationtagbinding"
...
&googletagslocationtagbinding.GoogleTagsLocationTagBindingConfig {
	...
	Id: *string,
	Location: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleTagsLocationTagBinding.GoogleTagsLocationTagBindingTimeouts,
}
```
