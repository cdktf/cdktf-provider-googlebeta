...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlestoragemanagedfolder"
...
&googlestoragemanagedfolder.GoogleStorageManagedFolderConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleStorageManagedFolder.GoogleStorageManagedFolderTimeouts,
}
```
