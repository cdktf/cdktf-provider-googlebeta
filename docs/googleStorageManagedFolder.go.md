...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlestoragemanagedfolder"
...
&googlestoragemanagedfolder.GoogleStorageManagedFolderConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleStorageManagedFolder.GoogleStorageManagedFolderTimeouts,
}
```
