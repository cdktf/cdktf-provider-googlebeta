...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googleiapwebbackendserviceiambinding"
...
&googleiapwebbackendserviceiambinding.GoogleIapWebBackendServiceIamBindingConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleIapWebBackendServiceIamBinding.GoogleIapWebBackendServiceIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
