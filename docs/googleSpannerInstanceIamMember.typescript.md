...
```typescript
import { googleSpannerInstanceIamMember } from '@cdktf/provider-google-beta'

new googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember(scope: Construct, id: string, config: GoogleSpannerInstanceIamMemberConfig)
```
...
```typescript
public putCondition(value: GoogleSpannerInstanceIamMemberCondition): void
```
...
googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember.isConstruct(x: any)
```
...
googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember.isTerraformElement(x: any)
```
...
googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember.isTerraformResource(x: any)
```
...
googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMember.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: GoogleSpannerInstanceIamMemberConditionOutputReference;
```
...
```typescript
public readonly conditionInput: GoogleSpannerInstanceIamMemberCondition;
```
...
const googleSpannerInstanceIamMemberCondition: googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMemberCondition = { ... }
```
...
const googleSpannerInstanceIamMemberConfig: googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMemberConfig = { ... }
```
...
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMemberConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMemberConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMemberConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMemberConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: GoogleSpannerInstanceIamMemberCondition;
```
...
new googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMemberConditionOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google-beta.googleSpannerInstanceIamMember.GoogleSpannerInstanceIamMemberConditionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: GoogleSpannerInstanceIamMemberCondition;
```
