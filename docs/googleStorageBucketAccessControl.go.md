...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlestoragebucketaccesscontrol"
...
&googlestoragebucketaccesscontrol.GoogleStorageBucketAccessControlConfig {
	...
	Id: *string,
	Role: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleStorageBucketAccessControl.GoogleStorageBucketAccessControlTimeouts,
}
```
