...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlestoragemanagedfolderiammember"
...
&googlestoragemanagedfolderiammember.GoogleStorageManagedFolderIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleStorageManagedFolderIamMember.GoogleStorageManagedFolderIamMemberCondition,
	Id: *string,
}
```
