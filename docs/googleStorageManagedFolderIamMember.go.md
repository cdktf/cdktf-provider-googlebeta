...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlestoragemanagedfolderiammember"
...
&googlestoragemanagedfolderiammember.GoogleStorageManagedFolderIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleStorageManagedFolderIamMember.GoogleStorageManagedFolderIamMemberCondition,
	Id: *string,
}
```
