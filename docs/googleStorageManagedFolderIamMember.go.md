...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlestoragemanagedfolderiammember"
...
&googlestoragemanagedfolderiammember.GoogleStorageManagedFolderIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleStorageManagedFolderIamMember.GoogleStorageManagedFolderIamMemberCondition,
	Id: *string,
}
```
