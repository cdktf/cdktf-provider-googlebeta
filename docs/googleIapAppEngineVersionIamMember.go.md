...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleiapappengineversioniammember"
...
&googleiapappengineversioniammember.GoogleIapAppEngineVersionIamMemberConfig {
	...
	Service: *string,
	VersionId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleIapAppEngineVersionIamMember.GoogleIapAppEngineVersionIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
