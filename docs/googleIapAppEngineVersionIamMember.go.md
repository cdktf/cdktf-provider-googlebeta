...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleiapappengineversioniammember"
...
&googleiapappengineversioniammember.GoogleIapAppEngineVersionIamMemberConfig {
	...
	Service: *string,
	VersionId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleIapAppEngineVersionIamMember.GoogleIapAppEngineVersionIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
