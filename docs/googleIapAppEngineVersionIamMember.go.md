...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googleiapappengineversioniammember"
...
&googleiapappengineversioniammember.GoogleIapAppEngineVersionIamMemberConfig {
	...
	Service: *string,
	VersionId: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleIapAppEngineVersionIamMember.GoogleIapAppEngineVersionIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
