...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlefolderorganizationpolicy"
...
&googlefolderorganizationpolicy.GoogleFolderOrganizationPolicyConfig {
	...
	Constraint: *string,
	Folder: *string,
	BooleanPolicy: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyBooleanPolicy,
	Id: *string,
	ListPolicy: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyListPolicy,
	RestorePolicy: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyRestorePolicy,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyTimeouts,
	Version: *f64,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.79.0/docs/resources/google_folder_organization_policy#id GoogleFolderOrganizationPolicy#id}. |
...
&googlefolderorganizationpolicy.GoogleFolderOrganizationPolicyListPolicy {
	Allow: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyListPolicyAllow,
	Deny: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyListPolicyDeny,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-google-beta.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyTimeouts.property.create">Create</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.79.0/docs/resources/google_folder_organization_policy#create GoogleFolderOrganizationPolicy#create}. |
| <code><a href="#@cdktf/provider-google-beta.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyTimeouts.property.delete">Delete</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.79.0/docs/resources/google_folder_organization_policy#delete GoogleFolderOrganizationPolicy#delete}. |
| <code><a href="#@cdktf/provider-google-beta.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyTimeouts.property.read">Read</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.79.0/docs/resources/google_folder_organization_policy#read GoogleFolderOrganizationPolicy#read}. |
| <code><a href="#@cdktf/provider-google-beta.googleFolderOrganizationPolicy.GoogleFolderOrganizationPolicyTimeouts.property.update">Update</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.79.0/docs/resources/google_folder_organization_policy#update GoogleFolderOrganizationPolicy#update}. |
