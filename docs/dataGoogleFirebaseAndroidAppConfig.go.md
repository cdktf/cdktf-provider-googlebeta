...
Refer to the Terraform Registory for docs: [`data_google_firebase_android_app_config`](https://registry.terraform.io/providers/hashicorp/google-beta/4.82.0/docs/data-sources/google_firebase_android_app_config).
...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/datagooglefirebaseandroidappconfig"
