...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlegeminiloggingsettingbinding"
...
&googlegeminiloggingsettingbinding.GoogleGeminiLoggingSettingBindingConfig {
	...
	Product: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleGeminiLoggingSettingBinding.GoogleGeminiLoggingSettingBindingTimeouts,
}
```
