...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleapigeesharedflow"
...
&googleapigeesharedflow.GoogleApigeeSharedflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleApigeeSharedflow.GoogleApigeeSharedflowTimeouts,
}
```
