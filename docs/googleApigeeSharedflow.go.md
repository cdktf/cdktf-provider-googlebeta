...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googleapigeesharedflow"
...
&googleapigeesharedflow.GoogleApigeeSharedflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleApigeeSharedflow.GoogleApigeeSharedflowTimeouts,
}
```
