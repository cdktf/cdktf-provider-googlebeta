...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googleapigeesharedflow"
...
&googleapigeesharedflow.GoogleApigeeSharedflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleApigeeSharedflow.GoogleApigeeSharedflowTimeouts,
}
```
