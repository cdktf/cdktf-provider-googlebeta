...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlegkehubnamespace"
...
&googlegkehubnamespace.GoogleGkeHubNamespaceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleGkeHubNamespace.GoogleGkeHubNamespaceTimeouts,
}
```
