...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlevertexaiendpoint"
...
&googlevertexaiendpoint.GoogleVertexAiEndpointConfig {
	...
	Name: *string,
	Description: *string,
	EncryptionSpec: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleVertexAiEndpoint.GoogleVertexAiEndpointEncryptionSpec,
	Id: *string,
	Labels: *map[string]*string,
	Network: *string,
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleVertexAiEndpoint.GoogleVertexAiEndpointTimeouts,
}
```
