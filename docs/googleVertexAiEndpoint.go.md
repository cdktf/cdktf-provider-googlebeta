...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlevertexaiendpoint"
...
| <code><a href="#@cdktf/provider-google-beta.googleVertexAiEndpoint.GoogleVertexAiEndpoint.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googlevertexaiendpoint.GoogleVertexAiEndpointConfig {
	...
	Name: *string,
	Description: *string,
	EncryptionSpec: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleVertexAiEndpoint.GoogleVertexAiEndpointEncryptionSpec,
	Id: *string,
	Labels: *map[string]*string,
	Network: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleVertexAiEndpoint.GoogleVertexAiEndpointTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleVertexAiEndpoint.GoogleVertexAiEndpointConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
