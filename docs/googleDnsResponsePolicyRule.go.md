...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlednsresponsepolicyrule"
...
&googlednsresponsepolicyrule.GoogleDnsResponsePolicyRuleConfig {
	...
	Behavior: *string,
	Id: *string,
	LocalData: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleDnsResponsePolicyRule.GoogleDnsResponsePolicyRuleLocalData,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleDnsResponsePolicyRule.GoogleDnsResponsePolicyRuleTimeouts,
}
```
