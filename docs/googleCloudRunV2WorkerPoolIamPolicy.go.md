...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecloudrunv2workerpooliampolicy"
...
| <code><a href="#@cdktf/provider-google-beta.googleCloudRunV2WorkerPoolIamPolicy.GoogleCloudRunV2WorkerPoolIamPolicyConfig.property.name">Name</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.38.0/docs/resources/google_cloud_run_v2_worker_pool_iam_policy#name GoogleCloudRunV2WorkerPoolIamPolicy#name}. |
