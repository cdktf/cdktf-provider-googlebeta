...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlecomputetargethttpsproxy"
...
&googlecomputetargethttpsproxy.GoogleComputeTargetHttpsProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleComputeTargetHttpsProxy.GoogleComputeTargetHttpsProxyTimeouts,
}
```
