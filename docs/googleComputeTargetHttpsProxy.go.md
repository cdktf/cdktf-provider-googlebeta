...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googlecomputetargethttpsproxy"
...
&googlecomputetargethttpsproxy.GoogleComputeTargetHttpsProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleComputeTargetHttpsProxy.GoogleComputeTargetHttpsProxyTimeouts,
}
```
