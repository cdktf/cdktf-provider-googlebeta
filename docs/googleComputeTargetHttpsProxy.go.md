...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googlecomputetargethttpsproxy"
...
&googlecomputetargethttpsproxy.GoogleComputeTargetHttpsProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleComputeTargetHttpsProxy.GoogleComputeTargetHttpsProxyTimeouts,
}
```
