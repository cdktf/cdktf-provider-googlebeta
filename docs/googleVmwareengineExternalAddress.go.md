...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlevmwareengineexternaladdress"
...
&googlevmwareengineexternaladdress.GoogleVmwareengineExternalAddressConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleVmwareengineExternalAddress.GoogleVmwareengineExternalAddressTimeouts,
}
```
