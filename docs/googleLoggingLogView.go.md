...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlelogginglogview"
...
&googlelogginglogview.GoogleLoggingLogViewConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleLoggingLogView.GoogleLoggingLogViewTimeouts,
}
```
