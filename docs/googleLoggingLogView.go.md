...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlelogginglogview"
...
&googlelogginglogview.GoogleLoggingLogViewConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleLoggingLogView.GoogleLoggingLogViewTimeouts,
}
```
