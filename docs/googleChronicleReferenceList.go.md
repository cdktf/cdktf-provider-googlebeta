...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlechroniclereferencelist"
...
&googlechroniclereferencelist.GoogleChronicleReferenceListConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleChronicleReferenceList.GoogleChronicleReferenceListTimeouts,
}
```
