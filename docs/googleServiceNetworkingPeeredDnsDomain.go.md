...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googleservicenetworkingpeereddnsdomain"
...
&googleservicenetworkingpeereddnsdomain.GoogleServiceNetworkingPeeredDnsDomainConfig {
	...
	Project: *string,
	Service: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleServiceNetworkingPeeredDnsDomain.GoogleServiceNetworkingPeeredDnsDomainTimeouts,
}
```
