...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecomputeglobalnetworkendpoint"
...
&googlecomputeglobalnetworkendpoint.GoogleComputeGlobalNetworkEndpointConfig {
	...
	IpAddress: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleComputeGlobalNetworkEndpoint.GoogleComputeGlobalNetworkEndpointTimeouts,
}
```
