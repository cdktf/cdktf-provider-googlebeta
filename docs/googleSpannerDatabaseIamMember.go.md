...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlespannerdatabaseiammember"
...
&googlespannerdatabaseiammember.GoogleSpannerDatabaseIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
