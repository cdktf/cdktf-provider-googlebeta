...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlespannerdatabaseiammember"
...
&googlespannerdatabaseiammember.GoogleSpannerDatabaseIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
