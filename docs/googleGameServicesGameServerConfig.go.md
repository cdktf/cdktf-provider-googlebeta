...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googlegameservicesgameserverconfig"
...
&googlegameservicesgameserverconfig.GoogleGameServicesGameServerConfigConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleGameServicesGameServerConfig.GoogleGameServicesGameServerConfigTimeouts,
}
```
