...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7/googlegameservicesgameserverconfig"
...
&googlegameservicesgameserverconfig.GoogleGameServicesGameServerConfigConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v7.googleGameServicesGameServerConfig.GoogleGameServicesGameServerConfigTimeouts,
}
```
