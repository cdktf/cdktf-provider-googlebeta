...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12/googleiapappengineserviceiammember"
...
&googleiapappengineserviceiammember.GoogleIapAppEngineServiceIamMemberConfig {
	...
	Role: *string,
	Service: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v12.googleIapAppEngineServiceIamMember.GoogleIapAppEngineServiceIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
