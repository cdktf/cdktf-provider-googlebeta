...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13/googlekmsautokeyconfig"
...
&googlekmsautokeyconfig.GoogleKmsAutokeyConfigConfig {
	...
	Id: *string,
	KeyProject: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v13.googleKmsAutokeyConfig.GoogleKmsAutokeyConfigTimeouts,
}
```
