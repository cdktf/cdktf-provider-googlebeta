...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlekmsautokeyconfig"
...
&googlekmsautokeyconfig.GoogleKmsAutokeyConfigConfig {
	...
	Id: *string,
	KeyProject: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleKmsAutokeyConfig.GoogleKmsAutokeyConfigTimeouts,
}
```
