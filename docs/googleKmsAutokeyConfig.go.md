...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlekmsautokeyconfig"
...
&googlekmsautokeyconfig.GoogleKmsAutokeyConfigConfig {
	...
	Id: *string,
	KeyProject: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleKmsAutokeyConfig.GoogleKmsAutokeyConfigTimeouts,
}
```
