...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlegkehubmembershipiambinding"
...
&googlegkehubmembershipiambinding.GoogleGkeHubMembershipIamBindingConfig {
	...
	MembershipId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleGkeHubMembershipIamBinding.GoogleGkeHubMembershipIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
