...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googlebigquerydatapolicydatapolicyiambinding"
...
googlebigquerydatapolicydatapolicyiambinding.GoogleBigqueryDatapolicyDataPolicyIamBinding_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
&googlebigquerydatapolicydatapolicyiambinding.GoogleBigqueryDatapolicyDataPolicyIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleBigqueryDatapolicyDataPolicyIamBinding.GoogleBigqueryDatapolicyDataPolicyIamBindingCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
