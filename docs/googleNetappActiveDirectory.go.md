...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlenetappactivedirectory"
...
&googlenetappactivedirectory.GoogleNetappActiveDirectoryConfig {
	...
	Site: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleNetappActiveDirectory.GoogleNetappActiveDirectoryTimeouts,
}
```
