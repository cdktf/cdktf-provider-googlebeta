...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlecloudbuildbitbucketserverconfig"
...
| <code><a href="#@cdktf/provider-google-beta.googleCloudbuildBitbucketServerConfig.GoogleCloudbuildBitbucketServerConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googlecloudbuildbitbucketserverconfig.GoogleCloudbuildBitbucketServerConfigConfig {
	...
	HostUri: *string,
	Location: *string,
	Secrets: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleCloudbuildBitbucketServerConfig.GoogleCloudbuildBitbucketServerConfigSecrets,
	Username: *string,
	...
	Project: *string,
	SslCa: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleCloudbuildBitbucketServerConfig.GoogleCloudbuildBitbucketServerConfigTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleCloudbuildBitbucketServerConfig.GoogleCloudbuildBitbucketServerConfigConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
