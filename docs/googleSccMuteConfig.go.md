...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlesccmuteconfig"
...
&googlesccmuteconfig.GoogleSccMuteConfigConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleSccMuteConfig.GoogleSccMuteConfigTimeouts,
}
```
