...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5/googlesccmuteconfig"
...
&googlesccmuteconfig.GoogleSccMuteConfigConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v5.googleSccMuteConfig.GoogleSccMuteConfigTimeouts,
}
```
