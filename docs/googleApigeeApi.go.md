...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleapigeeapi"
...
&googleapigeeapi.GoogleApigeeApiConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleApigeeApi.GoogleApigeeApiTimeouts,
}
```
