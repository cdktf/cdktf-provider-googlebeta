...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googleapigeeapi"
...
&googleapigeeapi.GoogleApigeeApiConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleApigeeApi.GoogleApigeeApiTimeouts,
}
```
