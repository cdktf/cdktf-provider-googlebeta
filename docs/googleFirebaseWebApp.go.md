...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlefirebasewebapp"
...
&googlefirebasewebapp.GoogleFirebaseWebAppConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleFirebaseWebApp.GoogleFirebaseWebAppTimeouts,
}
```
