...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlefirebasewebapp"
...
&googlefirebasewebapp.GoogleFirebaseWebAppConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleFirebaseWebApp.GoogleFirebaseWebAppTimeouts,
}
```
