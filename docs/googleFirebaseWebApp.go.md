...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlefirebasewebapp"
...
&googlefirebasewebapp.GoogleFirebaseWebAppConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleFirebaseWebApp.GoogleFirebaseWebAppTimeouts,
}
```
