...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlediscoveryengineschema"
...
&googlediscoveryengineschema.GoogleDiscoveryEngineSchemaConfig {
	...
	JsonSchema: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleDiscoveryEngineSchema.GoogleDiscoveryEngineSchemaTimeouts,
}
```
