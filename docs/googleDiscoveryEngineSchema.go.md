...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlediscoveryengineschema"
...
&googlediscoveryengineschema.GoogleDiscoveryEngineSchemaConfig {
	...
	JsonSchema: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleDiscoveryEngineSchema.GoogleDiscoveryEngineSchemaTimeouts,
}
```
