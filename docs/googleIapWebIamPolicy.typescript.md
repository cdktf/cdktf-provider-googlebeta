...
```typescript
import { googleIapWebIamPolicy } from '@cdktf/provider-google-beta'

new googleIapWebIamPolicy.GoogleIapWebIamPolicy(scope: Construct, id: string, config: GoogleIapWebIamPolicyConfig)
```
...
googleIapWebIamPolicy.GoogleIapWebIamPolicy.isConstruct(x: any)
```
...
googleIapWebIamPolicy.GoogleIapWebIamPolicy.isTerraformElement(x: any)
```
...
googleIapWebIamPolicy.GoogleIapWebIamPolicy.isTerraformResource(x: any)
```
...
googleIapWebIamPolicy.GoogleIapWebIamPolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-google-beta.googleIapWebIamPolicy.GoogleIapWebIamPolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleIapWebIamPolicy.GoogleIapWebIamPolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google-beta.googleIapWebIamPolicy.GoogleIapWebIamPolicy.property.provider">provider</a></code> | <code>cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-google-beta.googleIapWebIamPolicy.GoogleIapWebIamPolicy.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
const googleIapWebIamPolicyConfig: googleIapWebIamPolicy.GoogleIapWebIamPolicyConfig = { ... }
```
