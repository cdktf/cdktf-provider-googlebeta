...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14/googledataplexglossarycategory"
...
&googledataplexglossarycategory.GoogleDataplexGlossaryCategoryConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v14.googleDataplexGlossaryCategory.GoogleDataplexGlossaryCategoryTimeouts,
}
```
