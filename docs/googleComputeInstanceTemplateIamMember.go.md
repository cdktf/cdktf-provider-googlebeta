...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlecomputeinstancetemplateiammember"
...
&googlecomputeinstancetemplateiammember.GoogleComputeInstanceTemplateIamMemberConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleComputeInstanceTemplateIamMember.GoogleComputeInstanceTemplateIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
