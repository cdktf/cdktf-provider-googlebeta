...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8/googleorganizationiambinding"
...
&googleorganizationiambinding.GoogleOrganizationIamBindingConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v8.googleOrganizationIamBinding.GoogleOrganizationIamBindingCondition,
	Id: *string,
}
```
