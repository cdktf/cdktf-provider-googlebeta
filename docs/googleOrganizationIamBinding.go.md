...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleorganizationiambinding"
...
&googleorganizationiambinding.GoogleOrganizationIamBindingConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleOrganizationIamBinding.GoogleOrganizationIamBindingCondition,
	Id: *string,
}
```
