...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googleorganizationiambinding"
...
&googleorganizationiambinding.GoogleOrganizationIamBindingConfig {
	...
	OrgId: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleOrganizationIamBinding.GoogleOrganizationIamBindingCondition,
	Id: *string,
}
```
