...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlefolderiammember"
...
&googlefolderiammember.GoogleFolderIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleFolderIamMember.GoogleFolderIamMemberCondition,
	Id: *string,
}
```
