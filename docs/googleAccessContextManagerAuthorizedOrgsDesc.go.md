...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9/googleaccesscontextmanagerauthorizedorgsdesc"
...
&googleaccesscontextmanagerauthorizedorgsdesc.GoogleAccessContextManagerAuthorizedOrgsDescConfig {
	...
	Id: *string,
	Orgs: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v9.googleAccessContextManagerAuthorizedOrgsDesc.GoogleAccessContextManagerAuthorizedOrgsDescTimeouts,
}
```
