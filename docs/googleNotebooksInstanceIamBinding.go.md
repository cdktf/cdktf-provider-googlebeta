...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6/googlenotebooksinstanceiambinding"
...
| <code><a href="#@cdktf/provider-google-beta.googleNotebooksInstanceIamBinding.GoogleNotebooksInstanceIamBinding.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&googlenotebooksinstanceiambinding.GoogleNotebooksInstanceIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v6.googleNotebooksInstanceIamBinding.GoogleNotebooksInstanceIamBindingCondition,
	Id: *string,
	Location: *string,
	Project: *string,
}
...
| <code><a href="#@cdktf/provider-google-beta.googleNotebooksInstanceIamBinding.GoogleNotebooksInstanceIamBindingConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
