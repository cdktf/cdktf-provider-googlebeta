...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16/googlegeminirepositorygroup"
...
&googlegeminirepositorygroup.GoogleGeminiRepositoryGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v16.googleGeminiRepositoryGroup.GoogleGeminiRepositoryGroupTimeouts,
}
```
