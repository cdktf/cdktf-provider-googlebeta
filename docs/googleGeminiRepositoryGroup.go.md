...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlegeminirepositorygroup"
...
&googlegeminirepositorygroup.GoogleGeminiRepositoryGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleGeminiRepositoryGroup.GoogleGeminiRepositoryGroupTimeouts,
}
```
