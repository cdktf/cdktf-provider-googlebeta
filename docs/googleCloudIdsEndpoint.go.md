...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11/googlecloudidsendpoint"
...
&googlecloudidsendpoint.GoogleCloudIdsEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v11.googleCloudIdsEndpoint.GoogleCloudIdsEndpointTimeouts,
}
```
