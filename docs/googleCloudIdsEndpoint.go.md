...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10/googlecloudidsendpoint"
...
&googlecloudidsendpoint.GoogleCloudIdsEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v10.googleCloudIdsEndpoint.GoogleCloudIdsEndpointTimeouts,
}
```
