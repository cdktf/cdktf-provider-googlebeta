...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15/googlecloudidsendpoint"
...
&googlecloudidsendpoint.GoogleCloudIdsEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/v15.googleCloudIdsEndpoint.GoogleCloudIdsEndpointTimeouts,
}
```
