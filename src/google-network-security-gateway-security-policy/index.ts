...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.18.0/docs/resources/google_network_security_gateway_security_policy
...
export function googleNetworkSecurityGatewaySecurityPolicyTimeoutsToTerraform(struct?: GoogleNetworkSecurityGatewaySecurityPolicyTimeouts | cdktf.IResolvable): any {
...
export function googleNetworkSecurityGatewaySecurityPolicyTimeoutsToHclTerraform(struct?: GoogleNetworkSecurityGatewaySecurityPolicyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleNetworkSecurityGatewaySecurityPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetworkSecurityGatewaySecurityPolicyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleNetworkSecurityGatewaySecurityPolicyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleNetworkSecurityGatewaySecurityPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleNetworkSecurityGatewaySecurityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.18.0/docs/resources/google_network_security_gateway_security_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.18.0/docs/resources/google_network_security_gateway_security_policy google_network_security_gateway_security_policy} Resource
  *
  * @param scope The scope in which to define this construct
