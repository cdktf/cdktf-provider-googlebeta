...
export class GoogleComputeInterconnectAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeInterconnectAttachmentTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputeInterconnectAttachmentTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
