// https://www.terraform.io/docs/providers/google-beta/r/google_compute_region_health_check
...
export function googleComputeRegionHealthCheckTimeoutsToTerraform(struct?: GoogleComputeRegionHealthCheckTimeoutsOutputReference | GoogleComputeRegionHealthCheckTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeRegionHealthCheckTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeRegionHealthCheckTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputeRegionHealthCheckTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
