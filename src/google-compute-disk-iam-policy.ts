// https://www.terraform.io/docs/providers/google-beta/r/google_compute_disk_iam_policy
...
export interface GoogleComputeDiskIamPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class GoogleComputeDiskIamPolicy extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_compute_disk_iam_policy";
  ...
  * @param options GoogleComputeDiskIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeDiskIamPolicyConfig) {
    super(scope, id, {
      terraformResourceType: 'google_compute_disk_iam_policy',
