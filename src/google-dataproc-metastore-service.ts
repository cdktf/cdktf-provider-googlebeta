...
export class GoogleDataprocMetastoreServiceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataprocMetastoreServiceTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleDataprocMetastoreServiceTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
