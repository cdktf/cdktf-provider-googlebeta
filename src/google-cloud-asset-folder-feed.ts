// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_asset_folder_feed
...
export function googleCloudAssetFolderFeedTimeoutsToTerraform(struct?: GoogleCloudAssetFolderFeedTimeoutsOutputReference | GoogleCloudAssetFolderFeedTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCloudAssetFolderFeedTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudAssetFolderFeedTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudAssetFolderFeedTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
