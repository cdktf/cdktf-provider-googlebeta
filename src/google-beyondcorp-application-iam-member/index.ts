...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.21.0/docs/resources/google_beyondcorp_application_iam_member
...
export interface GoogleBeyondcorpApplicationIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleBeyondcorpApplicationIamMemberCondition;
}
export interface GoogleBeyondcorpApplicationIamMemberCondition {
  /**
...
export function googleBeyondcorpApplicationIamMemberConditionToTerraform(struct?: GoogleBeyondcorpApplicationIamMemberConditionOutputReference | GoogleBeyondcorpApplicationIamMemberCondition): any {
...
export function googleBeyondcorpApplicationIamMemberConditionToHclTerraform(struct?: GoogleBeyondcorpApplicationIamMemberConditionOutputReference | GoogleBeyondcorpApplicationIamMemberCondition): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleBeyondcorpApplicationIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBeyondcorpApplicationIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleBeyondcorpApplicationIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleBeyondcorpApplicationIamMember extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleBeyondcorpApplicationIamMember to import
  * @param importFromId The id of the existing GoogleBeyondcorpApplicationIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.21.0/docs/resources/google_beyondcorp_application_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.21.0/docs/resources/google_beyondcorp_application_iam_member google_beyondcorp_application_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleBeyondcorpApplicationIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleBeyondcorpApplicationIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleBeyondcorpApplicationIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleBeyondcorpApplicationIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleBeyondcorpApplicationIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleBeyondcorpApplicationIamMemberConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleBeyondcorpApplicationIamMemberConditionList",
      },
    };
