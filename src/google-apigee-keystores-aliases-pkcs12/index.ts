// https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_apigee_keystores_aliases_pkcs12
...
export interface GoogleApigeeKeystoresAliasesPkcs12Config extends cdktf.TerraformMetaArguments {
  /**
  * Alias Name
  *
...
export class GoogleApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList extends cdktf.ComplexList {
...
export class GoogleApigeeKeystoresAliasesPkcs12CertsInfoList extends cdktf.ComplexList {
...
export function googleApigeeKeystoresAliasesPkcs12TimeoutsToTerraform(struct?: GoogleApigeeKeystoresAliasesPkcs12Timeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleApigeeKeystoresAliasesPkcs12TimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleApigeeKeystoresAliasesPkcs12Timeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleApigeeKeystoresAliasesPkcs12Timeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleApigeeKeystoresAliasesPkcs12 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleApigeeKeystoresAliasesPkcs12 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_apigee_keystores_aliases_pkcs12#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_apigee_keystores_aliases_pkcs12 google_apigee_keystores_aliases_pkcs12} Resource
  *
  * @param scope The scope in which to define this construct
