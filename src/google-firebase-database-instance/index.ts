// https://www.terraform.io/docs/providers/google-beta/r/google_firebase_database_instance
...
export interface GoogleFirebaseDatabaseInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_firebase_database_instance#desired_state GoogleFirebaseDatabaseInstance#desired_state}
  */
  readonly desiredState?: string;
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_firebase_database_instance#id GoogleFirebaseDatabaseInstance#id}
  *
...
Instance IDs cannot be reused after deletion.
  * 
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_firebase_database_instance#instance_id GoogleFirebaseDatabaseInstance#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_firebase_database_instance#project GoogleFirebaseDatabaseInstance#project}
  */
...
Projects can be upgraded using the Cloud Billing API https://cloud.google.com/billing/reference/rest/v1/projects/updateBillingInfo. Default value: "USER_DATABASE" Possible values: ["DEFAULT_DATABASE", "USER_DATABASE"]
  * 
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_firebase_database_instance#type GoogleFirebaseDatabaseInstance#type}
  */
  readonly type?: string;
  /**
  * timeouts block
  * 
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_firebase_database_instance#timeouts GoogleFirebaseDatabaseInstance#timeouts}
  */
  readonly timeouts?: GoogleFirebaseDatabaseInstanceTimeouts;
}
export interface GoogleFirebaseDatabaseInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_firebase_database_instance#create GoogleFirebaseDatabaseInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_firebase_database_instance#delete GoogleFirebaseDatabaseInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_firebase_database_instance#update GoogleFirebaseDatabaseInstance#update}
  */
  readonly update?: string;
}

export function googleFirebaseDatabaseInstanceTimeoutsToTerraform(struct?: GoogleFirebaseDatabaseInstanceTimeoutsOutputReference | GoogleFirebaseDatabaseInstanceTimeouts | cdktf.IResolvable): any {
