// https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/data-sources/google_kms_crypto_keys
...
export class DataGoogleKmsCryptoKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleKmsCryptoKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/data-sources/google_kms_crypto_keys#import import section} in the documentation of this resource for the id to use
