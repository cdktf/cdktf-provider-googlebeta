...
export class GoogleComputeGlobalNetworkEndpointTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeGlobalNetworkEndpointTimeouts | undefined {
  ...
  public set internalValue(value: GoogleComputeGlobalNetworkEndpointTimeouts | undefined) {
    if (value === undefined) {
