// https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_secret_manager_secret
...
export class GoogleSecretManagerSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleSecretManagerSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_secret_manager_secret#import import section} in the documentation of this resource for the id to use
