...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_apigee_sharedflow
...
export class GoogleApigeeSharedflow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleApigeeSharedflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_apigee_sharedflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_apigee_sharedflow google_apigee_sharedflow} Resource
  *
  * @param scope The scope in which to define this construct
