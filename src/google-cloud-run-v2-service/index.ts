// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_run_v2_service
...
export function googleCloudRunV2ServiceTimeoutsToTerraform(struct?: GoogleCloudRunV2ServiceTimeoutsOutputReference | GoogleCloudRunV2ServiceTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCloudRunV2Service extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_cloud_run_v2_service google_cloud_run_v2_service} Resource
  *
