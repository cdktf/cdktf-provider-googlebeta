...
export class GoogleComputeExternalVpnGatewayTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeExternalVpnGatewayTimeouts | undefined {
  ...
  public set internalValue(value: GoogleComputeExternalVpnGatewayTimeouts | undefined) {
    if (value === undefined) {
...
export class GoogleComputeExternalVpnGateway extends cdktf.TerraformResource {
  ...
  */
  ...
  private _interface?: GoogleComputeExternalVpnGatewayInterface[] | cdktf.IResolvable; 
  public get interface() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('interface');
  }
  public set interface(value: GoogleComputeExternalVpnGatewayInterface[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      interface: cdktf.listMapper(googleComputeExternalVpnGatewayInterfaceToTerraform)(this._interface),
