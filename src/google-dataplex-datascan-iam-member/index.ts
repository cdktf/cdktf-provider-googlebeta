...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.16.0/docs/resources/google_dataplex_datascan_iam_member
...
export class GoogleDataplexDatascanIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDataplexDatascanIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.16.0/docs/resources/google_dataplex_datascan_iam_member#import import section} in the documentation of this resource for the id to use
