...
export class GoogleMonitoringDashboardTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleMonitoringDashboardTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleMonitoringDashboardTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
