...
export class GoogleComputeTargetTcpProxyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeTargetTcpProxyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeTargetTcpProxyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
