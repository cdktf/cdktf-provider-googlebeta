...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.15.0/docs/resources/google_notebooks_runtime_iam_member
...
export class GoogleNotebooksRuntimeIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleNotebooksRuntimeIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.15.0/docs/resources/google_notebooks_runtime_iam_member#import import section} in the documentation of this resource for the id to use
