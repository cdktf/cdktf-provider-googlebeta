...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.49.0/docs/resources/google_cloudfunctions_function
...
export interface GoogleCloudfunctionsFunctionConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly automaticUpdatePolicy?: GoogleCloudfunctionsFunctionAutomaticUpdatePolicy;
  /**
  * event_trigger block
  *
  ...
  */
  readonly onDeployUpdatePolicy?: GoogleCloudfunctionsFunctionOnDeployUpdatePolicy;
  /**
...
export interface GoogleCloudfunctionsFunctionAutomaticUpdatePolicy {
}

export function googleCloudfunctionsFunctionAutomaticUpdatePolicyToTerraform(struct?: GoogleCloudfunctionsFunctionAutomaticUpdatePolicyOutputReference | GoogleCloudfunctionsFunctionAutomaticUpdatePolicy): any {
...
export function googleCloudfunctionsFunctionAutomaticUpdatePolicyToHclTerraform(struct?: GoogleCloudfunctionsFunctionAutomaticUpdatePolicyOutputReference | GoogleCloudfunctionsFunctionAutomaticUpdatePolicy): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCloudfunctionsFunctionAutomaticUpdatePolicyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudfunctionsFunctionAutomaticUpdatePolicy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleCloudfunctionsFunctionAutomaticUpdatePolicy | undefined) {
    if (value === undefined) {
...
export interface GoogleCloudfunctionsFunctionOnDeployUpdatePolicy {
}

export function googleCloudfunctionsFunctionOnDeployUpdatePolicyToTerraform(struct?: GoogleCloudfunctionsFunctionOnDeployUpdatePolicyOutputReference | GoogleCloudfunctionsFunctionOnDeployUpdatePolicy): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleCloudfunctionsFunctionOnDeployUpdatePolicyToHclTerraform(struct?: GoogleCloudfunctionsFunctionOnDeployUpdatePolicyOutputReference | GoogleCloudfunctionsFunctionOnDeployUpdatePolicy): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCloudfunctionsFunctionOnDeployUpdatePolicyOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleCloudfunctionsFunctionOnDeployUpdatePolicy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleCloudfunctionsFunctionOnDeployUpdatePolicy | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class GoogleCloudfunctionsFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleCloudfunctionsFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.0/docs/resources/google_cloudfunctions_function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.0/docs/resources/google_cloudfunctions_function google_cloudfunctions_function} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _automaticUpdatePolicy = new GoogleCloudfunctionsFunctionAutomaticUpdatePolicyOutputReference(this, "automatic_update_policy");
  public get automaticUpdatePolicy() {
    return this._automaticUpdatePolicy;
  }
  public putAutomaticUpdatePolicy(value: GoogleCloudfunctionsFunctionAutomaticUpdatePolicy) {
  ...
  private _onDeployUpdatePolicy = new GoogleCloudfunctionsFunctionOnDeployUpdatePolicyOutputReference(this, "on_deploy_update_policy");
  public get onDeployUpdatePolicy() {
    return this._onDeployUpdatePolicy;
  }
  public putOnDeployUpdatePolicy(value: GoogleCloudfunctionsFunctionOnDeployUpdatePolicy) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      automatic_update_policy: googleCloudfunctionsFunctionAutomaticUpdatePolicyToTerraform(this._automaticUpdatePolicy.internalValue),
      event_trigger: googleCloudfunctionsFunctionEventTriggerToTerraform(this._eventTrigger.internalValue),
      on_deploy_update_policy: googleCloudfunctionsFunctionOnDeployUpdatePolicyToTerraform(this._onDeployUpdatePolicy.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      automatic_update_policy: {
        value: googleCloudfunctionsFunctionAutomaticUpdatePolicyToHclTerraform(this._automaticUpdatePolicy.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleCloudfunctionsFunctionAutomaticUpdatePolicyList",
      },
      event_trigger: {
      ...
      on_deploy_update_policy: {
        value: googleCloudfunctionsFunctionOnDeployUpdatePolicyToHclTerraform(this._onDeployUpdatePolicy.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleCloudfunctionsFunctionOnDeployUpdatePolicyList",
      },
