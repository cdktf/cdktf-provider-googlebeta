...
export class GoogleSqlSourceRepresentationInstanceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSqlSourceRepresentationInstanceTimeouts | undefined {
  ...
  public set internalValue(value: GoogleSqlSourceRepresentationInstanceTimeouts | undefined) {
    if (value === undefined) {
