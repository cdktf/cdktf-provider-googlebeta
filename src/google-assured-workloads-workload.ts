...
export class GoogleAssuredWorkloadsWorkloadTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleAssuredWorkloadsWorkloadTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleAssuredWorkloadsWorkloadTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleAssuredWorkloadsWorkload extends cdktf.TerraformResource {
  ...
  */
  ...
  private _resourceSettings?: GoogleAssuredWorkloadsWorkloadResourceSettings[] | cdktf.IResolvable; 
  public get resourceSettings() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('resource_settings');
  }
  public set resourceSettings(value: GoogleAssuredWorkloadsWorkloadResourceSettings[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      resource_settings: cdktf.listMapper(googleAssuredWorkloadsWorkloadResourceSettingsToTerraform)(this._resourceSettings),
