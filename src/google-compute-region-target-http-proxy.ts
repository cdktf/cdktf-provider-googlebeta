...
export class GoogleComputeRegionTargetHttpProxyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeRegionTargetHttpProxyTimeouts | undefined {
  ...
  public set internalValue(value: GoogleComputeRegionTargetHttpProxyTimeouts | undefined) {
    if (value === undefined) {
