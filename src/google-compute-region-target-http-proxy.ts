// https://www.terraform.io/docs/providers/google-beta/r/google_compute_region_target_http_proxy
...
export function googleComputeRegionTargetHttpProxyTimeoutsToTerraform(struct?: GoogleComputeRegionTargetHttpProxyTimeoutsOutputReference | GoogleComputeRegionTargetHttpProxyTimeouts | cdktf.IResolvable): any {
...
export class GoogleComputeRegionTargetHttpProxyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeRegionTargetHttpProxyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeRegionTargetHttpProxyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleComputeRegionTargetHttpProxy extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeRegionTargetHttpProxyConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleComputeRegionTargetHttpProxyTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleComputeRegionTargetHttpProxyTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleComputeRegionTargetHttpProxyTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
