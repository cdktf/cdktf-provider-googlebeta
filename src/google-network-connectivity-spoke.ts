// https://www.terraform.io/docs/providers/google-beta/r/google_network_connectivity_spoke
...
export function googleNetworkConnectivitySpokeLinkedRouterApplianceInstancesToTerraform(struct?: GoogleNetworkConnectivitySpokeLinkedRouterApplianceInstancesOutputReference | GoogleNetworkConnectivitySpokeLinkedRouterApplianceInstances): any {
  ...
  return {
    site_to_site_data_transfer: cdktf.booleanToTerraform(struct!.siteToSiteDataTransfer),
    instances: cdktf.listMapper(googleNetworkConnectivitySpokeLinkedRouterApplianceInstancesInstancesToTerraform)(struct!.instances),
  }
}
...
export class GoogleNetworkConnectivitySpokeLinkedRouterApplianceInstancesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _instances?: GoogleNetworkConnectivitySpokeLinkedRouterApplianceInstancesInstances[] | cdktf.IResolvable; 
  public get instances() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('instances');
  }
  public set instances(value: GoogleNetworkConnectivitySpokeLinkedRouterApplianceInstancesInstances[] | cdktf.IResolvable) {
...
export function googleNetworkConnectivitySpokeTimeoutsToTerraform(struct?: GoogleNetworkConnectivitySpokeTimeoutsOutputReference | GoogleNetworkConnectivitySpokeTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleNetworkConnectivitySpokeTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetworkConnectivitySpokeTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleNetworkConnectivitySpokeTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
