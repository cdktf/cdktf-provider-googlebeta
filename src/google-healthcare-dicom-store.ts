...
export class GoogleHealthcareDicomStoreTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleHealthcareDicomStoreTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleHealthcareDicomStoreTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleHealthcareDicomStore extends cdktf.TerraformResource {
  ...
  */
  ...
  private _streamConfigs?: GoogleHealthcareDicomStoreStreamConfigs[] | cdktf.IResolvable; 
  public get streamConfigs() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('stream_configs');
  }
  public set streamConfigs(value: GoogleHealthcareDicomStoreStreamConfigs[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stream_configs: cdktf.listMapper(googleHealthcareDicomStoreStreamConfigsToTerraform)(this._streamConfigs),
