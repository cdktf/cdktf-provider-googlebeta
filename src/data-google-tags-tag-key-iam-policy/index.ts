// https://registry.terraform.io/providers/hashicorp/google-beta/6.20.0/docs/data-sources/google_tags_tag_key_iam_policy
...
export interface DataGoogleTagsTagKeyIamPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.20.0/docs/data-sources/google_tags_tag_key_iam_policy#id DataGoogleTagsTagKeyIamPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.20.0/docs/data-sources/google_tags_tag_key_iam_policy#tag_key DataGoogleTagsTagKeyIamPolicy#tag_key}
  */
  readonly tagKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.20.0/docs/data-sources/google_tags_tag_key_iam_policy google_tags_tag_key_iam_policy}
*/
export class DataGoogleTagsTagKeyIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleTagsTagKeyIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.20.0/docs/data-sources/google_tags_tag_key_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.20.0/docs/data-sources/google_tags_tag_key_iam_policy google_tags_tag_key_iam_policy} Data Source
  *
  * @param scope The scope in which to define this construct
