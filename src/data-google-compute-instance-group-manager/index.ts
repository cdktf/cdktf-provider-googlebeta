...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.31.1/docs/data-sources/google_compute_instance_group_manager
...
export interface DataGoogleComputeInstanceGroupManagerParams {
}

export function dataGoogleComputeInstanceGroupManagerParamsToTerraform(struct?: DataGoogleComputeInstanceGroupManagerParams): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataGoogleComputeInstanceGroupManagerParamsToHclTerraform(struct?: DataGoogleComputeInstanceGroupManagerParams): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataGoogleComputeInstanceGroupManagerParamsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleComputeInstanceGroupManagerParams | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleComputeInstanceGroupManagerParams | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataGoogleComputeInstanceGroupManagerParamsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataGoogleComputeInstanceGroupManagerParamsOutputReference {
    return new DataGoogleComputeInstanceGroupManagerParamsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleComputeInstanceGroupManager extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeInstanceGroupManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.31.1/docs/data-sources/google_compute_instance_group_manager#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.31.1/docs/data-sources/google_compute_instance_group_manager google_compute_instance_group_manager} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _params = new DataGoogleComputeInstanceGroupManagerParamsList(this, "params", false);
  public get params() {
    return this._params;
  }
