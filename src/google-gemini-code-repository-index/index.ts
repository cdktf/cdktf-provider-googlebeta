// https://registry.terraform.io/providers/hashicorp/google-beta/6.21.0/docs/resources/google_gemini_code_repository_index
...
export class GoogleGeminiCodeRepositoryIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleGeminiCodeRepositoryIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.21.0/docs/resources/google_gemini_code_repository_index#import import section} in the documentation of this resource for the id to use
