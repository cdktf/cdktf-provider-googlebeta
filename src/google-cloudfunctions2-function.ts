...
export class GoogleCloudfunctions2FunctionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudfunctions2FunctionTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudfunctions2FunctionTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
