...
export class GoogleAccessContextManagerGcpUserAccessBindingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleAccessContextManagerGcpUserAccessBindingTimeouts | undefined {
  ...
  public set internalValue(value: GoogleAccessContextManagerGcpUserAccessBindingTimeouts | undefined) {
    if (value === undefined) {
