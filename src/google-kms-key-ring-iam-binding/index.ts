...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.3.0/docs/resources/google_kms_key_ring_iam_binding
...
export class GoogleKmsKeyRingIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleKmsKeyRingIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.3.0/docs/resources/google_kms_key_ring_iam_binding#import import section} in the documentation of this resource for the id to use
