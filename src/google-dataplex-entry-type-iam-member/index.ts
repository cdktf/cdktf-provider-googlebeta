...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.12.0/docs/resources/google_dataplex_entry_type_iam_member
...
export interface GoogleDataplexEntryTypeIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleDataplexEntryTypeIamMemberCondition;
}
export interface GoogleDataplexEntryTypeIamMemberCondition {
  /**
...
export function googleDataplexEntryTypeIamMemberConditionToTerraform(struct?: GoogleDataplexEntryTypeIamMemberConditionOutputReference | GoogleDataplexEntryTypeIamMemberCondition): any {
...
export function googleDataplexEntryTypeIamMemberConditionToHclTerraform(struct?: GoogleDataplexEntryTypeIamMemberConditionOutputReference | GoogleDataplexEntryTypeIamMemberCondition): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleDataplexEntryTypeIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataplexEntryTypeIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleDataplexEntryTypeIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleDataplexEntryTypeIamMember extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleDataplexEntryTypeIamMember to import
  * @param importFromId The id of the existing GoogleDataplexEntryTypeIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.12.0/docs/resources/google_dataplex_entry_type_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.12.0/docs/resources/google_dataplex_entry_type_iam_member google_dataplex_entry_type_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleDataplexEntryTypeIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleDataplexEntryTypeIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleDataplexEntryTypeIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleDataplexEntryTypeIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleDataplexEntryTypeIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleDataplexEntryTypeIamMemberConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleDataplexEntryTypeIamMemberConditionList",
      },
    };
