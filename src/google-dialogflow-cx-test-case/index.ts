// https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_dialogflow_cx_test_case
...
export class GoogleDialogflowCxTestCase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDialogflowCxTestCase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_dialogflow_cx_test_case#import import section} in the documentation of this resource for the id to use
