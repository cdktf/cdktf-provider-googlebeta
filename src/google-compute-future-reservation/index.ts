...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation
...
export interface GoogleComputeFutureReservationAggregateReservationReservedResourcesAccelerator {
  /**
...
export class GoogleComputeFutureReservationAggregateReservationReservedResourcesAcceleratorOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeFutureReservationAggregateReservationReservedResourcesAccelerator | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputeFutureReservationAggregateReservationReservedResourcesAccelerator | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleComputeFutureReservationAggregateReservationReservedResources {
  /**
  * accelerator block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#accelerator GoogleComputeFutureReservation#accelerator}
  */
...
export function googleComputeFutureReservationAggregateReservationReservedResourcesToHclTerraform(struct?: GoogleComputeFutureReservationAggregateReservationReservedResources | cdktf.IResolvable): any {
  ...
  const attrs = {
    accelerator: {
      value: googleComputeFutureReservationAggregateReservationReservedResourcesAcceleratorToHclTerraform(struct!.accelerator),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleComputeFutureReservationAggregateReservationReservedResourcesAcceleratorList",
    },
  };
...
export class GoogleComputeFutureReservationAggregateReservationReservedResourcesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeFutureReservationAggregateReservationReservedResources | cdktf.IResolvable | undefined {
    ...
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._accelerator?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.accelerator = this._accelerator?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }
  ...
  public set internalValue(value: GoogleComputeFutureReservationAggregateReservationReservedResources | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this.resolvableValue = undefined;
      this._accelerator.internalValue = value.accelerator;
    }
  }

  // accelerator - computed: false, optional: true, required: false
  private _accelerator = new GoogleComputeFutureReservationAggregateReservationReservedResourcesAcceleratorOutputReference(this, "accelerator");
  public get accelerator() {
    return this._accelerator;
  }
  public putAccelerator(value: GoogleComputeFutureReservationAggregateReservationReservedResourcesAccelerator) {
...
export class GoogleComputeFutureReservationAggregateReservationReservedResourcesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleComputeFutureReservationAggregateReservationReservedResourcesOutputReference {
    return new GoogleComputeFutureReservationAggregateReservationReservedResourcesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleComputeFutureReservationAggregateReservation {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#vm_family GoogleComputeFutureReservation#vm_family}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#workload_type GoogleComputeFutureReservation#workload_type}
  */
  readonly workloadType?: string;
  /**
  * reserved_resources block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#reserved_resources GoogleComputeFutureReservation#reserved_resources}
  */
...
export class GoogleComputeFutureReservationAggregateReservationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeFutureReservationAggregateReservation | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._vmFamily !== undefined) {
      hasAnyValues = true;
      internalValueResult.vmFamily = this._vmFamily;
    }
    if (this._workloadType !== undefined) {
      hasAnyValues = true;
      internalValueResult.workloadType = this._workloadType;
    }
    if (this._reservedResources?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.reservedResources = this._reservedResources?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleComputeFutureReservationAggregateReservation | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._vmFamily = undefined;
      this._workloadType = undefined;
      this._reservedResources.internalValue = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._vmFamily = value.vmFamily;
      this._workloadType = value.workloadType;
      this._reservedResources.internalValue = value.reservedResources;
    }
  }

  // vm_family - computed: false, optional: true, required: false
  private _vmFamily?: string; 
  public get vmFamily() {
    return this.getStringAttribute('vm_family');
  }
  public set vmFamily(value: string) {
    this._vmFamily = value;
  }
  public resetVmFamily() {
    this._vmFamily = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get vmFamilyInput() {
    return this._vmFamily;
  }
  ...
  // reserved_resources - computed: false, optional: false, required: true
  private _reservedResources = new GoogleComputeFutureReservationAggregateReservationReservedResourcesList(this, "reserved_resources", false);
  ...
  // Temporarily expose input value. Use with caution.
  public get reservedResourcesInput() {
    return this._reservedResources.internalValue;
  }
}
export interface GoogleComputeFutureReservationAutoCreatedReservationsDuration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#nanos GoogleComputeFutureReservation#nanos}
  */
  readonly nanos?: number;
  /**
  * Span of time at a resolution of a second. Must be from 0 to 315,576,000,000 inclusive.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#seconds GoogleComputeFutureReservation#seconds}
  */
...
export interface GoogleComputeFutureReservationShareSettingsProjectMap {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#project_id GoogleComputeFutureReservation#project_id}
  */
...
export interface GoogleComputeFutureReservationShareSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#projects GoogleComputeFutureReservation#projects}
  */
  readonly projects?: string[];
  /**
  * Type of sharing for this future reservation. Possible values: ["LOCAL", "SPECIFIC_PROJECTS"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#share_type GoogleComputeFutureReservation#share_type}
  */
  readonly shareType?: string;
  /**
  * project_map block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#project_map GoogleComputeFutureReservation#project_map}
  */
...
export interface GoogleComputeFutureReservationSpecificSkuPropertiesInstancePropertiesLocalSsds {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#disk_size_gb GoogleComputeFutureReservation#disk_size_gb}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#interface GoogleComputeFutureReservation#interface}
  */
...
export interface GoogleComputeFutureReservationSpecificSkuPropertiesInstanceProperties {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#location_hint GoogleComputeFutureReservation#location_hint}
  */
  readonly locationHint?: string;
  /**
  * Specifies type of machine (name only) which has fixed number of vCPUs and fixed amount of memory. This also includes specifying custom machine type following custom-NUMBER_OF_CPUS-AMOUNT_OF_MEMORY pattern.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#machine_type GoogleComputeFutureReservation#machine_type}
  */
  readonly machineType?: string;
  /**
  * Specifies the number of hours after reservation creation where instances using the reservation won't be scheduled for maintenance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#maintenance_freeze_duration_hours GoogleComputeFutureReservation#maintenance_freeze_duration_hours}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#maintenance_interval GoogleComputeFutureReservation#maintenance_interval}
  */
  readonly maintenanceInterval?: string;
  /**
  * Minimum cpu platform the reservation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#min_cpu_platform GoogleComputeFutureReservation#min_cpu_platform}
  */
  readonly minCpuPlatform?: string;
  /**
  * guest_accelerators block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#guest_accelerators GoogleComputeFutureReservation#guest_accelerators}
  */
  ...
  * local_ssds block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#local_ssds GoogleComputeFutureReservation#local_ssds}
  */
...
export interface GoogleComputeFutureReservationSpecificSkuProperties {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#source_instance_template GoogleComputeFutureReservation#source_instance_template}
  */
  readonly sourceInstanceTemplate?: string;
  /**
  * Total number of instances for which capacity assurance is requested at a future time period.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#total_count GoogleComputeFutureReservation#total_count}
  */
  readonly totalCount?: string;
  /**
  * instance_properties block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#instance_properties GoogleComputeFutureReservation#instance_properties}
  */
...
export interface GoogleComputeFutureReservationTimeWindow {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#end_time GoogleComputeFutureReservation#end_time}
  */
  readonly endTime?: string;
  /**
  * Start time of the future reservation in RFC3339 format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#start_time GoogleComputeFutureReservation#start_time}
  */
  readonly startTime: string;
  /**
  * duration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#duration GoogleComputeFutureReservation#duration}
  */
...
export interface GoogleComputeFutureReservationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#create GoogleComputeFutureReservation#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#delete GoogleComputeFutureReservation#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#update GoogleComputeFutureReservation#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation google_compute_future_reservation}
*/
export class GoogleComputeFutureReservation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeFutureReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_compute_future_reservation google_compute_future_reservation} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeFutureReservationConfig) {
    ...
    this._aggregateReservation.internalValue = config.aggregateReservation;
  ...
  // aggregate_reservation - computed: false, optional: true, required: false
  private _aggregateReservation = new GoogleComputeFutureReservationAggregateReservationOutputReference(this, "aggregate_reservation");
  public get aggregateReservation() {
    return this._aggregateReservation;
  }
  public putAggregateReservation(value: GoogleComputeFutureReservationAggregateReservation) {
    this._aggregateReservation.internalValue = value;
  }
  public resetAggregateReservation() {
    this._aggregateReservation.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get aggregateReservationInput() {
    return this._aggregateReservation.internalValue;
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      aggregate_reservation: {
        value: googleComputeFutureReservationAggregateReservationToHclTerraform(this._aggregateReservation.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeFutureReservationAggregateReservationList",
      },
