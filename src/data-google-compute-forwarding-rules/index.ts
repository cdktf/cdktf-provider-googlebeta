...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/data-sources/google_compute_forwarding_rules
...
export class DataGoogleComputeForwardingRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeForwardingRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/data-sources/google_compute_forwarding_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/data-sources/google_compute_forwarding_rules google_compute_forwarding_rules} Data Source
  *
  * @param scope The scope in which to define this construct
