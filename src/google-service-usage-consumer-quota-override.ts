// https://www.terraform.io/docs/providers/google-beta/r/google_service_usage_consumer_quota_override
...
export function googleServiceUsageConsumerQuotaOverrideTimeoutsToTerraform(struct?: GoogleServiceUsageConsumerQuotaOverrideTimeoutsOutputReference | GoogleServiceUsageConsumerQuotaOverrideTimeouts | cdktf.IResolvable): any {
...
export class GoogleServiceUsageConsumerQuotaOverrideTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleServiceUsageConsumerQuotaOverrideTimeouts | undefined {
  ...
  public set internalValue(value: GoogleServiceUsageConsumerQuotaOverrideTimeouts | undefined) {
    if (value === undefined) {
