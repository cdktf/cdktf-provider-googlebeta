// https://www.terraform.io/docs/providers/google-beta/r/google_binary_authorization_attestor
...
export class GoogleBinaryAuthorizationAttestorAttestationAuthorityNoteOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _publicKeys?: GoogleBinaryAuthorizationAttestorAttestationAuthorityNotePublicKeys[] | cdktf.IResolvable; 
  public get publicKeys() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('public_keys');
  }
  public set publicKeys(value: GoogleBinaryAuthorizationAttestorAttestationAuthorityNotePublicKeys[] | cdktf.IResolvable) {
...
export function googleBinaryAuthorizationAttestorTimeoutsToTerraform(struct?: GoogleBinaryAuthorizationAttestorTimeoutsOutputReference | GoogleBinaryAuthorizationAttestorTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleBinaryAuthorizationAttestorTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBinaryAuthorizationAttestorTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleBinaryAuthorizationAttestorTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
