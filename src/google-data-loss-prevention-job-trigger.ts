...
export function googleDataLossPreventionJobTriggerInspectJobToTerraform(struct?: GoogleDataLossPreventionJobTriggerInspectJobOutputReference | GoogleDataLossPreventionJobTriggerInspectJob): any {
  ...
  return {
    ...
    actions: cdktf.listMapper(googleDataLossPreventionJobTriggerInspectJobActionsToTerraform)(struct!.actions),
...
export class GoogleDataLossPreventionJobTriggerInspectJobOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _actions?: GoogleDataLossPreventionJobTriggerInspectJobActions[] | cdktf.IResolvable; 
  public get actions() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('actions');
  }
  public set actions(value: GoogleDataLossPreventionJobTriggerInspectJobActions[] | cdktf.IResolvable) {
    this._actions = value;
  }
  // Temporarily expose input value. Use with caution.
...
export class GoogleDataLossPreventionJobTriggerTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataLossPreventionJobTriggerTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleDataLossPreventionJobTriggerTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleDataLossPreventionJobTrigger extends cdktf.TerraformResource {
  ...
  */
  ...
  private _triggers?: GoogleDataLossPreventionJobTriggerTriggers[] | cdktf.IResolvable; 
  public get triggers() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('triggers');
  }
  public set triggers(value: GoogleDataLossPreventionJobTriggerTriggers[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      triggers: cdktf.listMapper(googleDataLossPreventionJobTriggerTriggersToTerraform)(this._triggers),
    };
  }
}
