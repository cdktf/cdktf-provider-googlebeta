...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.15.0/docs/resources/google_vmwareengine_subnet
...
export class GoogleVmwareengineSubnet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleVmwareengineSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.15.0/docs/resources/google_vmwareengine_subnet#import import section} in the documentation of this resource for the id to use
