...
export class GoogleProjectUsageExportBucketTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleProjectUsageExportBucketTimeouts | undefined {
  ...
  public set internalValue(value: GoogleProjectUsageExportBucketTimeouts | undefined) {
    if (value === undefined) {
