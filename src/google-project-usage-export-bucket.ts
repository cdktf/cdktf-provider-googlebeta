// https://www.terraform.io/docs/providers/google-beta/r/google_project_usage_export_bucket
...
export function googleProjectUsageExportBucketTimeoutsToTerraform(struct?: GoogleProjectUsageExportBucketTimeoutsOutputReference | GoogleProjectUsageExportBucketTimeouts | cdktf.IResolvable): any {
...
export class GoogleProjectUsageExportBucketTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleProjectUsageExportBucketTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleProjectUsageExportBucketTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
