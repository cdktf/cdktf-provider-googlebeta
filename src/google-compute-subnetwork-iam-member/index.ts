...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.40.0/docs/resources/google_compute_subnetwork_iam_member
...
export class GoogleComputeSubnetworkIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeSubnetworkIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.40.0/docs/resources/google_compute_subnetwork_iam_member#import import section} in the documentation of this resource for the id to use
