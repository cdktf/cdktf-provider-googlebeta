// https://www.terraform.io/docs/providers/google-beta/r/google_api_gateway_api_config_iam_member
...
export function googleApiGatewayApiConfigIamMemberConditionToTerraform(struct?: GoogleApiGatewayApiConfigIamMemberConditionOutputReference | GoogleApiGatewayApiConfigIamMemberCondition): any {
...
export class GoogleApiGatewayApiConfigIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleApiGatewayApiConfigIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleApiGatewayApiConfigIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleApiGatewayApiConfigIamMember extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_api_gateway_api_config_iam_member";
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleApiGatewayApiConfigIamMemberConfig) {
    super(scope, id, {
      terraformResourceType: 'google_api_gateway_api_config_iam_member',
  ...
  private _condition = new GoogleApiGatewayApiConfigIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleApiGatewayApiConfigIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleApiGatewayApiConfigIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
