...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.46.0/docs/resources/google_compute_image
...
export interface GoogleComputeImageSourceDiskEncryptionKey {
  /**
...
export class GoogleComputeImageSourceDiskEncryptionKeyOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleComputeImageSourceDiskEncryptionKey | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._kmsKeySelfLink !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: GoogleComputeImageSourceDiskEncryptionKey | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._kmsKeySelfLink = undefined;
      this._kmsKeyServiceAccount = undefined;
...
export interface GoogleComputeImageSourceImageEncryptionKey {
  /**
  * The self link of the encryption key used to decrypt this resource. Also called KmsKeyName
  * in the cloud console. Your project's Compute Engine System service account
  * ('service-{{PROJECT_NUMBER}}@compute-system.iam.gserviceaccount.com') must have
...
export class GoogleComputeImageSourceImageEncryptionKeyOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleComputeImageSourceImageEncryptionKey | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._kmsKeySelfLink !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: GoogleComputeImageSourceImageEncryptionKey | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._kmsKeySelfLink = undefined;
      this._kmsKeyServiceAccount = undefined;
...
export interface GoogleComputeImageSourceSnapshotEncryptionKey {
  /**
  * The self link of the encryption key used to decrypt this resource. Also called KmsKeyName
  * in the cloud console. Your project's Compute Engine System service account
  * ('service-{{PROJECT_NUMBER}}@compute-system.iam.gserviceaccount.com') must have
...
export class GoogleComputeImageSourceSnapshotEncryptionKeyOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleComputeImageSourceSnapshotEncryptionKey | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._kmsKeySelfLink !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: GoogleComputeImageSourceSnapshotEncryptionKey | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._kmsKeySelfLink = undefined;
      this._kmsKeyServiceAccount = undefined;
...
export class GoogleComputeImage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.46.0/docs/resources/google_compute_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.46.0/docs/resources/google_compute_image google_compute_image} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _sourceDiskEncryptionKey = new GoogleComputeImageSourceDiskEncryptionKeyOutputReference(this, "source_disk_encryption_key");
  public get sourceDiskEncryptionKey() {
    return this._sourceDiskEncryptionKey;
  }
  public putSourceDiskEncryptionKey(value: GoogleComputeImageSourceDiskEncryptionKey) {
  ...
  private _sourceImageEncryptionKey = new GoogleComputeImageSourceImageEncryptionKeyOutputReference(this, "source_image_encryption_key");
  public get sourceImageEncryptionKey() {
    return this._sourceImageEncryptionKey;
  }
  public putSourceImageEncryptionKey(value: GoogleComputeImageSourceImageEncryptionKey) {
  ...
  private _sourceSnapshotEncryptionKey = new GoogleComputeImageSourceSnapshotEncryptionKeyOutputReference(this, "source_snapshot_encryption_key");
  public get sourceSnapshotEncryptionKey() {
    return this._sourceSnapshotEncryptionKey;
  }
  public putSourceSnapshotEncryptionKey(value: GoogleComputeImageSourceSnapshotEncryptionKey) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      source_disk_encryption_key: googleComputeImageSourceDiskEncryptionKeyToTerraform(this._sourceDiskEncryptionKey.internalValue),
      source_image_encryption_key: googleComputeImageSourceImageEncryptionKeyToTerraform(this._sourceImageEncryptionKey.internalValue),
      source_snapshot_encryption_key: googleComputeImageSourceSnapshotEncryptionKeyToTerraform(this._sourceSnapshotEncryptionKey.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      source_disk_encryption_key: {
        value: googleComputeImageSourceDiskEncryptionKeyToHclTerraform(this._sourceDiskEncryptionKey.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeImageSourceDiskEncryptionKeyList",
      },
      source_image_encryption_key: {
        value: googleComputeImageSourceImageEncryptionKeyToHclTerraform(this._sourceImageEncryptionKey.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeImageSourceImageEncryptionKeyList",
      },
      source_snapshot_encryption_key: {
        value: googleComputeImageSourceSnapshotEncryptionKeyToHclTerraform(this._sourceSnapshotEncryptionKey.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeImageSourceSnapshotEncryptionKeyList",
      },
      timeouts: {
