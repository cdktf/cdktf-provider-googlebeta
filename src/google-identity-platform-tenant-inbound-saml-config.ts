// https://www.terraform.io/docs/providers/google-beta/r/google_identity_platform_tenant_inbound_saml_config
...
export function googleIdentityPlatformTenantInboundSamlConfigIdpConfigToTerraform(struct?: GoogleIdentityPlatformTenantInboundSamlConfigIdpConfigOutputReference | GoogleIdentityPlatformTenantInboundSamlConfigIdpConfig): any {
  ...
  return {
    ...
    idp_certificates: cdktf.listMapper(googleIdentityPlatformTenantInboundSamlConfigIdpConfigIdpCertificatesToTerraform)(struct!.idpCertificates),
  }
}
...
export class GoogleIdentityPlatformTenantInboundSamlConfigIdpConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _idpCertificates?: GoogleIdentityPlatformTenantInboundSamlConfigIdpConfigIdpCertificates[] | cdktf.IResolvable; 
  public get idpCertificates() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('idp_certificates');
  }
  public set idpCertificates(value: GoogleIdentityPlatformTenantInboundSamlConfigIdpConfigIdpCertificates[] | cdktf.IResolvable) {
...
export function googleIdentityPlatformTenantInboundSamlConfigTimeoutsToTerraform(struct?: GoogleIdentityPlatformTenantInboundSamlConfigTimeoutsOutputReference | GoogleIdentityPlatformTenantInboundSamlConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleIdentityPlatformTenantInboundSamlConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIdentityPlatformTenantInboundSamlConfigTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleIdentityPlatformTenantInboundSamlConfigTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
