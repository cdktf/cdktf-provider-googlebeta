// https://www.terraform.io/docs/providers/google-beta/r/google_workstations_workstation_config
...
export interface GoogleWorkstationsWorkstationConfigConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleWorkstationsWorkstationConfigTimeoutsToTerraform(struct?: GoogleWorkstationsWorkstationConfigTimeoutsOutputReference | GoogleWorkstationsWorkstationConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
*/
export class GoogleWorkstationsWorkstationConfig extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_workstations_workstation_config google_workstations_workstation_config} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleWorkstationsWorkstationConfigConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleWorkstationsWorkstationConfigConfig) {
    super(scope, id, {
