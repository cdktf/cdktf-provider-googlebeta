// https://registry.terraform.io/providers/hashicorp/google-beta/6.28.0/docs/resources/google_storage_default_object_acl
...
export class GoogleStorageDefaultObjectAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleStorageDefaultObjectAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.28.0/docs/resources/google_storage_default_object_acl#import import section} in the documentation of this resource for the id to use
