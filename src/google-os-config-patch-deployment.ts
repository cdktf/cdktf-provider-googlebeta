...
export function googleOsConfigPatchDeploymentInstanceFilterToTerraform(struct?: GoogleOsConfigPatchDeploymentInstanceFilterOutputReference | GoogleOsConfigPatchDeploymentInstanceFilter): any {
  ...
  return {
    ...
    group_labels: cdktf.listMapper(googleOsConfigPatchDeploymentInstanceFilterGroupLabelsToTerraform)(struct!.groupLabels),
  }
}
...
export class GoogleOsConfigPatchDeploymentInstanceFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _groupLabels?: GoogleOsConfigPatchDeploymentInstanceFilterGroupLabels[] | cdktf.IResolvable; 
  public get groupLabels() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('group_labels');
  }
  public set groupLabels(value: GoogleOsConfigPatchDeploymentInstanceFilterGroupLabels[] | cdktf.IResolvable) {
...
export class GoogleOsConfigPatchDeploymentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleOsConfigPatchDeploymentTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleOsConfigPatchDeploymentTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
