...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/resources/google_workbench_instance_iam_policy
...
export interface GoogleWorkbenchInstanceIamPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class GoogleWorkbenchInstanceIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleWorkbenchInstanceIamPolicy to import
  * @param importFromId The id of the existing GoogleWorkbenchInstanceIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/resources/google_workbench_instance_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/resources/google_workbench_instance_iam_policy google_workbench_instance_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleWorkbenchInstanceIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleWorkbenchInstanceIamPolicyConfig) {
    super(scope, id, {
