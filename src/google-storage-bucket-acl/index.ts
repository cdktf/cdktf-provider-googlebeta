...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.40.0/docs/resources/google_storage_bucket_acl
...
export class GoogleStorageBucketAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleStorageBucketAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.40.0/docs/resources/google_storage_bucket_acl#import import section} in the documentation of this resource for the id to use
