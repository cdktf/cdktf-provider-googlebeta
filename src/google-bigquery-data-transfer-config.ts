...
export class GoogleBigqueryDataTransferConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigqueryDataTransferConfigTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleBigqueryDataTransferConfigTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
