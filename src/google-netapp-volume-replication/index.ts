// https://registry.terraform.io/providers/hashicorp/google-beta/6.37.0/docs/resources/google_netapp_volume_replication
...
export interface GoogleNetappVolumeReplicationHybridPeeringDetails {
}

export function googleNetappVolumeReplicationHybridPeeringDetailsToTerraform(struct?: GoogleNetappVolumeReplicationHybridPeeringDetails): any {
...
export function googleNetappVolumeReplicationHybridPeeringDetailsToHclTerraform(struct?: GoogleNetappVolumeReplicationHybridPeeringDetails): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleNetappVolumeReplicationHybridPeeringDetailsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetappVolumeReplicationHybridPeeringDetails | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleNetappVolumeReplicationHybridPeeringDetails | undefined) {
    if (value === undefined) {
...
export class GoogleNetappVolumeReplicationHybridPeeringDetailsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleNetappVolumeReplicationHybridPeeringDetailsOutputReference {
    return new GoogleNetappVolumeReplicationHybridPeeringDetailsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleNetappVolumeReplication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleNetappVolumeReplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.37.0/docs/resources/google_netapp_volume_replication#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _hybridPeeringDetails = new GoogleNetappVolumeReplicationHybridPeeringDetailsList(this, "hybrid_peering_details", false);
