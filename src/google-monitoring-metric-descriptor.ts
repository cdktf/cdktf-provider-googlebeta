...
export class GoogleMonitoringMetricDescriptorTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleMonitoringMetricDescriptorTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleMonitoringMetricDescriptorTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleMonitoringMetricDescriptor extends cdktf.TerraformResource {
  ...
  */
  ...
  private _labels?: GoogleMonitoringMetricDescriptorLabels[] | cdktf.IResolvable; 
  public get labels() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('labels')));
  }
  public set labels(value: GoogleMonitoringMetricDescriptorLabels[] | cdktf.IResolvable) {
    this._labels = value;
  }
  public resetLabels() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      labels: cdktf.listMapper(googleMonitoringMetricDescriptorLabelsToTerraform)(this._labels),
