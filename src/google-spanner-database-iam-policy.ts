// https://www.terraform.io/docs/providers/google-beta/r/google_spanner_database_iam_policy
...
export interface GoogleSpannerDatabaseIamPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class GoogleSpannerDatabaseIamPolicy extends cdktf.TerraformResource {
  ...
  * @param options GoogleSpannerDatabaseIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleSpannerDatabaseIamPolicyConfig) {
    super(scope, id, {
