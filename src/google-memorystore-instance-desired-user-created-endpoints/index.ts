...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.44.0/docs/resources/google_memorystore_instance_desired_user_created_endpoints
...
export class GoogleMemorystoreInstanceDesiredUserCreatedEndpoints extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleMemorystoreInstanceDesiredUserCreatedEndpoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.44.0/docs/resources/google_memorystore_instance_desired_user_created_endpoints#import import section} in the documentation of this resource for the id to use
