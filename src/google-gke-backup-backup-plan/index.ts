// https://www.terraform.io/docs/providers/google-beta/r/google_gke_backup_backup_plan
...
export function googleGkeBackupBackupPlanTimeoutsToTerraform(struct?: GoogleGkeBackupBackupPlanTimeoutsOutputReference | GoogleGkeBackupBackupPlanTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeBackupBackupPlan extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_gke_backup_backup_plan google_gke_backup_backup_plan} Resource
  *
