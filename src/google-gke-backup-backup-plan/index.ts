...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.12.0/docs/resources/google_gke_backup_backup_plan
...
export class GoogleGkeBackupBackupPlanBackupConfigEncryptionKeyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupBackupPlanBackupConfigEncryptionKey | undefined {
  ...
  public set internalValue(value: GoogleGkeBackupBackupPlanBackupConfigEncryptionKey | undefined) {
    if (value === undefined) {
...
export class GoogleGkeBackupBackupPlanBackupConfigSelectedApplicationsNamespacedNamesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleGkeBackupBackupPlanBackupConfigSelectedApplicationsNamespacedNamesOutputReference {
    return new GoogleGkeBackupBackupPlanBackupConfigSelectedApplicationsNamespacedNamesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleGkeBackupBackupPlanBackupConfigSelectedApplicationsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupBackupPlanBackupConfigSelectedApplications | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupBackupPlanBackupConfigSelectedApplications | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _namespacedNames = new GoogleGkeBackupBackupPlanBackupConfigSelectedApplicationsNamespacedNamesList(this, "namespaced_names", false);
...
export class GoogleGkeBackupBackupPlanBackupConfigSelectedNamespacesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupBackupPlanBackupConfigSelectedNamespaces | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupBackupPlanBackupConfigSelectedNamespaces | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleGkeBackupBackupPlanBackupConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupBackupPlanBackupConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupBackupPlanBackupConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _encryptionKey = new GoogleGkeBackupBackupPlanBackupConfigEncryptionKeyOutputReference(this, "encryption_key");
  public get encryptionKey() {
    return this._encryptionKey;
  }
  public putEncryptionKey(value: GoogleGkeBackupBackupPlanBackupConfigEncryptionKey) {
  ...
  private _selectedApplications = new GoogleGkeBackupBackupPlanBackupConfigSelectedApplicationsOutputReference(this, "selected_applications");
  public get selectedApplications() {
    return this._selectedApplications;
  }
  public putSelectedApplications(value: GoogleGkeBackupBackupPlanBackupConfigSelectedApplications) {
  ...
  private _selectedNamespaces = new GoogleGkeBackupBackupPlanBackupConfigSelectedNamespacesOutputReference(this, "selected_namespaces");
  public get selectedNamespaces() {
    return this._selectedNamespaces;
  }
  public putSelectedNamespaces(value: GoogleGkeBackupBackupPlanBackupConfigSelectedNamespaces) {
...
export interface GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsDaysOfWeek {
  /**
...
export class GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsDaysOfWeekOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsDaysOfWeek | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsDaysOfWeek | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsSingleOccurrenceDate {
  /**
  * Day of a month.
  *
...
export class GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsSingleOccurrenceDateOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsSingleOccurrenceDate | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsSingleOccurrenceDate | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._day = undefined;
...
export interface GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsStartTime {
  /**
...
export class GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsStartTimeOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsStartTime | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsStartTime | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindows {
  /**
  ...
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.12.0/docs/resources/google_gke_backup_backup_plan#days_of_week GoogleGkeBackupBackupPlan#days_of_week}
  */
  readonly daysOfWeek?: GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsDaysOfWeek;
  /**
  ...
  */
  readonly singleOccurrenceDate?: GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsSingleOccurrenceDate;
  /**
  * start_time block
  *
...
export function googleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsToHclTerraform(struct?: GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindows | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    days_of_week: {
      value: googleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsDaysOfWeekToHclTerraform(struct!.daysOfWeek),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsDaysOfWeekList",
    },
    single_occurrence_date: {
      value: googleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsSingleOccurrenceDateToHclTerraform(struct!.singleOccurrenceDate),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsSingleOccurrenceDateList",
    },
    start_time: {
      value: googleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsStartTimeToHclTerraform(struct!.startTime),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsStartTimeList",
    },
  };
...
export class GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // days_of_week - computed: false, optional: true, required: false
  private _daysOfWeek = new GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsDaysOfWeekOutputReference(this, "days_of_week");
  public get daysOfWeek() {
    return this._daysOfWeek;
  }
  public putDaysOfWeek(value: GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsDaysOfWeek) {
  ...
  private _singleOccurrenceDate = new GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsSingleOccurrenceDateOutputReference(this, "single_occurrence_date");
  public get singleOccurrenceDate() {
    return this._singleOccurrenceDate;
  }
  public putSingleOccurrenceDate(value: GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsSingleOccurrenceDate) {
  ...
  private _startTime = new GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsStartTimeOutputReference(this, "start_time");
  public get startTime() {
    return this._startTime;
  }
  public putStartTime(value: GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsStartTime) {
...
export class GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsOutputReference {
    return new GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleGkeBackupBackupPlanBackupScheduleRpoConfig {
  /**
...
export class GoogleGkeBackupBackupPlanBackupScheduleRpoConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupBackupPlanBackupScheduleRpoConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupBackupPlanBackupScheduleRpoConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _exclusionWindows = new GoogleGkeBackupBackupPlanBackupScheduleRpoConfigExclusionWindowsList(this, "exclusion_windows", false);
...
export interface GoogleGkeBackupBackupPlanBackupSchedule {
  ...
  */
  readonly rpoConfig?: GoogleGkeBackupBackupPlanBackupScheduleRpoConfig;
}
...
export function googleGkeBackupBackupPlanBackupScheduleToHclTerraform(struct?: GoogleGkeBackupBackupPlanBackupScheduleOutputReference | GoogleGkeBackupBackupPlanBackupSchedule): any {
  ...
  const attrs = {
    ...
    rpo_config: {
      value: googleGkeBackupBackupPlanBackupScheduleRpoConfigToHclTerraform(struct!.rpoConfig),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupBackupPlanBackupScheduleRpoConfigList",
    },
  };
...
export class GoogleGkeBackupBackupPlanBackupScheduleOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupBackupPlanBackupSchedule | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupBackupPlanBackupSchedule | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _rpoConfig = new GoogleGkeBackupBackupPlanBackupScheduleRpoConfigOutputReference(this, "rpo_config");
  public get rpoConfig() {
    return this._rpoConfig;
  }
  public putRpoConfig(value: GoogleGkeBackupBackupPlanBackupScheduleRpoConfig) {
...
export class GoogleGkeBackupBackupPlanRetentionPolicyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupBackupPlanRetentionPolicy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupBackupPlanRetentionPolicy | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleGkeBackupBackupPlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleGkeBackupBackupPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.12.0/docs/resources/google_gke_backup_backup_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.12.0/docs/resources/google_gke_backup_backup_plan google_gke_backup_backup_plan} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleGkeBackupBackupPlanConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleGkeBackupBackupPlanConfig) {
    super(scope, id, {
  ...
  private _backupConfig = new GoogleGkeBackupBackupPlanBackupConfigOutputReference(this, "backup_config");
  public get backupConfig() {
    return this._backupConfig;
  }
  public putBackupConfig(value: GoogleGkeBackupBackupPlanBackupConfig) {
  ...
  private _backupSchedule = new GoogleGkeBackupBackupPlanBackupScheduleOutputReference(this, "backup_schedule");
  public get backupSchedule() {
    return this._backupSchedule;
  }
  public putBackupSchedule(value: GoogleGkeBackupBackupPlanBackupSchedule) {
  ...
  private _retentionPolicy = new GoogleGkeBackupBackupPlanRetentionPolicyOutputReference(this, "retention_policy");
  public get retentionPolicy() {
    return this._retentionPolicy;
  }
  public putRetentionPolicy(value: GoogleGkeBackupBackupPlanRetentionPolicy) {
  ...
  private _timeouts = new GoogleGkeBackupBackupPlanTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleGkeBackupBackupPlanTimeouts) {
