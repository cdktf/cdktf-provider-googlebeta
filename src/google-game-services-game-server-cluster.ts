...
export class GoogleGameServicesGameServerClusterTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGameServicesGameServerClusterTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGameServicesGameServerClusterTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
