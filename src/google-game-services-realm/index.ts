// https://registry.terraform.io/providers/hashicorp/google-beta/4.82.0/docs/resources/google_game_services_realm
...
export function googleGameServicesRealmTimeoutsToTerraform(struct?: GoogleGameServicesRealmTimeouts | cdktf.IResolvable): any {
...
export class GoogleGameServicesRealmTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGameServicesRealmTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleGameServicesRealmTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleGameServicesRealm extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.82.0/docs/resources/google_game_services_realm google_game_services_realm} Resource
  *
