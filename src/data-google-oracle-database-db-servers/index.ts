...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.48.0/docs/data-sources/google_oracle_database_db_servers
...
export class DataGoogleOracleDatabaseDbServers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleOracleDatabaseDbServers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.48.0/docs/data-sources/google_oracle_database_db_servers#import import section} in the documentation of this resource for the id to use
