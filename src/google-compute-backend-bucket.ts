...
export function googleComputeBackendBucketCdnPolicyToTerraform(struct?: GoogleComputeBackendBucketCdnPolicyOutputReference | GoogleComputeBackendBucketCdnPolicy): any {
  ...
  return {
    ...
    bypass_cache_on_request_headers: cdktf.listMapper(googleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersToTerraform)(struct!.bypassCacheOnRequestHeaders),
