...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.16.0/docs/resources/google_scc_event_threat_detection_custom_module
...
export interface GoogleSccEventThreatDetectionCustomModuleConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: GoogleSccEventThreatDetectionCustomModuleTimeouts;
}
export interface GoogleSccEventThreatDetectionCustomModuleTimeouts {
  /**
...
export function googleSccEventThreatDetectionCustomModuleTimeoutsToTerraform(struct?: GoogleSccEventThreatDetectionCustomModuleTimeouts | cdktf.IResolvable): any {
...
export function googleSccEventThreatDetectionCustomModuleTimeoutsToHclTerraform(struct?: GoogleSccEventThreatDetectionCustomModuleTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleSccEventThreatDetectionCustomModuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSccEventThreatDetectionCustomModuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleSccEventThreatDetectionCustomModuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleSccEventThreatDetectionCustomModule extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleSccEventThreatDetectionCustomModule to import
  * @param importFromId The id of the existing GoogleSccEventThreatDetectionCustomModule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.16.0/docs/resources/google_scc_event_threat_detection_custom_module#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.16.0/docs/resources/google_scc_event_threat_detection_custom_module google_scc_event_threat_detection_custom_module} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleSccEventThreatDetectionCustomModuleConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleSccEventThreatDetectionCustomModuleConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleSccEventThreatDetectionCustomModuleTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleSccEventThreatDetectionCustomModuleTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleSccEventThreatDetectionCustomModuleTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleSccEventThreatDetectionCustomModuleTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleSccEventThreatDetectionCustomModuleTimeouts",
      },
    };
