// https://www.terraform.io/docs/providers/google-beta/r/google_bigquery_reservation_assignment
...
export interface GoogleBigqueryReservationAssignmentConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleBigqueryReservationAssignmentTimeoutsToTerraform(struct?: GoogleBigqueryReservationAssignmentTimeoutsOutputReference | GoogleBigqueryReservationAssignmentTimeouts | cdktf.IResolvable): any {
...
export class GoogleBigqueryReservationAssignmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigqueryReservationAssignmentTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleBigqueryReservationAssignmentTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleBigqueryReservationAssignment extends cdktf.TerraformResource {
  ...
  * @param options GoogleBigqueryReservationAssignmentConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleBigqueryReservationAssignmentConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleBigqueryReservationAssignmentTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleBigqueryReservationAssignmentTimeouts) {
