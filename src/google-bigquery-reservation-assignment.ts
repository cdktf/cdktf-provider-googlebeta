...
export class GoogleBigqueryReservationAssignmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigqueryReservationAssignmentTimeouts | undefined {
  ...
  public set internalValue(value: GoogleBigqueryReservationAssignmentTimeouts | undefined) {
    if (value === undefined) {
