...
export class GoogleActiveDirectoryDomainTrustTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleActiveDirectoryDomainTrustTimeouts | undefined {
  ...
  public set internalValue(value: GoogleActiveDirectoryDomainTrustTimeouts | undefined) {
    if (value === undefined) {
