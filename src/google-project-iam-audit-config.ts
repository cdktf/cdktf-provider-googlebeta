...
export class GoogleProjectIamAuditConfig extends cdktf.TerraformResource {
  ...
  */
  ...
  private _auditLogConfig?: GoogleProjectIamAuditConfigAuditLogConfig[] | cdktf.IResolvable; 
  ...
  public set auditLogConfig(value: GoogleProjectIamAuditConfigAuditLogConfig[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      audit_log_config: cdktf.listMapper(googleProjectIamAuditConfigAuditLogConfigToTerraform)(this._auditLogConfig),
    };
  }
}
