...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.22.0/docs/resources/google_gemini_data_sharing_with_google_setting_binding
...
export interface GoogleGeminiDataSharingWithGoogleSettingBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleGeminiDataSharingWithGoogleSettingBindingTimeoutsToTerraform(struct?: GoogleGeminiDataSharingWithGoogleSettingBindingTimeouts | cdktf.IResolvable): any {
...
export function googleGeminiDataSharingWithGoogleSettingBindingTimeoutsToHclTerraform(struct?: GoogleGeminiDataSharingWithGoogleSettingBindingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGeminiDataSharingWithGoogleSettingBindingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGeminiDataSharingWithGoogleSettingBindingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleGeminiDataSharingWithGoogleSettingBindingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleGeminiDataSharingWithGoogleSettingBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleGeminiDataSharingWithGoogleSettingBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.22.0/docs/resources/google_gemini_data_sharing_with_google_setting_binding#import import section} in the documentation of this resource for the id to use
