...
export class GoogleCertificateManagerCertificateTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCertificateManagerCertificateTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCertificateManagerCertificateTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
