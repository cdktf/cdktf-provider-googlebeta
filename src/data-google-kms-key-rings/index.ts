...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.16.0/docs/data-sources/google_kms_key_rings
...
export class DataGoogleKmsKeyRings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleKmsKeyRings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.16.0/docs/data-sources/google_kms_key_rings#import import section} in the documentation of this resource for the id to use
