...
export class GoogleComputeRegionNetworkEndpointGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeRegionNetworkEndpointGroupTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputeRegionNetworkEndpointGroupTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
