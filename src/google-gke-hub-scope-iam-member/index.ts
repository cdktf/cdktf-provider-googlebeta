...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.24.0/docs/resources/google_gke_hub_scope_iam_member
...
export function googleGkeHubScopeIamMemberConditionToTerraform(struct?: GoogleGkeHubScopeIamMemberConditionOutputReference | GoogleGkeHubScopeIamMemberCondition): any {
...
export function googleGkeHubScopeIamMemberConditionToHclTerraform(struct?: GoogleGkeHubScopeIamMemberConditionOutputReference | GoogleGkeHubScopeIamMemberCondition): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeHubScopeIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeHubScopeIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleGkeHubScopeIamMemberCondition | undefined) {
    if (value === undefined) {
...
export class GoogleGkeHubScopeIamMember extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleGkeHubScopeIamMember to import
  * @param importFromId The id of the existing GoogleGkeHubScopeIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.24.0/docs/resources/google_gke_hub_scope_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.24.0/docs/resources/google_gke_hub_scope_iam_member google_gke_hub_scope_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleGkeHubScopeIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleGkeHubScopeIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleGkeHubScopeIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleGkeHubScopeIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleGkeHubScopeIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleGkeHubScopeIamMemberConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleGkeHubScopeIamMemberConditionList",
      },
    };
