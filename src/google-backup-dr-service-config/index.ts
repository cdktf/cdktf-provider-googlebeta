...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_backup_dr_service_config
...
export function googleBackupDrServiceConfigTimeoutsToTerraform(struct?: GoogleBackupDrServiceConfigTimeouts | cdktf.IResolvable): any {
...
export function googleBackupDrServiceConfigTimeoutsToHclTerraform(struct?: GoogleBackupDrServiceConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleBackupDrServiceConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBackupDrServiceConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleBackupDrServiceConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleBackupDrServiceConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleBackupDrServiceConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_backup_dr_service_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_backup_dr_service_config google_backup_dr_service_config} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleBackupDrServiceConfigConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleBackupDrServiceConfigConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleBackupDrServiceConfigTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleBackupDrServiceConfigTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleBackupDrServiceConfigTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleBackupDrServiceConfigTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleBackupDrServiceConfigTimeouts",
      },
    };
