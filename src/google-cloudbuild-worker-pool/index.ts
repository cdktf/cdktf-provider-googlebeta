...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.6.0/docs/resources/google_cloudbuild_worker_pool
...
export class GoogleCloudbuildWorkerPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleCloudbuildWorkerPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.6.0/docs/resources/google_cloudbuild_worker_pool#import import section} in the documentation of this resource for the id to use
