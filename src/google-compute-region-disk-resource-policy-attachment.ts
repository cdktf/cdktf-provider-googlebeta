// https://www.terraform.io/docs/providers/google-beta/r/google_compute_region_disk_resource_policy_attachment
...
export function googleComputeRegionDiskResourcePolicyAttachmentTimeoutsToTerraform(struct?: GoogleComputeRegionDiskResourcePolicyAttachmentTimeoutsOutputReference | GoogleComputeRegionDiskResourcePolicyAttachmentTimeouts | cdktf.IResolvable): any {
...
export class GoogleComputeRegionDiskResourcePolicyAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeRegionDiskResourcePolicyAttachmentTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeRegionDiskResourcePolicyAttachmentTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleComputeRegionDiskResourcePolicyAttachment extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeRegionDiskResourcePolicyAttachmentConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleComputeRegionDiskResourcePolicyAttachmentTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleComputeRegionDiskResourcePolicyAttachmentTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleComputeRegionDiskResourcePolicyAttachmentTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
