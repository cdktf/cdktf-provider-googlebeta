...
export class GoogleComputeRegionDiskResourcePolicyAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeRegionDiskResourcePolicyAttachmentTimeouts | undefined {
  ...
  public set internalValue(value: GoogleComputeRegionDiskResourcePolicyAttachmentTimeouts | undefined) {
    if (value === undefined) {
