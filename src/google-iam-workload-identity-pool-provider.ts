// https://www.terraform.io/docs/providers/google-beta/r/google_iam_workload_identity_pool_provider
...
export class GoogleIamWorkloadIdentityPoolProviderAwsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIamWorkloadIdentityPoolProviderAws | undefined {
  ...
  public set internalValue(value: GoogleIamWorkloadIdentityPoolProviderAws | undefined) {
    if (value === undefined) {
...
export interface GoogleIamWorkloadIdentityPoolProviderOidc {
  /**
...
export class GoogleIamWorkloadIdentityPoolProviderOidcOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIamWorkloadIdentityPoolProviderOidc | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleIamWorkloadIdentityPoolProviderOidc | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function googleIamWorkloadIdentityPoolProviderTimeoutsToTerraform(struct?: GoogleIamWorkloadIdentityPoolProviderTimeoutsOutputReference | GoogleIamWorkloadIdentityPoolProviderTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleIamWorkloadIdentityPoolProviderTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIamWorkloadIdentityPoolProviderTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleIamWorkloadIdentityPoolProviderTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleIamWorkloadIdentityPoolProvider extends cdktf.TerraformResource {
  ...
  * @param options GoogleIamWorkloadIdentityPoolProviderConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleIamWorkloadIdentityPoolProviderConfig) {
    super(scope, id, {
  ...
  private _aws = new GoogleIamWorkloadIdentityPoolProviderAwsOutputReference(this, "aws");
  public get aws() {
    return this._aws;
  }
  public putAws(value: GoogleIamWorkloadIdentityPoolProviderAws) {
  ...
  private _oidc = new GoogleIamWorkloadIdentityPoolProviderOidcOutputReference(this, "oidc");
  public get oidc() {
    return this._oidc;
  }
  public putOidc(value: GoogleIamWorkloadIdentityPoolProviderOidc) {
  ...
  private _timeouts = new GoogleIamWorkloadIdentityPoolProviderTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleIamWorkloadIdentityPoolProviderTimeouts) {
