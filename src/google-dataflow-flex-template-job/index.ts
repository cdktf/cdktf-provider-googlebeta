...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.49.2/docs/resources/google_dataflow_flex_template_job
...
export interface GoogleDataflowFlexTemplateJobConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly additionalPipelineOptions?: string[];
  /**
...
export class GoogleDataflowFlexTemplateJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDataflowFlexTemplateJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.2/docs/resources/google_dataflow_flex_template_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.2/docs/resources/google_dataflow_flex_template_job google_dataflow_flex_template_job} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleDataflowFlexTemplateJobConfig) {
    ...
    this._additionalPipelineOptions = config.additionalPipelineOptions;
  ...
  // additional_pipeline_options - computed: false, optional: true, required: false
  private _additionalPipelineOptions?: string[]; 
  public get additionalPipelineOptions() {
    return cdktf.Fn.tolist(this.getListAttribute('additional_pipeline_options'));
  }
  public set additionalPipelineOptions(value: string[]) {
    this._additionalPipelineOptions = value;
  }
  public resetAdditionalPipelineOptions() {
    this._additionalPipelineOptions = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get additionalPipelineOptionsInput() {
    return this._additionalPipelineOptions;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      additional_pipeline_options: cdktf.listMapper(cdktf.stringToTerraform, false)(this._additionalPipelineOptions),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      additional_pipeline_options: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._additionalPipelineOptions),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
