...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.31.1/docs/data-sources/google_storage_bucket
...
export class DataGoogleStorageBucket extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleStorageBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.31.1/docs/data-sources/google_storage_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.31.1/docs/data-sources/google_storage_bucket google_storage_bucket} Data Source
  *
  * @param scope The scope in which to define this construct
