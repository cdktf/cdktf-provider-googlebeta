...
export class GoogleHealthcareFhirStoreStreamConfigsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _bigqueryDestination = new GoogleHealthcareFhirStoreStreamConfigsBigqueryDestinationOutputReference(this, "bigquery_destination");
  public get bigqueryDestination() {
    return this._bigqueryDestination;
  }
  public putBigqueryDestination(value: GoogleHealthcareFhirStoreStreamConfigsBigqueryDestination) {
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stream_configs: cdktf.listMapper(googleHealthcareFhirStoreStreamConfigsToTerraform)(this._streamConfigs.internalValue),
