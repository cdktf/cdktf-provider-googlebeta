...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.36.1/docs/data-sources/google_compute_forwarding_rule
...
export class DataGoogleComputeForwardingRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeForwardingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.36.1/docs/data-sources/google_compute_forwarding_rule#import import section} in the documentation of this resource for the id to use
