// https://www.terraform.io/docs/providers/google-beta/r/google_api_gateway_api_iam_member
...
export interface GoogleApiGatewayApiIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface GoogleApiGatewayApiIamMemberCondition {
  /**
...
export function googleApiGatewayApiIamMemberConditionToTerraform(struct?: GoogleApiGatewayApiIamMemberConditionOutputReference | GoogleApiGatewayApiIamMemberCondition): any {
...
export class GoogleApiGatewayApiIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleApiGatewayApiIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleApiGatewayApiIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleApiGatewayApiIamMember extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_api_gateway_api_iam_member";
  ...
  * @param options GoogleApiGatewayApiIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleApiGatewayApiIamMemberConfig) {
    super(scope, id, {
      terraformResourceType: 'google_api_gateway_api_iam_member',
  ...
  private _condition = new GoogleApiGatewayApiIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleApiGatewayApiIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleApiGatewayApiIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
