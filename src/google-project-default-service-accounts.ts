...
export class GoogleProjectDefaultServiceAccountsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleProjectDefaultServiceAccountsTimeouts | undefined {
  ...
  public set internalValue(value: GoogleProjectDefaultServiceAccountsTimeouts | undefined) {
    if (value === undefined) {
