...
export class GoogleAccessContextManagerAccessPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleAccessContextManagerAccessPolicyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleAccessContextManagerAccessPolicyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
