// https://www.terraform.io/docs/providers/google-beta/r/google_app_engine_firewall_rule
...
export function googleAppEngineFirewallRuleTimeoutsToTerraform(struct?: GoogleAppEngineFirewallRuleTimeoutsOutputReference | GoogleAppEngineFirewallRuleTimeouts | cdktf.IResolvable): any {
...
export class GoogleAppEngineFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleAppEngineFirewallRuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleAppEngineFirewallRuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleAppEngineFirewallRule extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleAppEngineFirewallRuleConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleAppEngineFirewallRuleTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleAppEngineFirewallRuleTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleAppEngineFirewallRuleTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
