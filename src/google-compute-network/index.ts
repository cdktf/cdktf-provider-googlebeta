...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.49.3/docs/resources/google_compute_network
...
export interface GoogleComputeNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly params?: GoogleComputeNetworkParams;
  /**
  * timeouts block
  *
...
export interface GoogleComputeNetworkParams {
  /**
...
export class GoogleComputeNetworkParamsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeNetworkParams | undefined {
  ...
  public set internalValue(value: GoogleComputeNetworkParams | undefined) {
    if (value === undefined) {
...
export class GoogleComputeNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.3/docs/resources/google_compute_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.3/docs/resources/google_compute_network google_compute_network} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _params = new GoogleComputeNetworkParamsOutputReference(this, "params");
  public get params() {
    return this._params;
  }
  public putParams(value: GoogleComputeNetworkParams) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      params: {
        value: googleComputeNetworkParamsToHclTerraform(this._params.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeNetworkParamsList",
      },
      timeouts: {
        value: googleComputeNetworkTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleComputeNetworkTimeouts",
      },
    };
