...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_sql_databases
...
export class DataGoogleSqlDatabases extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSqlDatabases that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_sql_databases#import import section} in the documentation of this resource for the id to use
