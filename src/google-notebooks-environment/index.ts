...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_notebooks_environment
...
export class GoogleNotebooksEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleNotebooksEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_notebooks_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_notebooks_environment google_notebooks_environment} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      container_image: {
        value: googleNotebooksEnvironmentContainerImageToHclTerraform(this._containerImage.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleNotebooksEnvironmentContainerImageList",
      },
      timeouts: {
        value: googleNotebooksEnvironmentTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleNotebooksEnvironmentTimeouts",
      },
      vm_image: {
        value: googleNotebooksEnvironmentVmImageToHclTerraform(this._vmImage.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleNotebooksEnvironmentVmImageList",
      },
    };
