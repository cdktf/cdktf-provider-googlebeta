...
export class GoogleFirebaseProjectLocationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleFirebaseProjectLocationTimeouts | undefined {
  ...
  public set internalValue(value: GoogleFirebaseProjectLocationTimeouts | undefined) {
    if (value === undefined) {
