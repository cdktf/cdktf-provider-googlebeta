...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.9.0/docs/resources/google_dialogflow_fulfillment
...
export class GoogleDialogflowFulfillment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDialogflowFulfillment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.9.0/docs/resources/google_dialogflow_fulfillment#import import section} in the documentation of this resource for the id to use
