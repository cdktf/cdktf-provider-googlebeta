// https://www.terraform.io/docs/providers/google-beta/r/google_dataproc_autoscaling_policy
...
export function googleDataprocAutoscalingPolicyTimeoutsToTerraform(struct?: GoogleDataprocAutoscalingPolicyTimeoutsOutputReference | GoogleDataprocAutoscalingPolicyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleDataprocAutoscalingPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataprocAutoscalingPolicyTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleDataprocAutoscalingPolicyTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
