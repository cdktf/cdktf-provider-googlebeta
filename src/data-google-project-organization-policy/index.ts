...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.31.0/docs/data-sources/google_project_organization_policy
...
export class DataGoogleProjectOrganizationPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleProjectOrganizationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.31.0/docs/data-sources/google_project_organization_policy#import import section} in the documentation of this resource for the id to use
