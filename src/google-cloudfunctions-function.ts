  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      secret_environment_variables: cdktf.listMapper(googleCloudfunctionsFunctionSecretEnvironmentVariablesToTerraform)(this._secretEnvironmentVariables.internalValue),
      secret_volumes: cdktf.listMapper(googleCloudfunctionsFunctionSecretVolumesToTerraform)(this._secretVolumes.internalValue),
