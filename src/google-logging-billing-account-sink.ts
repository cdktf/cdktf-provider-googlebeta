...
export class GoogleLoggingBillingAccountSink extends cdktf.TerraformResource {
  ...
  */
  ...
  private _exclusions?: GoogleLoggingBillingAccountSinkExclusions[] | cdktf.IResolvable; 
  public get exclusions() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('exclusions');
  }
  public set exclusions(value: GoogleLoggingBillingAccountSinkExclusions[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      exclusions: cdktf.listMapper(googleLoggingBillingAccountSinkExclusionsToTerraform)(this._exclusions),
    };
  }
}
