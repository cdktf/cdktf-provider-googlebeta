// https://registry.terraform.io/providers/hashicorp/google-beta/6.21.0/docs/resources/google_netapp_volume_quota_rule
...
export interface GoogleNetappVolumeQuotaRuleConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleNetappVolumeQuotaRuleTimeoutsToTerraform(struct?: GoogleNetappVolumeQuotaRuleTimeouts | cdktf.IResolvable): any {
...
export function googleNetappVolumeQuotaRuleTimeoutsToHclTerraform(struct?: GoogleNetappVolumeQuotaRuleTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleNetappVolumeQuotaRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetappVolumeQuotaRuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleNetappVolumeQuotaRuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleNetappVolumeQuotaRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleNetappVolumeQuotaRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.21.0/docs/resources/google_netapp_volume_quota_rule#import import section} in the documentation of this resource for the id to use
