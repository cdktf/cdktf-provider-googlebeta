...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.8.0/docs/resources/google_compute_project_default_network_tier
...
export class GoogleComputeProjectDefaultNetworkTier extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeProjectDefaultNetworkTier that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.8.0/docs/resources/google_compute_project_default_network_tier#import import section} in the documentation of this resource for the id to use
