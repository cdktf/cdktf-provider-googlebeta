// https://www.terraform.io/docs/providers/google-beta/r/google_network_services_edge_cache_origin
...
export function googleNetworkServicesEdgeCacheOriginTimeoutsToTerraform(struct?: GoogleNetworkServicesEdgeCacheOriginTimeoutsOutputReference | GoogleNetworkServicesEdgeCacheOriginTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleNetworkServicesEdgeCacheOriginTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetworkServicesEdgeCacheOriginTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleNetworkServicesEdgeCacheOriginTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
