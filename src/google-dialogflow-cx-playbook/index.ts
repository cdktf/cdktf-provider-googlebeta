...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.49.2/docs/resources/google_dialogflow_cx_playbook
...
export interface GoogleDialogflowCxPlaybookConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly instruction?: GoogleDialogflowCxPlaybookInstruction;
  /**
  ...
  */
  readonly llmModelSettings?: GoogleDialogflowCxPlaybookLlmModelSettings;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: GoogleDialogflowCxPlaybookTimeouts;
}
export interface GoogleDialogflowCxPlaybookInstructionSteps {
  /**
...
export class GoogleDialogflowCxPlaybookInstructionStepsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleDialogflowCxPlaybookInstructionStepsOutputReference {
    return new GoogleDialogflowCxPlaybookInstructionStepsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleDialogflowCxPlaybookInstruction {
  /**
...
export class GoogleDialogflowCxPlaybookInstructionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDialogflowCxPlaybookInstruction | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleDialogflowCxPlaybookInstruction | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  // steps - computed: false, optional: true, required: false
  private _steps = new GoogleDialogflowCxPlaybookInstructionStepsList(this, "steps", false);
  public get steps() {
    return this._steps;
  }
...
export interface GoogleDialogflowCxPlaybookLlmModelSettings {
  /**
...
export class GoogleDialogflowCxPlaybookLlmModelSettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDialogflowCxPlaybookLlmModelSettings | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleDialogflowCxPlaybookLlmModelSettings | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleDialogflowCxPlaybookTimeouts {
  /**
...
export class GoogleDialogflowCxPlaybook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDialogflowCxPlaybook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.2/docs/resources/google_dialogflow_cx_playbook#import import section} in the documentation of this resource for the id to use
  ...
  * @param options GoogleDialogflowCxPlaybookConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleDialogflowCxPlaybookConfig) {
    super(scope, id, {
  ...
  private _instruction = new GoogleDialogflowCxPlaybookInstructionOutputReference(this, "instruction");
  public get instruction() {
    return this._instruction;
  }
  public putInstruction(value: GoogleDialogflowCxPlaybookInstruction) {
  ...
  private _llmModelSettings = new GoogleDialogflowCxPlaybookLlmModelSettingsOutputReference(this, "llm_model_settings");
  public get llmModelSettings() {
    return this._llmModelSettings;
  }
  public putLlmModelSettings(value: GoogleDialogflowCxPlaybookLlmModelSettings) {
  ...
  private _timeouts = new GoogleDialogflowCxPlaybookTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleDialogflowCxPlaybookTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      instruction: {
        value: googleDialogflowCxPlaybookInstructionToHclTerraform(this._instruction.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleDialogflowCxPlaybookInstructionList",
      },
      llm_model_settings: {
        value: googleDialogflowCxPlaybookLlmModelSettingsToHclTerraform(this._llmModelSettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleDialogflowCxPlaybookLlmModelSettingsList",
      },
      timeouts: {
        value: googleDialogflowCxPlaybookTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleDialogflowCxPlaybookTimeouts",
      },
    };
