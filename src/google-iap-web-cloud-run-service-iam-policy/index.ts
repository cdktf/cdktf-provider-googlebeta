...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_iap_web_cloud_run_service_iam_policy
...
export interface GoogleIapWebCloudRunServiceIamPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class GoogleIapWebCloudRunServiceIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleIapWebCloudRunServiceIamPolicy to import
  * @param importFromId The id of the existing GoogleIapWebCloudRunServiceIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_iap_web_cloud_run_service_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  * @param options GoogleIapWebCloudRunServiceIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleIapWebCloudRunServiceIamPolicyConfig) {
    super(scope, id, {
