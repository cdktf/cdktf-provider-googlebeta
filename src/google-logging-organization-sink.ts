...
export class GoogleLoggingOrganizationSink extends cdktf.TerraformResource {
  ...
  */
  ...
  private _exclusions?: GoogleLoggingOrganizationSinkExclusions[] | cdktf.IResolvable; 
  public get exclusions() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('exclusions');
  }
  public set exclusions(value: GoogleLoggingOrganizationSinkExclusions[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      exclusions: cdktf.listMapper(googleLoggingOrganizationSinkExclusionsToTerraform)(this._exclusions),
    };
  }
}
