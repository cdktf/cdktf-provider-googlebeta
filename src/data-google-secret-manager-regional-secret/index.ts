// https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/data-sources/google_secret_manager_regional_secret
...
export class DataGoogleSecretManagerRegionalSecret extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSecretManagerRegionalSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/data-sources/google_secret_manager_regional_secret#import import section} in the documentation of this resource for the id to use
