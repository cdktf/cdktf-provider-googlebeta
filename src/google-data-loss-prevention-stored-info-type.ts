// https://www.terraform.io/docs/providers/google-beta/r/google_data_loss_prevention_stored_info_type
...
export function googleDataLossPreventionStoredInfoTypeTimeoutsToTerraform(struct?: GoogleDataLossPreventionStoredInfoTypeTimeoutsOutputReference | GoogleDataLossPreventionStoredInfoTypeTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleDataLossPreventionStoredInfoTypeTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataLossPreventionStoredInfoTypeTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleDataLossPreventionStoredInfoTypeTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
