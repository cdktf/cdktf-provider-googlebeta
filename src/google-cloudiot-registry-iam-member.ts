// https://www.terraform.io/docs/providers/google-beta/r/google_cloudiot_registry_iam_member
...
export interface GoogleCloudiotRegistryIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleCloudiotRegistryIamMemberCondition;
}
export interface GoogleCloudiotRegistryIamMemberCondition {
  /**
...
export function googleCloudiotRegistryIamMemberConditionToTerraform(struct?: GoogleCloudiotRegistryIamMemberConditionOutputReference | GoogleCloudiotRegistryIamMemberCondition): any {
...
export class GoogleCloudiotRegistryIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudiotRegistryIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleCloudiotRegistryIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleCloudiotRegistryIamMember extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_cloudiot_registry_iam_member";
  ...
  * @param options GoogleCloudiotRegistryIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleCloudiotRegistryIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleCloudiotRegistryIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleCloudiotRegistryIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleCloudiotRegistryIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
