// https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user
...
export interface GoogleAlloydbUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#cluster GoogleAlloydbUser#cluster}
  */
  readonly cluster: string;
  /**
  * List of database roles this database user has.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#database_roles GoogleAlloydbUser#database_roles}
  */
  readonly databaseRoles?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#id GoogleAlloydbUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#password GoogleAlloydbUser#password}
  */
  readonly password?: string;
  /**
  * The database role name of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#user_id GoogleAlloydbUser#user_id}
  */
  readonly userId: string;
  /**
  * The type of this user. Possible values: ["ALLOYDB_BUILT_IN", "ALLOYDB_IAM_USER"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#user_type GoogleAlloydbUser#user_type}
  */
  readonly userType: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#timeouts GoogleAlloydbUser#timeouts}
  */
  readonly timeouts?: GoogleAlloydbUserTimeouts;
}
export interface GoogleAlloydbUserTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#create GoogleAlloydbUser#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#delete GoogleAlloydbUser#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#update GoogleAlloydbUser#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user google_alloydb_user}
*/
export class GoogleAlloydbUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleAlloydbUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/resources/google_alloydb_user google_alloydb_user} Resource
  *
  * @param scope The scope in which to define this construct
