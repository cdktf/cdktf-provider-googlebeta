...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.45.0/docs/data-sources/google_sql_backup_run
...
export interface DataGoogleSqlBackupRunConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.45.0/docs/data-sources/google_sql_backup_run#backup_id DataGoogleSqlBackupRun#backup_id}
  */
  readonly backupId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.45.0/docs/data-sources/google_sql_backup_run#id DataGoogleSqlBackupRun#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.45.0/docs/data-sources/google_sql_backup_run#instance DataGoogleSqlBackupRun#instance}
  */
  readonly instance: string;
  /**
  * Toggles use of the most recent backup run if multiple backups exist for a Cloud SQL instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.45.0/docs/data-sources/google_sql_backup_run#most_recent DataGoogleSqlBackupRun#most_recent}
  */
  readonly mostRecent?: boolean | cdktf.IResolvable;
  /**
  * Project ID of the project that contains the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.45.0/docs/data-sources/google_sql_backup_run#project DataGoogleSqlBackupRun#project}
  */
  readonly project?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.45.0/docs/data-sources/google_sql_backup_run google_sql_backup_run}
*/
export class DataGoogleSqlBackupRun extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSqlBackupRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.45.0/docs/data-sources/google_sql_backup_run#import import section} in the documentation of this resource for the id to use
