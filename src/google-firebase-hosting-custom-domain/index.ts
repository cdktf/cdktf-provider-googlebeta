...
export class GoogleFirebaseHostingCustomDomain extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.11.0/docs/resources/google_firebase_hosting_custom_domain google_firebase_hosting_custom_domain} Resource
  *
  * @param scope The scope in which to define this construct
