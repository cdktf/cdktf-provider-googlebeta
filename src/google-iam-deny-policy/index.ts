// https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/resources/google_iam_deny_policy
...
export function googleIamDenyPolicyRulesDenyRuleToHclTerraform(struct?: GoogleIamDenyPolicyRulesDenyRuleOutputReference | GoogleIamDenyPolicyRulesDenyRule): any {
  ...
  const attrs = {
    ...
    denial_condition: {
      value: googleIamDenyPolicyRulesDenyRuleDenialConditionToHclTerraform(struct!.denialCondition),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleIamDenyPolicyRulesDenyRuleDenialConditionList",
    },
  };
...
export function googleIamDenyPolicyRulesToHclTerraform(struct?: GoogleIamDenyPolicyRules | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    deny_rule: {
      value: googleIamDenyPolicyRulesDenyRuleToHclTerraform(struct!.denyRule),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleIamDenyPolicyRulesDenyRuleList",
    },
  };
...
export class GoogleIamDenyPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleIamDenyPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/resources/google_iam_deny_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/resources/google_iam_deny_policy google_iam_deny_policy} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleIamDenyPolicyTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleIamDenyPolicyTimeouts",
      },
    };
