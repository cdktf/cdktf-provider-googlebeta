...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_gemini_release_channel_setting_binding
...
export interface GoogleGeminiReleaseChannelSettingBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: GoogleGeminiReleaseChannelSettingBindingTimeouts;
}
export interface GoogleGeminiReleaseChannelSettingBindingTimeouts {
  /**
...
export function googleGeminiReleaseChannelSettingBindingTimeoutsToTerraform(struct?: GoogleGeminiReleaseChannelSettingBindingTimeouts | cdktf.IResolvable): any {
...
export function googleGeminiReleaseChannelSettingBindingTimeoutsToHclTerraform(struct?: GoogleGeminiReleaseChannelSettingBindingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGeminiReleaseChannelSettingBindingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGeminiReleaseChannelSettingBindingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleGeminiReleaseChannelSettingBindingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleGeminiReleaseChannelSettingBinding extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_gemini_release_channel_setting_binding";
  ...
  * @param importToId The construct id used in the generated config for the GoogleGeminiReleaseChannelSettingBinding to import
  * @param importFromId The id of the existing GoogleGeminiReleaseChannelSettingBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_gemini_release_channel_setting_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_gemini_release_channel_setting_binding", importId: importFromId, provider });
      }
  ...
  * @param options GoogleGeminiReleaseChannelSettingBindingConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleGeminiReleaseChannelSettingBindingConfig) {
    super(scope, id, {
      terraformResourceType: 'google_gemini_release_channel_setting_binding',
  ...
  private _timeouts = new GoogleGeminiReleaseChannelSettingBindingTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleGeminiReleaseChannelSettingBindingTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleGeminiReleaseChannelSettingBindingTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleGeminiReleaseChannelSettingBindingTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleGeminiReleaseChannelSettingBindingTimeouts",
      },
    };
