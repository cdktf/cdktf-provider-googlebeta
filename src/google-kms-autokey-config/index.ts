// https://registry.terraform.io/providers/hashicorp/google-beta/6.24.0/docs/resources/google_kms_autokey_config
...
export class GoogleKmsAutokeyConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleKmsAutokeyConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.24.0/docs/resources/google_kms_autokey_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.24.0/docs/resources/google_kms_autokey_config google_kms_autokey_config} Resource
  *
  * @param scope The scope in which to define this construct
