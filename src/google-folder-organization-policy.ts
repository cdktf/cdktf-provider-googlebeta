...
export class GoogleFolderOrganizationPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleFolderOrganizationPolicyTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleFolderOrganizationPolicyTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
