...
export class GoogleApigeeEnvgroupAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleApigeeEnvgroupAttachmentTimeouts | undefined {
  ...
  public set internalValue(value: GoogleApigeeEnvgroupAttachmentTimeouts | undefined) {
    if (value === undefined) {
