// https://registry.terraform.io/providers/hashicorp/google-beta/6.34.1/docs/resources/google_backup_dr_backup_vault
...
export class GoogleBackupDrBackupVault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleBackupDrBackupVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.34.1/docs/resources/google_backup_dr_backup_vault#import import section} in the documentation of this resource for the id to use
