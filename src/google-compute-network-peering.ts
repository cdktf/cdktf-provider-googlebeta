// https://www.terraform.io/docs/providers/google-beta/r/google_compute_network_peering
...
export function googleComputeNetworkPeeringTimeoutsToTerraform(struct?: GoogleComputeNetworkPeeringTimeoutsOutputReference | GoogleComputeNetworkPeeringTimeouts | cdktf.IResolvable): any {
...
export class GoogleComputeNetworkPeeringTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeNetworkPeeringTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeNetworkPeeringTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleComputeNetworkPeering extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeNetworkPeeringConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleComputeNetworkPeeringTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleComputeNetworkPeeringTimeouts) {
