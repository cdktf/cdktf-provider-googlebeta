// https://www.terraform.io/docs/providers/google-beta/r/google_dataproc_autoscaling_policy_iam_member
...
export interface GoogleDataprocAutoscalingPolicyIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleDataprocAutoscalingPolicyIamMemberCondition;
}
export interface GoogleDataprocAutoscalingPolicyIamMemberCondition {
  /**
...
export function googleDataprocAutoscalingPolicyIamMemberConditionToTerraform(struct?: GoogleDataprocAutoscalingPolicyIamMemberConditionOutputReference | GoogleDataprocAutoscalingPolicyIamMemberCondition): any {
...
export class GoogleDataprocAutoscalingPolicyIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataprocAutoscalingPolicyIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleDataprocAutoscalingPolicyIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleDataprocAutoscalingPolicyIamMember extends cdktf.TerraformResource {
  ...
  * @param options GoogleDataprocAutoscalingPolicyIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleDataprocAutoscalingPolicyIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleDataprocAutoscalingPolicyIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleDataprocAutoscalingPolicyIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleDataprocAutoscalingPolicyIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
