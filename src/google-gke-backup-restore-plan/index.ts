// https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan
...
export interface GoogleGkeBackupRestorePlanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#backup_plan GoogleGkeBackupRestorePlan#backup_plan}
  */
  readonly backupPlan: string;
  /**
  * The source cluster from which Restores will be created via this RestorePlan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#cluster GoogleGkeBackupRestorePlan#cluster}
  */
  readonly cluster: string;
  /**
  * User specified descriptive string for this RestorePlan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#description GoogleGkeBackupRestorePlan#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#id GoogleGkeBackupRestorePlan#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#labels GoogleGkeBackupRestorePlan#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The region of the Restore Plan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#location GoogleGkeBackupRestorePlan#location}
  */
  readonly location: string;
  /**
  * The full name of the BackupPlan Resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#name GoogleGkeBackupRestorePlan#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#project GoogleGkeBackupRestorePlan#project}
  */
  readonly project?: string;
  /**
  * restore_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#restore_config GoogleGkeBackupRestorePlan#restore_config}
  */
  readonly restoreConfig: GoogleGkeBackupRestorePlanRestoreConfig;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#timeouts GoogleGkeBackupRestorePlan#timeouts}
  */
...
export interface GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKinds {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#resource_group GoogleGkeBackupRestorePlan#resource_group}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#resource_kind GoogleGkeBackupRestorePlan#resource_kind}
  */
  readonly resourceKind?: string;
}

export function googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindsToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKinds | cdktf.IResolvable): any {
...
export function googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindsToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKinds | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKinds | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKinds | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindsList extends cdktf.ComplexList {
  public internalValue? : GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKinds[] | cdktf.IResolvable
  ...
  */
  public get(index: number): GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindsOutputReference {
    return new GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindsToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKinds | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindsToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKinds | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKinds | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKinds | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._resourceGroup = undefined;
...
export class GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindsList extends cdktf.ComplexList {
  public internalValue? : GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKinds[] | cdktf.IResolvable
  ...
  */
  public get(index: number): GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindsOutputReference {
    return new GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScope {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#all_group_kinds GoogleGkeBackupRestorePlan#all_group_kinds}
  */
  ...
  * Mutually exclusive to any other field in 'clusterResourceRestoreScope'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#no_group_kinds GoogleGkeBackupRestorePlan#no_group_kinds}
  */
  readonly noGroupKinds?: boolean | cdktf.IResolvable;
  /**
  * excluded_group_kinds block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#excluded_group_kinds GoogleGkeBackupRestorePlan#excluded_group_kinds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#selected_group_kinds GoogleGkeBackupRestorePlan#selected_group_kinds}
  */
...
export function googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeOutputReference | GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScope): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    excluded_group_kinds: cdktf.listMapper(googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindsToTerraform, true)(struct!.excludedGroupKinds),
    selected_group_kinds: cdktf.listMapper(googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindsToTerraform, true)(struct!.selectedGroupKinds),
  }
}


export function googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeOutputReference | GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScope): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    excluded_group_kinds: {
      value: cdktf.listMapperHcl(googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindsToHclTerraform, true)(struct!.excludedGroupKinds),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindsList",
    },
    selected_group_kinds: {
      value: cdktf.listMapperHcl(googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindsToHclTerraform, true)(struct!.selectedGroupKinds),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindsList",
    },
  };
...
export class GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScope | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScope | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _excludedGroupKinds = new GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindsList(this, "excluded_group_kinds", false);
  public get excludedGroupKinds() {
    return this._excludedGroupKinds;
  }
  public putExcludedGroupKinds(value: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKinds[] | cdktf.IResolvable) {
  ...
  private _selectedGroupKinds = new GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindsList(this, "selected_group_kinds", false);
  public get selectedGroupKinds() {
    return this._selectedGroupKinds;
  }
  public putSelectedGroupKinds(value: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKinds[] | cdktf.IResolvable) {
...
export interface GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespaces {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#namespaces GoogleGkeBackupRestorePlan#namespaces}
  */
  readonly namespaces: string[];
}

export function googleGkeBackupRestorePlanRestoreConfigExcludedNamespacesToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespacesOutputReference | GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespaces): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleGkeBackupRestorePlanRestoreConfigExcludedNamespacesToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespacesOutputReference | GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespaces): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespacesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespaces | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespaces | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleGkeBackupRestorePlanRestoreConfigRestoreOrderGroupKindDependencies {
  ...
  * requiring block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#requiring GoogleGkeBackupRestorePlan#requiring}
  */
  readonly requiring: GoogleGkeBackupRestorePlanRestoreConfigRestoreOrderGroupKindDependenciesRequiring;
  /**
  * satisfying block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#satisfying GoogleGkeBackupRestorePlan#satisfying}
  */
...
export interface GoogleGkeBackupRestorePlanRestoreConfigRestoreOrder {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#group_kind_dependencies GoogleGkeBackupRestorePlan#group_kind_dependencies}
  */
...
export interface GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNames {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#namespace GoogleGkeBackupRestorePlan#namespace}
  */
  readonly namespace: string;
}

export function googleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNamesToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNames | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNamesToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNames | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNamesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNames | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNames | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNamesList extends cdktf.ComplexList {
  public internalValue? : GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNames[] | cdktf.IResolvable
  ...
  */
  public get(index: number): GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNamesOutputReference {
    return new GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNamesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleGkeBackupRestorePlanRestoreConfigSelectedApplications {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#namespaced_names GoogleGkeBackupRestorePlan#namespaced_names}
  */
  readonly namespacedNames: GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNames[] | cdktf.IResolvable;
}

export function googleGkeBackupRestorePlanRestoreConfigSelectedApplicationsToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsOutputReference | GoogleGkeBackupRestorePlanRestoreConfigSelectedApplications): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    namespaced_names: cdktf.listMapper(googleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNamesToTerraform, true)(struct!.namespacedNames),
  }
}


export function googleGkeBackupRestorePlanRestoreConfigSelectedApplicationsToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsOutputReference | GoogleGkeBackupRestorePlanRestoreConfigSelectedApplications): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    namespaced_names: {
      value: cdktf.listMapperHcl(googleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNamesToHclTerraform, true)(struct!.namespacedNames),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNamesList",
    },
  };
...
export class GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigSelectedApplications | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigSelectedApplications | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _namespacedNames = new GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNamesList(this, "namespaced_names", false);
  public get namespacedNames() {
    return this._namespacedNames;
  }
  public putNamespacedNames(value: GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsNamespacedNames[] | cdktf.IResolvable) {
...
export function googleGkeBackupRestorePlanRestoreConfigSelectedNamespacesToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespacesOutputReference | GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespaces): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleGkeBackupRestorePlanRestoreConfigSelectedNamespacesToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespacesOutputReference | GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespaces): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespacesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespaces | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._namespaces !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespaces | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._namespaces = undefined;
    }
...
export interface GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#from_path GoogleGkeBackupRestorePlan#from_path}
  */
  readonly fromPath?: string;
  /**
  * Specifies the operation to perform. Possible values: ["REMOVE", "MOVE", "COPY", "ADD", "TEST", "REPLACE"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#op GoogleGkeBackupRestorePlan#op}
  */
  readonly op: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#path GoogleGkeBackupRestorePlan#path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#value GoogleGkeBackupRestorePlan#value}
  */
  readonly value?: string;
}

export function googleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActionsToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActionsToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActionsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActions | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActions | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActionsList extends cdktf.ComplexList {
  public internalValue? : GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActions[] | cdktf.IResolvable
  ...
  */
  public get(index: number): GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActionsOutputReference {
    return new GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function googleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKindsToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKinds | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKindsToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKinds | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKindsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKinds | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKinds | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._resourceGroup = undefined;
...
export class GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKindsList extends cdktf.ComplexList {
  public internalValue? : GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKinds[] | cdktf.IResolvable
  ...
  */
  public get(index: number): GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKindsOutputReference {
    return new GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKindsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#json_path GoogleGkeBackupRestorePlan#json_path}
  */
  ...
  * group_kinds block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#group_kinds GoogleGkeBackupRestorePlan#group_kinds}
  */
  readonly groupKinds?: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKinds[] | cdktf.IResolvable;
}

export function googleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterOutputReference | GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilter): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    namespaces: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.namespaces),
    group_kinds: cdktf.listMapper(googleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKindsToTerraform, true)(struct!.groupKinds),
  }
}


export function googleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterOutputReference | GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilter): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    group_kinds: {
      value: cdktf.listMapperHcl(googleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKindsToHclTerraform, true)(struct!.groupKinds),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKindsList",
    },
  };
...
export class GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilter | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilter | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _groupKinds = new GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKindsList(this, "group_kinds", false);
  public get groupKinds() {
    return this._groupKinds;
  }
  public putGroupKinds(value: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterGroupKinds[] | cdktf.IResolvable) {
...
export interface GoogleGkeBackupRestorePlanRestoreConfigTransformationRules {
  ...
  * field_actions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#field_actions GoogleGkeBackupRestorePlan#field_actions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#resource_filter GoogleGkeBackupRestorePlan#resource_filter}
  */
  readonly resourceFilter?: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilter;
}

export function googleGkeBackupRestorePlanRestoreConfigTransformationRulesToTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigTransformationRules | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    field_actions: cdktf.listMapper(googleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActionsToTerraform, true)(struct!.fieldActions),
    resource_filter: googleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterToTerraform(struct!.resourceFilter),
  }
}


export function googleGkeBackupRestorePlanRestoreConfigTransformationRulesToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigTransformationRules | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    field_actions: {
      value: cdktf.listMapperHcl(googleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActionsToHclTerraform, true)(struct!.fieldActions),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActionsList",
    },
    resource_filter: {
      value: googleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterToHclTerraform(struct!.resourceFilter),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterList",
    },
  };
...
export class GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfigTransformationRules | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfigTransformationRules | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _fieldActions = new GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActionsList(this, "field_actions", false);
  public get fieldActions() {
    return this._fieldActions;
  }
  public putFieldActions(value: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesFieldActions[] | cdktf.IResolvable) {
  ...
  private _resourceFilter = new GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilterOutputReference(this, "resource_filter");
  public get resourceFilter() {
    return this._resourceFilter;
  }
  public putResourceFilter(value: GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesResourceFilter) {
...
export class GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesList extends cdktf.ComplexList {
  public internalValue? : GoogleGkeBackupRestorePlanRestoreConfigTransformationRules[] | cdktf.IResolvable
...
export interface GoogleGkeBackupRestorePlanRestoreConfigVolumeDataRestorePolicyBindings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#policy GoogleGkeBackupRestorePlan#policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#volume_type GoogleGkeBackupRestorePlan#volume_type}
  */
...
export interface GoogleGkeBackupRestorePlanRestoreConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#all_namespaces GoogleGkeBackupRestorePlan#all_namespaces}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#cluster_resource_conflict_policy GoogleGkeBackupRestorePlan#cluster_resource_conflict_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#namespaced_resource_restore_mode GoogleGkeBackupRestorePlan#namespaced_resource_restore_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#no_namespaces GoogleGkeBackupRestorePlan#no_namespaces}
  */
  ...
  * for more information on each policy option. Possible values: ["RESTORE_VOLUME_DATA_FROM_BACKUP", "REUSE_VOLUME_HANDLE_FROM_BACKUP", "NO_VOLUME_DATA_RESTORATION"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#volume_data_restore_policy GoogleGkeBackupRestorePlan#volume_data_restore_policy}
  */
  readonly volumeDataRestorePolicy?: string;
  /**
  * cluster_resource_restore_scope block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#cluster_resource_restore_scope GoogleGkeBackupRestorePlan#cluster_resource_restore_scope}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#excluded_namespaces GoogleGkeBackupRestorePlan#excluded_namespaces}
  */
  readonly excludedNamespaces?: GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespaces;
  /**
  * restore_order block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#restore_order GoogleGkeBackupRestorePlan#restore_order}
  */
  readonly restoreOrder?: GoogleGkeBackupRestorePlanRestoreConfigRestoreOrder;
  /**
  * selected_applications block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#selected_applications GoogleGkeBackupRestorePlan#selected_applications}
  */
  readonly selectedApplications?: GoogleGkeBackupRestorePlanRestoreConfigSelectedApplications;
  /**
  * selected_namespaces block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#selected_namespaces GoogleGkeBackupRestorePlan#selected_namespaces}
  */
  readonly selectedNamespaces?: GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespaces;
  /**
  * transformation_rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#transformation_rules GoogleGkeBackupRestorePlan#transformation_rules}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#volume_data_restore_policy_bindings GoogleGkeBackupRestorePlan#volume_data_restore_policy_bindings}
  */
...
export function googleGkeBackupRestorePlanRestoreConfigToHclTerraform(struct?: GoogleGkeBackupRestorePlanRestoreConfigOutputReference | GoogleGkeBackupRestorePlanRestoreConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    cluster_resource_restore_scope: {
      value: googleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeToHclTerraform(struct!.clusterResourceRestoreScope),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeList",
    },
    excluded_namespaces: {
      value: googleGkeBackupRestorePlanRestoreConfigExcludedNamespacesToHclTerraform(struct!.excludedNamespaces),
      isBlock: true,
      type: "list",
    ...
    selected_applications: {
      ...
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupRestorePlanRestoreConfigSelectedApplicationsList",
    },
    selected_namespaces: {
      value: googleGkeBackupRestorePlanRestoreConfigSelectedNamespacesToHclTerraform(struct!.selectedNamespaces),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespacesList",
    },
    transformation_rules: {
      value: cdktf.listMapperHcl(googleGkeBackupRestorePlanRestoreConfigTransformationRulesToHclTerraform, true)(struct!.transformationRules),
      isBlock: true,
      type: "list",
...
export class GoogleGkeBackupRestorePlanRestoreConfigOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanRestoreConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanRestoreConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _clusterResourceRestoreScope = new GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScopeOutputReference(this, "cluster_resource_restore_scope");
  public get clusterResourceRestoreScope() {
    return this._clusterResourceRestoreScope;
  }
  public putClusterResourceRestoreScope(value: GoogleGkeBackupRestorePlanRestoreConfigClusterResourceRestoreScope) {
  ...
  private _excludedNamespaces = new GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespacesOutputReference(this, "excluded_namespaces");
  public get excludedNamespaces() {
    return this._excludedNamespaces;
  }
  public putExcludedNamespaces(value: GoogleGkeBackupRestorePlanRestoreConfigExcludedNamespaces) {
  ...
  public putSelectedApplications(value: GoogleGkeBackupRestorePlanRestoreConfigSelectedApplications) {
  ...
  private _selectedNamespaces = new GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespacesOutputReference(this, "selected_namespaces");
  public get selectedNamespaces() {
    return this._selectedNamespaces;
  }
  public putSelectedNamespaces(value: GoogleGkeBackupRestorePlanRestoreConfigSelectedNamespaces) {
  ...
  private _transformationRules = new GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesList(this, "transformation_rules", false);
  public get transformationRules() {
    return this._transformationRules;
  }
  public putTransformationRules(value: GoogleGkeBackupRestorePlanRestoreConfigTransformationRules[] | cdktf.IResolvable) {
...
export interface GoogleGkeBackupRestorePlanTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#create GoogleGkeBackupRestorePlan#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#delete GoogleGkeBackupRestorePlan#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#update GoogleGkeBackupRestorePlan#update}
  */
  readonly update?: string;
}

export function googleGkeBackupRestorePlanTimeoutsToTerraform(struct?: GoogleGkeBackupRestorePlanTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleGkeBackupRestorePlanTimeoutsToHclTerraform(struct?: GoogleGkeBackupRestorePlanTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeBackupRestorePlanTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): GoogleGkeBackupRestorePlanTimeouts | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleGkeBackupRestorePlanTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan google_gke_backup_restore_plan}
*/
export class GoogleGkeBackupRestorePlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleGkeBackupRestorePlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.6.0/docs/resources/google_gke_backup_restore_plan google_gke_backup_restore_plan} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleGkeBackupRestorePlanConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleGkeBackupRestorePlanConfig) {
    super(scope, id, {
  ...
  private _restoreConfig = new GoogleGkeBackupRestorePlanRestoreConfigOutputReference(this, "restore_config");
  public get restoreConfig() {
    return this._restoreConfig;
  }
  public putRestoreConfig(value: GoogleGkeBackupRestorePlanRestoreConfig) {
  ...
  private _timeouts = new GoogleGkeBackupRestorePlanTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleGkeBackupRestorePlanTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      restore_config: googleGkeBackupRestorePlanRestoreConfigToTerraform(this._restoreConfig.internalValue),
      timeouts: googleGkeBackupRestorePlanTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      restore_config: {
        value: googleGkeBackupRestorePlanRestoreConfigToHclTerraform(this._restoreConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleGkeBackupRestorePlanRestoreConfigList",
      },
      timeouts: {
        value: googleGkeBackupRestorePlanTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleGkeBackupRestorePlanTimeouts",
      },
    };
