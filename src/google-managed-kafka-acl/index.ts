...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.40.0/docs/resources/google_managed_kafka_acl
...
export class GoogleManagedKafkaAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleManagedKafkaAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.40.0/docs/resources/google_managed_kafka_acl#import import section} in the documentation of this resource for the id to use
