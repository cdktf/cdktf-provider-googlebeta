...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_storage_anywhere_cache
...
export interface GoogleStorageAnywhereCacheConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleStorageAnywhereCacheTimeoutsToTerraform(struct?: GoogleStorageAnywhereCacheTimeouts | cdktf.IResolvable): any {
...
export function googleStorageAnywhereCacheTimeoutsToHclTerraform(struct?: GoogleStorageAnywhereCacheTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleStorageAnywhereCacheTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleStorageAnywhereCacheTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleStorageAnywhereCacheTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleStorageAnywhereCache extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleStorageAnywhereCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_storage_anywhere_cache#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_storage_anywhere_cache google_storage_anywhere_cache} Resource
  *
  * @param scope The scope in which to define this construct
