// https://www.terraform.io/docs/providers/google-beta/r/google_bigquery_connection_iam_policy
...
export interface GoogleBigqueryConnectionIamPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class GoogleBigqueryConnectionIamPolicy extends cdktf.TerraformResource {
  ...
  * @param options GoogleBigqueryConnectionIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleBigqueryConnectionIamPolicyConfig) {
    super(scope, id, {
