// https://www.terraform.io/docs/providers/google-beta/r/google_compute_per_instance_config
...
export function googleComputePerInstanceConfigPreservedStateToTerraform(struct?: GoogleComputePerInstanceConfigPreservedStateOutputReference | GoogleComputePerInstanceConfigPreservedState): any {
  ...
  return {
    ...
    disk: cdktf.listMapper(googleComputePerInstanceConfigPreservedStateDiskToTerraform)(struct!.disk),
  }
}
...
export class GoogleComputePerInstanceConfigPreservedStateOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _disk?: GoogleComputePerInstanceConfigPreservedStateDisk[] | cdktf.IResolvable; 
  public get disk() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('disk')));
  }
  public set disk(value: GoogleComputePerInstanceConfigPreservedStateDisk[] | cdktf.IResolvable) {
    this._disk = value;
  }
  public resetDisk() {
    this._disk = undefined;
...
export function googleComputePerInstanceConfigTimeoutsToTerraform(struct?: GoogleComputePerInstanceConfigTimeoutsOutputReference | GoogleComputePerInstanceConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputePerInstanceConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputePerInstanceConfigTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputePerInstanceConfigTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
