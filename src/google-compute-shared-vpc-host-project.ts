...
export class GoogleComputeSharedVpcHostProjectTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeSharedVpcHostProjectTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeSharedVpcHostProjectTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
