// https://registry.terraform.io/providers/hashicorp/google-beta/6.24.0/docs/resources/google_scc_v2_organization_source_iam_binding
...
export interface GoogleSccV2OrganizationSourceIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleSccV2OrganizationSourceIamBindingCondition;
}
export interface GoogleSccV2OrganizationSourceIamBindingCondition {
  /**
...
export function googleSccV2OrganizationSourceIamBindingConditionToTerraform(struct?: GoogleSccV2OrganizationSourceIamBindingConditionOutputReference | GoogleSccV2OrganizationSourceIamBindingCondition): any {
...
export function googleSccV2OrganizationSourceIamBindingConditionToHclTerraform(struct?: GoogleSccV2OrganizationSourceIamBindingConditionOutputReference | GoogleSccV2OrganizationSourceIamBindingCondition): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleSccV2OrganizationSourceIamBindingConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSccV2OrganizationSourceIamBindingCondition | undefined {
  ...
  public set internalValue(value: GoogleSccV2OrganizationSourceIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleSccV2OrganizationSourceIamBinding extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleSccV2OrganizationSourceIamBinding to import
  * @param importFromId The id of the existing GoogleSccV2OrganizationSourceIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.24.0/docs/resources/google_scc_v2_organization_source_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  * @param options GoogleSccV2OrganizationSourceIamBindingConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleSccV2OrganizationSourceIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleSccV2OrganizationSourceIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleSccV2OrganizationSourceIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleSccV2OrganizationSourceIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleSccV2OrganizationSourceIamBindingConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleSccV2OrganizationSourceIamBindingConditionList",
      },
    };
