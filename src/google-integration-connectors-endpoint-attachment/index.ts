// https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/resources/google_integration_connectors_endpoint_attachment
...
export interface GoogleIntegrationConnectorsEndpointAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: GoogleIntegrationConnectorsEndpointAttachmentTimeouts;
}
export interface GoogleIntegrationConnectorsEndpointAttachmentTimeouts {
  /**
...
export function googleIntegrationConnectorsEndpointAttachmentTimeoutsToTerraform(struct?: GoogleIntegrationConnectorsEndpointAttachmentTimeouts | cdktf.IResolvable): any {
...
export function googleIntegrationConnectorsEndpointAttachmentTimeoutsToHclTerraform(struct?: GoogleIntegrationConnectorsEndpointAttachmentTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleIntegrationConnectorsEndpointAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIntegrationConnectorsEndpointAttachmentTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleIntegrationConnectorsEndpointAttachmentTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleIntegrationConnectorsEndpointAttachment extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleIntegrationConnectorsEndpointAttachment to import
  * @param importFromId The id of the existing GoogleIntegrationConnectorsEndpointAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/resources/google_integration_connectors_endpoint_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/resources/google_integration_connectors_endpoint_attachment google_integration_connectors_endpoint_attachment} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleIntegrationConnectorsEndpointAttachmentConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleIntegrationConnectorsEndpointAttachmentConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleIntegrationConnectorsEndpointAttachmentTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleIntegrationConnectorsEndpointAttachmentTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleIntegrationConnectorsEndpointAttachmentTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleIntegrationConnectorsEndpointAttachmentTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleIntegrationConnectorsEndpointAttachmentTimeouts",
      },
    };
