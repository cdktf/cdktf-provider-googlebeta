...
export class GooglePubsubLiteReservationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GooglePubsubLiteReservationTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GooglePubsubLiteReservationTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
