// https://registry.terraform.io/providers/hashicorp/google-beta/6.12.0/docs/resources/google_bigtable_table
...
export interface GoogleBigtableTableConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly automatedBackupPolicy?: GoogleBigtableTableAutomatedBackupPolicy;
  /**
  * column_family block
  *
...
export interface GoogleBigtableTableAutomatedBackupPolicy {
  /**
...
export class GoogleBigtableTableAutomatedBackupPolicyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigtableTableAutomatedBackupPolicy | undefined {
  ...
  public set internalValue(value: GoogleBigtableTableAutomatedBackupPolicy | undefined) {
    if (value === undefined) {
...
export class GoogleBigtableTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleBigtableTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.12.0/docs/resources/google_bigtable_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.12.0/docs/resources/google_bigtable_table google_bigtable_table} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _automatedBackupPolicy = new GoogleBigtableTableAutomatedBackupPolicyOutputReference(this, "automated_backup_policy");
  public get automatedBackupPolicy() {
    return this._automatedBackupPolicy;
  }
  public putAutomatedBackupPolicy(value: GoogleBigtableTableAutomatedBackupPolicy) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      automated_backup_policy: {
        value: googleBigtableTableAutomatedBackupPolicyToHclTerraform(this._automatedBackupPolicy.internalValue),
        isBlock: true,
        type: "set",
      ...
      timeouts: {
        value: googleBigtableTableTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleBigtableTableTimeouts",
      },
    };
