// https://registry.terraform.io/providers/hashicorp/google-beta/5.7.0/docs/data-sources/google_firebase_web_app
...
export class DataGoogleFirebaseWebApp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleFirebaseWebApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.7.0/docs/data-sources/google_firebase_web_app#import import section} in the documentation of this resource for the id to use
