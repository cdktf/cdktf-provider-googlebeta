// https://www.terraform.io/docs/providers/google-beta/r/google_active_directory_domain
...
Ranges must be unique and non-overlapping with existing subnets in authorizedNetworks
  ...
  */
  readonly timeouts?: GoogleActiveDirectoryDomainTimeouts;
}
export interface GoogleActiveDirectoryDomainTimeouts {
  /**
...
export function googleActiveDirectoryDomainTimeoutsToTerraform(struct?: GoogleActiveDirectoryDomainTimeoutsOutputReference | GoogleActiveDirectoryDomainTimeouts | cdktf.IResolvable): any {
...
export class GoogleActiveDirectoryDomainTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleActiveDirectoryDomainTimeouts | undefined {
  ...
  public set internalValue(value: GoogleActiveDirectoryDomainTimeouts | undefined) {
    if (value === undefined) {
...
export class GoogleActiveDirectoryDomain extends cdktf.TerraformResource {
  ...
  * @param options GoogleActiveDirectoryDomainConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleActiveDirectoryDomainConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleActiveDirectoryDomainTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleActiveDirectoryDomainTimeouts) {
