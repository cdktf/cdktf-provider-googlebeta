...
export class GoogleLoggingProjectSinkExclusionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleLoggingProjectSinkExclusionsOutputReference {
    return new GoogleLoggingProjectSinkExclusionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleLoggingProjectSink extends cdktf.TerraformResource {
  ...
  */
  ...
  private _exclusions = new GoogleLoggingProjectSinkExclusionsList(this, "exclusions", false);
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      exclusions: cdktf.listMapper(googleLoggingProjectSinkExclusionsToTerraform)(this._exclusions.internalValue),
    };
  }
}
