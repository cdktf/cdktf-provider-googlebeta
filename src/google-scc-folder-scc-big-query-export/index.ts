// https://registry.terraform.io/providers/hashicorp/google-beta/6.23.0/docs/resources/google_scc_folder_scc_big_query_export
...
export interface GoogleSccFolderSccBigQueryExportConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: GoogleSccFolderSccBigQueryExportTimeouts;
}
export interface GoogleSccFolderSccBigQueryExportTimeouts {
  /**
...
export function googleSccFolderSccBigQueryExportTimeoutsToTerraform(struct?: GoogleSccFolderSccBigQueryExportTimeouts | cdktf.IResolvable): any {
...
export function googleSccFolderSccBigQueryExportTimeoutsToHclTerraform(struct?: GoogleSccFolderSccBigQueryExportTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleSccFolderSccBigQueryExportTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSccFolderSccBigQueryExportTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleSccFolderSccBigQueryExportTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleSccFolderSccBigQueryExport extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_scc_folder_scc_big_query_export";
  ...
  * @param importToId The construct id used in the generated config for the GoogleSccFolderSccBigQueryExport to import
  * @param importFromId The id of the existing GoogleSccFolderSccBigQueryExport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.23.0/docs/resources/google_scc_folder_scc_big_query_export#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_scc_folder_scc_big_query_export", importId: importFromId, provider });
      }
  ...
  * @param options GoogleSccFolderSccBigQueryExportConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleSccFolderSccBigQueryExportConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleSccFolderSccBigQueryExportTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleSccFolderSccBigQueryExportTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleSccFolderSccBigQueryExportTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleSccFolderSccBigQueryExportTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleSccFolderSccBigQueryExportTimeouts",
      },
    };
