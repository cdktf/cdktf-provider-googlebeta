// https://registry.terraform.io/providers/hashicorp/google-beta/5.33.0/docs/data-sources/google_folder_organization_policy
...
export class DataGoogleFolderOrganizationPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleFolderOrganizationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.33.0/docs/data-sources/google_folder_organization_policy#import import section} in the documentation of this resource for the id to use
