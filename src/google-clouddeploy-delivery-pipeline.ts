...
export function googleClouddeployDeliveryPipelineSerialPipelineToTerraform(struct?: GoogleClouddeployDeliveryPipelineSerialPipelineOutputReference | GoogleClouddeployDeliveryPipelineSerialPipeline): any {
  ...
  return {
    stages: cdktf.listMapper(googleClouddeployDeliveryPipelineSerialPipelineStagesToTerraform)(struct!.stages),
  }
}
...
export class GoogleClouddeployDeliveryPipelineSerialPipelineOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _stages?: GoogleClouddeployDeliveryPipelineSerialPipelineStages[] | cdktf.IResolvable; 
  public get stages() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('stages');
  }
  public set stages(value: GoogleClouddeployDeliveryPipelineSerialPipelineStages[] | cdktf.IResolvable) {
    this._stages = value;
  }
  public resetStages() {
    this._stages = undefined;
...
export class GoogleClouddeployDeliveryPipelineTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleClouddeployDeliveryPipelineTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleClouddeployDeliveryPipelineTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
