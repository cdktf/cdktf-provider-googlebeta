...
export class GoogleBillingBudgetTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBillingBudgetTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleBillingBudgetTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleBillingBudget extends cdktf.TerraformResource {
  ...
  */
  ...
  private _thresholdRules?: GoogleBillingBudgetThresholdRules[] | cdktf.IResolvable; 
  public get thresholdRules() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('threshold_rules');
  }
  public set thresholdRules(value: GoogleBillingBudgetThresholdRules[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      threshold_rules: cdktf.listMapper(googleBillingBudgetThresholdRulesToTerraform)(this._thresholdRules),
