...
export class GoogleComputeAutoscalerAutoscalingPolicyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _metric?: GoogleComputeAutoscalerAutoscalingPolicyMetric[] | cdktf.IResolvable; 
  public get metric() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('metric');
  }
  public set metric(value: GoogleComputeAutoscalerAutoscalingPolicyMetric[] | cdktf.IResolvable) {
    this._metric = value;
  }
  public resetMetric() {
    this._metric = undefined;
  ...
  private _scalingSchedules?: GoogleComputeAutoscalerAutoscalingPolicyScalingSchedules[] | cdktf.IResolvable; 
  public get scalingSchedules() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('scaling_schedules')));
  }
  public set scalingSchedules(value: GoogleComputeAutoscalerAutoscalingPolicyScalingSchedules[] | cdktf.IResolvable) {
...
export class GoogleComputeAutoscalerTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeAutoscalerTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputeAutoscalerTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
