...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.49.0/docs/resources/google_bigquery_data_transfer_config
...
export interface GoogleBigqueryDataTransferConfigSensitiveParams {
  ...
  */
  readonly secretAccessKeyWoVersion?: string;
}
...
export function googleBigqueryDataTransferConfigSensitiveParamsToTerraform(struct?: GoogleBigqueryDataTransferConfigSensitiveParamsOutputReference | GoogleBigqueryDataTransferConfigSensitiveParams): any {
  ...
  return {
    ...
    secret_access_key_wo_version: cdktf.stringToTerraform(struct!.secretAccessKeyWoVersion),
  }
}
...
export function googleBigqueryDataTransferConfigSensitiveParamsToHclTerraform(struct?: GoogleBigqueryDataTransferConfigSensitiveParamsOutputReference | GoogleBigqueryDataTransferConfigSensitiveParams): any {
  ...
  const attrs = {
    ...
    secret_access_key_wo_version: {
      value: cdktf.stringToHclTerraform(struct!.secretAccessKeyWoVersion),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class GoogleBigqueryDataTransferConfigSensitiveParamsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _secretAccessKeyWoVersion?: string; 
  public get secretAccessKeyWoVersion() {
    return this.getStringAttribute('secret_access_key_wo_version');
  }
  public set secretAccessKeyWoVersion(value: string) {
...
export class GoogleBigqueryDataTransferConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleBigqueryDataTransferConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.0/docs/resources/google_bigquery_data_transfer_config#import import section} in the documentation of this resource for the id to use
