...
export class GoogleGkeHubFeatureMembershipTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGkeHubFeatureMembershipTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleGkeHubFeatureMembershipTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
