// https://www.terraform.io/docs/providers/google-beta/r/google_pubsub_subscription
...
export function googlePubsubSubscriptionTimeoutsToTerraform(struct?: GooglePubsubSubscriptionTimeoutsOutputReference | GooglePubsubSubscriptionTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GooglePubsubSubscriptionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GooglePubsubSubscriptionTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GooglePubsubSubscriptionTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
