...
export class GoogleMonitoringNotificationChannelTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleMonitoringNotificationChannelTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleMonitoringNotificationChannelTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
