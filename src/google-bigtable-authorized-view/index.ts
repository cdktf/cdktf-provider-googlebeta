...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.42.0/docs/resources/google_bigtable_authorized_view
...
export class GoogleBigtableAuthorizedView extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleBigtableAuthorizedView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.42.0/docs/resources/google_bigtable_authorized_view#import import section} in the documentation of this resource for the id to use
