...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.49.3/docs/resources/google_dataplex_glossary_term
...
export class GoogleDataplexGlossaryTerm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDataplexGlossaryTerm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.3/docs/resources/google_dataplex_glossary_term#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.3/docs/resources/google_dataplex_glossary_term google_dataplex_glossary_term} Resource
  *
  * @param scope The scope in which to define this construct
