// https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_integrations_client
...
export interface GoogleIntegrationsClientConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface GoogleIntegrationsClientCloudKmsConfig {
  /**
...
export function googleIntegrationsClientCloudKmsConfigToTerraform(struct?: GoogleIntegrationsClientCloudKmsConfigOutputReference | GoogleIntegrationsClientCloudKmsConfig): any {
...
export function googleIntegrationsClientCloudKmsConfigToHclTerraform(struct?: GoogleIntegrationsClientCloudKmsConfigOutputReference | GoogleIntegrationsClientCloudKmsConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleIntegrationsClientCloudKmsConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIntegrationsClientCloudKmsConfig | undefined {
  ...
  public set internalValue(value: GoogleIntegrationsClientCloudKmsConfig | undefined) {
    if (value === undefined) {
...
export function googleIntegrationsClientTimeoutsToTerraform(struct?: GoogleIntegrationsClientTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleIntegrationsClientTimeoutsToHclTerraform(struct?: GoogleIntegrationsClientTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleIntegrationsClientTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleIntegrationsClientTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleIntegrationsClientTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleIntegrationsClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleIntegrationsClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_integrations_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.34.0/docs/resources/google_integrations_client google_integrations_client} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleIntegrationsClientConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleIntegrationsClientConfig) {
    super(scope, id, {
  ...
  public putCloudKmsConfig(value: GoogleIntegrationsClientCloudKmsConfig) {
  ...
  private _timeouts = new GoogleIntegrationsClientTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleIntegrationsClientTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      cloud_kms_config: {
        value: googleIntegrationsClientCloudKmsConfigToHclTerraform(this._cloudKmsConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleIntegrationsClientCloudKmsConfigList",
      },
      timeouts: {
        value: googleIntegrationsClientTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleIntegrationsClientTimeouts",
      },
    };
