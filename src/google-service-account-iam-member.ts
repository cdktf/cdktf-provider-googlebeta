// https://www.terraform.io/docs/providers/google-beta/r/google_service_account_iam_member
...
export function googleServiceAccountIamMemberConditionToTerraform(struct?: GoogleServiceAccountIamMemberConditionOutputReference | GoogleServiceAccountIamMemberCondition): any {
...
export class GoogleServiceAccountIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleServiceAccountIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleServiceAccountIamMemberCondition | undefined) {
    if (value === undefined) {
...
export class GoogleServiceAccountIamMember extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleServiceAccountIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleServiceAccountIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleServiceAccountIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleServiceAccountIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
