...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.17.0/docs/resources/google_api_gateway_api_config
...
export class GoogleApiGatewayApiConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleApiGatewayApiConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.17.0/docs/resources/google_api_gateway_api_config#import import section} in the documentation of this resource for the id to use
