...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.20.0/docs/resources/google_kms_key_handle
...
export function googleKmsKeyHandleTimeoutsToTerraform(struct?: GoogleKmsKeyHandleTimeouts | cdktf.IResolvable): any {
...
export function googleKmsKeyHandleTimeoutsToHclTerraform(struct?: GoogleKmsKeyHandleTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleKmsKeyHandleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleKmsKeyHandleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleKmsKeyHandleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleKmsKeyHandle extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleKmsKeyHandle that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.20.0/docs/resources/google_kms_key_handle#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.20.0/docs/resources/google_kms_key_handle google_kms_key_handle} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleKmsKeyHandleConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleKmsKeyHandleConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleKmsKeyHandleTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleKmsKeyHandleTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleKmsKeyHandleTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleKmsKeyHandleTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleKmsKeyHandleTimeouts",
      },
    };
