// https://www.terraform.io/docs/providers/google-beta/r/google_healthcare_consent_store
...
export interface GoogleHealthcareConsentStoreConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleHealthcareConsentStoreTimeoutsToTerraform(struct?: GoogleHealthcareConsentStoreTimeoutsOutputReference | GoogleHealthcareConsentStoreTimeouts | cdktf.IResolvable): any {
...
*/
export class GoogleHealthcareConsentStore extends cdktf.TerraformResource {
