...
export class GoogleEventarcTriggerMatchingCriteriaList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleEventarcTriggerMatchingCriteriaOutputReference {
    return new GoogleEventarcTriggerMatchingCriteriaOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleEventarcTrigger extends cdktf.TerraformResource {
  ...
  */
  ...
  private _matchingCriteria = new GoogleEventarcTriggerMatchingCriteriaList(this, "matching_criteria", true);
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      matching_criteria: cdktf.listMapper(googleEventarcTriggerMatchingCriteriaToTerraform)(this._matchingCriteria.internalValue),
