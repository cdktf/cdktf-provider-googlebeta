...
export class GoogleAppEngineStandardAppVersionDeploymentOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _files?: GoogleAppEngineStandardAppVersionDeploymentFiles[] | cdktf.IResolvable; 
  public get files() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('files')));
  }
  public set files(value: GoogleAppEngineStandardAppVersionDeploymentFiles[] | cdktf.IResolvable) {
    this._files = value;
  }
  public resetFiles() {
    this._files = undefined;
...
export class GoogleAppEngineStandardAppVersionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleAppEngineStandardAppVersionTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleAppEngineStandardAppVersionTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleAppEngineStandardAppVersion extends cdktf.TerraformResource {
  ...
  */
  ...
  private _handlers?: GoogleAppEngineStandardAppVersionHandlers[] | cdktf.IResolvable; 
  public get handlers() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('handlers');
  }
  public set handlers(value: GoogleAppEngineStandardAppVersionHandlers[] | cdktf.IResolvable) {
  ...
  private _libraries?: GoogleAppEngineStandardAppVersionLibraries[] | cdktf.IResolvable; 
  public get libraries() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('libraries');
  }
  public set libraries(value: GoogleAppEngineStandardAppVersionLibraries[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      handlers: cdktf.listMapper(googleAppEngineStandardAppVersionHandlersToTerraform)(this._handlers),
      libraries: cdktf.listMapper(googleAppEngineStandardAppVersionLibrariesToTerraform)(this._libraries),
