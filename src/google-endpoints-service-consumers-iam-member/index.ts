// https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_endpoints_service_consumers_iam_member
...
export class GoogleEndpointsServiceConsumersIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleEndpointsServiceConsumersIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_endpoints_service_consumers_iam_member#import import section} in the documentation of this resource for the id to use
