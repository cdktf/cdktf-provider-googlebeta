...
export interface GoogleTagsTagBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_tags_tag_binding#id GoogleTagsTagBinding#id}
  *
...
export class GoogleTagsTagBindingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleTagsTagBindingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleTagsTagBindingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
