// https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_alloydb_instance
...
export class GoogleAlloydbInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleAlloydbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_alloydb_instance#import import section} in the documentation of this resource for the id to use
