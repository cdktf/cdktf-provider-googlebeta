...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/data-sources/google_bigquery_dataset
...
export class DataGoogleBigqueryDataset extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBigqueryDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.5.0/docs/data-sources/google_bigquery_dataset#import import section} in the documentation of this resource for the id to use
