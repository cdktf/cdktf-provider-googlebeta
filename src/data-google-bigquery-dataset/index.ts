...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.36.1/docs/data-sources/google_bigquery_dataset
...
export class DataGoogleBigqueryDataset extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBigqueryDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.36.1/docs/data-sources/google_bigquery_dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.36.1/docs/data-sources/google_bigquery_dataset google_bigquery_dataset} Data Source
  *
  * @param scope The scope in which to define this construct
