// https://www.terraform.io/docs/providers/google-beta/r/google_iap_web_type_app_engine_iam_member
...
export interface GoogleIapWebTypeAppEngineIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleIapWebTypeAppEngineIamMemberCondition;
}
export interface GoogleIapWebTypeAppEngineIamMemberCondition {
  /**
...
export function googleIapWebTypeAppEngineIamMemberConditionToTerraform(struct?: GoogleIapWebTypeAppEngineIamMemberConditionOutputReference | GoogleIapWebTypeAppEngineIamMemberCondition): any {
...
export class GoogleIapWebTypeAppEngineIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIapWebTypeAppEngineIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleIapWebTypeAppEngineIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleIapWebTypeAppEngineIamMember extends cdktf.TerraformResource {
  ...
  * @param options GoogleIapWebTypeAppEngineIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleIapWebTypeAppEngineIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleIapWebTypeAppEngineIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleIapWebTypeAppEngineIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleIapWebTypeAppEngineIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
