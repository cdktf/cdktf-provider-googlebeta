...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.18.0/docs/resources/google_cloud_asset_organization_feed
...
export class GoogleCloudAssetOrganizationFeed extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleCloudAssetOrganizationFeed that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.18.0/docs/resources/google_cloud_asset_organization_feed#import import section} in the documentation of this resource for the id to use
