...
export class GoogleIdentityPlatformOauthIdpConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIdentityPlatformOauthIdpConfigTimeouts | undefined {
  ...
  public set internalValue(value: GoogleIdentityPlatformOauthIdpConfigTimeouts | undefined) {
    if (value === undefined) {
