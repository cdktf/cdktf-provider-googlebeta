// https://www.terraform.io/docs/providers/google-beta/r/google_pubsub_topic
...
export function googlePubsubTopicTimeoutsToTerraform(struct?: GooglePubsubTopicTimeoutsOutputReference | GooglePubsubTopicTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GooglePubsubTopicTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GooglePubsubTopicTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GooglePubsubTopicTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
