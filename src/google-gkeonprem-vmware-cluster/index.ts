// https://registry.terraform.io/providers/hashicorp/google-beta/4.68.0/docs/resources/google_gkeonprem_vmware_cluster
...
export function googleGkeonpremVmwareClusterVcenterToTerraform(struct?: GoogleGkeonpremVmwareClusterVcenter): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeonpremVmwareClusterVcenterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // ca_cert_data - computed: true, optional: false, required: false
...
export class GoogleGkeonpremVmwareClusterVcenterList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleGkeonpremVmwareClusterVcenterOutputReference {
    return new GoogleGkeonpremVmwareClusterVcenterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleGkeonpremVmwareClusterNetworkConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // vcenter_network - computed: true, optional: false, required: false
...
export class GoogleGkeonpremVmwareCluster extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.68.0/docs/resources/google_gkeonprem_vmware_cluster google_gkeonprem_vmware_cluster} Resource
  *
  ...
  */
  ...
  private _vcenter = new GoogleGkeonpremVmwareClusterVcenterList(this, "vcenter", false);
  public get vcenter() {
