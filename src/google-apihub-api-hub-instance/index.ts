// https://registry.terraform.io/providers/hashicorp/google-beta/6.18.0/docs/resources/google_apihub_api_hub_instance
...
export interface GoogleApihubApiHubInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly config: GoogleApihubApiHubInstanceConfigA;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: GoogleApihubApiHubInstanceTimeouts;
}
export interface GoogleApihubApiHubInstanceConfigA {
  /**
...
export class GoogleApihubApiHubInstanceConfigAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleApihubApiHubInstanceConfigA | undefined {
  ...
  public set internalValue(value: GoogleApihubApiHubInstanceConfigA | undefined) {
    if (value === undefined) {
...
export interface GoogleApihubApiHubInstanceTimeouts {
  /**
...
export class GoogleApihubApiHubInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleApihubApiHubInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.18.0/docs/resources/google_apihub_api_hub_instance#import import section} in the documentation of this resource for the id to use
  ...
  * @param options GoogleApihubApiHubInstanceConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleApihubApiHubInstanceConfig) {
    super(scope, id, {
  ...
  private _config = new GoogleApihubApiHubInstanceConfigAOutputReference(this, "config");
  public get config() {
    return this._config;
  }
  public putConfig(value: GoogleApihubApiHubInstanceConfigA) {
  ...
  private _timeouts = new GoogleApihubApiHubInstanceTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleApihubApiHubInstanceTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      config: {
        value: googleApihubApiHubInstanceConfigAToHclTerraform(this._config.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleApihubApiHubInstanceConfigAList",
      },
      timeouts: {
        value: googleApihubApiHubInstanceTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleApihubApiHubInstanceTimeouts",
      },
    };
