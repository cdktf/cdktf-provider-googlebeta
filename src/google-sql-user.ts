// https://www.terraform.io/docs/providers/google-beta/r/google_sql_user
...
export function googleSqlUserTimeoutsToTerraform(struct?: GoogleSqlUserTimeoutsOutputReference | GoogleSqlUserTimeouts | cdktf.IResolvable): any {
...
export class GoogleSqlUserTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSqlUserTimeouts | undefined {
  ...
  public set internalValue(value: GoogleSqlUserTimeouts | undefined) {
    if (value === undefined) {
...
export class GoogleSqlUser extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleSqlUserConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleSqlUserTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleSqlUserTimeouts) {
