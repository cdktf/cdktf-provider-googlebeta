...
export class GoogleComputeNetworkEndpointGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeNetworkEndpointGroupTimeouts | undefined {
  ...
  public set internalValue(value: GoogleComputeNetworkEndpointGroupTimeouts | undefined) {
    if (value === undefined) {
