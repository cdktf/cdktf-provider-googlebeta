// https://www.terraform.io/docs/providers/google-beta/r/google_secret_manager_secret_iam_member
...
export function googleSecretManagerSecretIamMemberConditionToTerraform(struct?: GoogleSecretManagerSecretIamMemberConditionOutputReference | GoogleSecretManagerSecretIamMemberCondition): any {
...
export class GoogleSecretManagerSecretIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSecretManagerSecretIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleSecretManagerSecretIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleSecretManagerSecretIamMember extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_secret_manager_secret_iam_member";
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleSecretManagerSecretIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleSecretManagerSecretIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleSecretManagerSecretIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleSecretManagerSecretIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
