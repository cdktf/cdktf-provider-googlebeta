// https://www.terraform.io/docs/providers/google-beta/r/google_data_catalog_entry_group_iam_member
...
export function googleDataCatalogEntryGroupIamMemberConditionToTerraform(struct?: GoogleDataCatalogEntryGroupIamMemberConditionOutputReference | GoogleDataCatalogEntryGroupIamMemberCondition): any {
...
export class GoogleDataCatalogEntryGroupIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataCatalogEntryGroupIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleDataCatalogEntryGroupIamMemberCondition | undefined) {
    if (value === undefined) {
...
export class GoogleDataCatalogEntryGroupIamMember extends cdktf.TerraformResource {
  ...
  * @param options GoogleDataCatalogEntryGroupIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleDataCatalogEntryGroupIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleDataCatalogEntryGroupIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleDataCatalogEntryGroupIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleDataCatalogEntryGroupIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
