// https://www.terraform.io/docs/providers/google-beta/r/google_runtimeconfig_config_iam_binding
...
export function googleRuntimeconfigConfigIamBindingConditionToTerraform(struct?: GoogleRuntimeconfigConfigIamBindingConditionOutputReference | GoogleRuntimeconfigConfigIamBindingCondition): any {
...
export class GoogleRuntimeconfigConfigIamBindingConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleRuntimeconfigConfigIamBindingCondition | undefined {
  ...
  public set internalValue(value: GoogleRuntimeconfigConfigIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleRuntimeconfigConfigIamBinding extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleRuntimeconfigConfigIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleRuntimeconfigConfigIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleRuntimeconfigConfigIamBindingCondition) {
