// https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/data-sources/google_kms_crypto_key_latest_version
...
export class DataGoogleKmsCryptoKeyLatestVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleKmsCryptoKeyLatestVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.17.0/docs/data-sources/google_kms_crypto_key_latest_version#import import section} in the documentation of this resource for the id to use
