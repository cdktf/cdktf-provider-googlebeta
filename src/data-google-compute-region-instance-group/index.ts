...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.9.0/docs/data-sources/google_compute_region_instance_group
...
export class DataGoogleComputeRegionInstanceGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeRegionInstanceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.9.0/docs/data-sources/google_compute_region_instance_group#import import section} in the documentation of this resource for the id to use
