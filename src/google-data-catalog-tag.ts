...
export class GoogleDataCatalogTagTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataCatalogTagTimeouts | undefined {
  ...
  public set internalValue(value: GoogleDataCatalogTagTimeouts | undefined) {
    if (value === undefined) {
...
export class GoogleDataCatalogTag extends cdktf.TerraformResource {
  ...
  */
  ...
  private _fields?: GoogleDataCatalogTagFields[] | cdktf.IResolvable; 
  public get fields() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('fields')));
  }
  public set fields(value: GoogleDataCatalogTagFields[] | cdktf.IResolvable) {
    this._fields = value;
  }
  // Temporarily expose input value. Use with caution.
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      fields: cdktf.listMapper(googleDataCatalogTagFieldsToTerraform)(this._fields),
