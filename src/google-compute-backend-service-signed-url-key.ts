// https://www.terraform.io/docs/providers/google-beta/r/google_compute_backend_service_signed_url_key
...
export interface GoogleComputeBackendServiceSignedUrlKeyConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleComputeBackendServiceSignedUrlKeyTimeoutsToTerraform(struct?: GoogleComputeBackendServiceSignedUrlKeyTimeoutsOutputReference | GoogleComputeBackendServiceSignedUrlKeyTimeouts | cdktf.IResolvable): any {
...
export class GoogleComputeBackendServiceSignedUrlKeyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeBackendServiceSignedUrlKeyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeBackendServiceSignedUrlKeyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleComputeBackendServiceSignedUrlKey extends cdktf.TerraformResource {
  ...
  * @param options GoogleComputeBackendServiceSignedUrlKeyConfig
  */
  ...
  private _timeouts = new GoogleComputeBackendServiceSignedUrlKeyTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleComputeBackendServiceSignedUrlKeyTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleComputeBackendServiceSignedUrlKeyTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
