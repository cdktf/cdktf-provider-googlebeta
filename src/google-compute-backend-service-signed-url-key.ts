...
export class GoogleComputeBackendServiceSignedUrlKeyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeBackendServiceSignedUrlKeyTimeouts | undefined {
  ...
  public set internalValue(value: GoogleComputeBackendServiceSignedUrlKeyTimeouts | undefined) {
    if (value === undefined) {
