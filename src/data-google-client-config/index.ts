// https://registry.terraform.io/providers/hashicorp/google-beta/6.8.0/docs/data-sources/google_client_config
...
export class DataGoogleClientConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleClientConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.8.0/docs/data-sources/google_client_config#import import section} in the documentation of this resource for the id to use
