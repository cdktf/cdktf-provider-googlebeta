// https://registry.terraform.io/providers/hashicorp/google-beta/6.23.0/docs/resources/google_logging_project_bucket_config
...
export interface GoogleLoggingProjectBucketConfigConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleLoggingProjectBucketConfigCmekSettingsToTerraform(struct?: GoogleLoggingProjectBucketConfigCmekSettingsOutputReference | GoogleLoggingProjectBucketConfigCmekSettings): any {
...
export function googleLoggingProjectBucketConfigCmekSettingsToHclTerraform(struct?: GoogleLoggingProjectBucketConfigCmekSettingsOutputReference | GoogleLoggingProjectBucketConfigCmekSettings): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleLoggingProjectBucketConfigCmekSettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleLoggingProjectBucketConfigCmekSettings | undefined {
  ...
  public set internalValue(value: GoogleLoggingProjectBucketConfigCmekSettings | undefined) {
    if (value === undefined) {
...
export function googleLoggingProjectBucketConfigIndexConfigsToHclTerraform(struct?: GoogleLoggingProjectBucketConfigIndexConfigs | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleLoggingProjectBucketConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleLoggingProjectBucketConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.23.0/docs/resources/google_logging_project_bucket_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.23.0/docs/resources/google_logging_project_bucket_config google_logging_project_bucket_config} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleLoggingProjectBucketConfigConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleLoggingProjectBucketConfigConfig) {
    super(scope, id, {
  ...
  private _cmekSettings = new GoogleLoggingProjectBucketConfigCmekSettingsOutputReference(this, "cmek_settings");
  public get cmekSettings() {
    return this._cmekSettings;
  }
  public putCmekSettings(value: GoogleLoggingProjectBucketConfigCmekSettings) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      cmek_settings: {
        value: googleLoggingProjectBucketConfigCmekSettingsToHclTerraform(this._cmekSettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleLoggingProjectBucketConfigCmekSettingsList",
      },
      index_configs: {
        value: cdktf.listMapperHcl(googleLoggingProjectBucketConfigIndexConfigsToHclTerraform, true)(this._indexConfigs.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "GoogleLoggingProjectBucketConfigIndexConfigsList",
      },
    };
