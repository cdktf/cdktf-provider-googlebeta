...
export class GoogleCloudAssetOrganizationFeedTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudAssetOrganizationFeedTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudAssetOrganizationFeedTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
