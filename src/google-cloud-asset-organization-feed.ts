// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_asset_organization_feed
...
export function googleCloudAssetOrganizationFeedConditionToTerraform(struct?: GoogleCloudAssetOrganizationFeedConditionOutputReference | GoogleCloudAssetOrganizationFeedCondition): any {
...
export class GoogleCloudAssetOrganizationFeedConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudAssetOrganizationFeedCondition | undefined {
  ...
  public set internalValue(value: GoogleCloudAssetOrganizationFeedCondition | undefined) {
    if (value === undefined) {
...
export function googleCloudAssetOrganizationFeedFeedOutputConfigPubsubDestinationToTerraform(struct?: GoogleCloudAssetOrganizationFeedFeedOutputConfigPubsubDestinationOutputReference | GoogleCloudAssetOrganizationFeedFeedOutputConfigPubsubDestination): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCloudAssetOrganizationFeedFeedOutputConfigPubsubDestinationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudAssetOrganizationFeedFeedOutputConfigPubsubDestination | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudAssetOrganizationFeedFeedOutputConfigPubsubDestination | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function googleCloudAssetOrganizationFeedFeedOutputConfigToTerraform(struct?: GoogleCloudAssetOrganizationFeedFeedOutputConfigOutputReference | GoogleCloudAssetOrganizationFeedFeedOutputConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCloudAssetOrganizationFeedFeedOutputConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudAssetOrganizationFeedFeedOutputConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudAssetOrganizationFeedFeedOutputConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _pubsubDestination = new GoogleCloudAssetOrganizationFeedFeedOutputConfigPubsubDestinationOutputReference(this, "pubsub_destination");
  public get pubsubDestination() {
    return this._pubsubDestination;
  }
  public putPubsubDestination(value: GoogleCloudAssetOrganizationFeedFeedOutputConfigPubsubDestination) {
...
export function googleCloudAssetOrganizationFeedTimeoutsToTerraform(struct?: GoogleCloudAssetOrganizationFeedTimeoutsOutputReference | GoogleCloudAssetOrganizationFeedTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCloudAssetOrganizationFeedTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudAssetOrganizationFeedTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleCloudAssetOrganizationFeedTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleCloudAssetOrganizationFeed extends cdktf.TerraformResource {
  ...
  */
  ...
  private _condition = new GoogleCloudAssetOrganizationFeedConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleCloudAssetOrganizationFeedCondition) {
  ...
  private _feedOutputConfig = new GoogleCloudAssetOrganizationFeedFeedOutputConfigOutputReference(this, "feed_output_config");
  public get feedOutputConfig() {
    return this._feedOutputConfig;
  }
  public putFeedOutputConfig(value: GoogleCloudAssetOrganizationFeedFeedOutputConfig) {
  ...
  private _timeouts = new GoogleCloudAssetOrganizationFeedTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleCloudAssetOrganizationFeedTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleCloudAssetOrganizationFeedConditionToTerraform(this._condition.internalValue),
