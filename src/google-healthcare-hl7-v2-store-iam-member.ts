// https://www.terraform.io/docs/providers/google-beta/r/google_healthcare_hl7_v2_store_iam_member
...
export function googleHealthcareHl7V2StoreIamMemberConditionToTerraform(struct?: GoogleHealthcareHl7V2StoreIamMemberConditionOutputReference | GoogleHealthcareHl7V2StoreIamMemberCondition): any {
...
export class GoogleHealthcareHl7V2StoreIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleHealthcareHl7V2StoreIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleHealthcareHl7V2StoreIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleHealthcareHl7V2StoreIamMember extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleHealthcareHl7V2StoreIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleHealthcareHl7V2StoreIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleHealthcareHl7V2StoreIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleHealthcareHl7V2StoreIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
