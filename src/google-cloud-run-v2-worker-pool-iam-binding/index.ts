...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.38.0/docs/resources/google_cloud_run_v2_worker_pool_iam_binding
...
export class GoogleCloudRunV2WorkerPoolIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleCloudRunV2WorkerPoolIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.38.0/docs/resources/google_cloud_run_v2_worker_pool_iam_binding#import import section} in the documentation of this resource for the id to use
