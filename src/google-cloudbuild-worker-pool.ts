// https://www.terraform.io/docs/providers/google-beta/r/google_cloudbuild_worker_pool
...
export function googleCloudbuildWorkerPoolTimeoutsToTerraform(struct?: GoogleCloudbuildWorkerPoolTimeoutsOutputReference | GoogleCloudbuildWorkerPoolTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCloudbuildWorkerPoolTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudbuildWorkerPoolTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudbuildWorkerPoolTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
