...
export class GoogleProjectOrganizationPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleProjectOrganizationPolicyTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleProjectOrganizationPolicyTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
