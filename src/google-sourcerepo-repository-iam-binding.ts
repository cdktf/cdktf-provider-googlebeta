// https://www.terraform.io/docs/providers/google-beta/r/google_sourcerepo_repository_iam_binding
...
export function googleSourcerepoRepositoryIamBindingConditionToTerraform(struct?: GoogleSourcerepoRepositoryIamBindingConditionOutputReference | GoogleSourcerepoRepositoryIamBindingCondition): any {
...
export class GoogleSourcerepoRepositoryIamBindingConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSourcerepoRepositoryIamBindingCondition | undefined {
  ...
  public set internalValue(value: GoogleSourcerepoRepositoryIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleSourcerepoRepositoryIamBinding extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleSourcerepoRepositoryIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleSourcerepoRepositoryIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleSourcerepoRepositoryIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleSourcerepoRepositoryIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
}
