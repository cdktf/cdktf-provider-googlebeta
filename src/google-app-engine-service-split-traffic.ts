...
export class GoogleAppEngineServiceSplitTrafficTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleAppEngineServiceSplitTrafficTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleAppEngineServiceSplitTrafficTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
