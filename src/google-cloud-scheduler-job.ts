// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_scheduler_job
...
export interface GoogleCloudSchedulerJobAppEngineHttpTargetAppEngineRouting {
  /**
  * App instance.
...
export class GoogleCloudSchedulerJobAppEngineHttpTargetAppEngineRoutingOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudSchedulerJobAppEngineHttpTargetAppEngineRouting | undefined {
  ...
  public set internalValue(value: GoogleCloudSchedulerJobAppEngineHttpTargetAppEngineRouting | undefined) {
    if (value === undefined) {
...
export interface GoogleCloudSchedulerJobAppEngineHttpTarget {
  /**
  * HTTP request body. 
...
export class GoogleCloudSchedulerJobAppEngineHttpTargetOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudSchedulerJobAppEngineHttpTarget | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudSchedulerJobAppEngineHttpTarget | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _appEngineRouting = new GoogleCloudSchedulerJobAppEngineHttpTargetAppEngineRoutingOutputReference(this, "app_engine_routing");
  public get appEngineRouting() {
    return this._appEngineRouting;
  }
  public putAppEngineRouting(value: GoogleCloudSchedulerJobAppEngineHttpTargetAppEngineRouting) {
...
export interface GoogleCloudSchedulerJobHttpTargetOauthToken {
  /**
...
export class GoogleCloudSchedulerJobHttpTargetOauthTokenOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudSchedulerJobHttpTargetOauthToken | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudSchedulerJobHttpTargetOauthToken | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleCloudSchedulerJobHttpTargetOidcToken {
  /**
...
export class GoogleCloudSchedulerJobHttpTargetOidcTokenOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudSchedulerJobHttpTargetOidcToken | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudSchedulerJobHttpTargetOidcToken | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleCloudSchedulerJobHttpTarget {
  /**
  * HTTP request body. 
...
export class GoogleCloudSchedulerJobHttpTargetOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudSchedulerJobHttpTarget | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._body !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: GoogleCloudSchedulerJobHttpTarget | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._body = undefined;
      this._headers = undefined;
  ...
  private _oauthToken = new GoogleCloudSchedulerJobHttpTargetOauthTokenOutputReference(this, "oauth_token");
  public get oauthToken() {
    return this._oauthToken;
  }
  public putOauthToken(value: GoogleCloudSchedulerJobHttpTargetOauthToken) {
  ...
  private _oidcToken = new GoogleCloudSchedulerJobHttpTargetOidcTokenOutputReference(this, "oidc_token");
  public get oidcToken() {
    return this._oidcToken;
  }
  public putOidcToken(value: GoogleCloudSchedulerJobHttpTargetOidcToken) {
...
export interface GoogleCloudSchedulerJobPubsubTarget {
  /**
...
export class GoogleCloudSchedulerJobPubsubTargetOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudSchedulerJobPubsubTarget | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudSchedulerJobPubsubTarget | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleCloudSchedulerJobRetryConfig {
  /**
...
export class GoogleCloudSchedulerJobRetryConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudSchedulerJobRetryConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudSchedulerJobRetryConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function googleCloudSchedulerJobTimeoutsToTerraform(struct?: GoogleCloudSchedulerJobTimeoutsOutputReference | GoogleCloudSchedulerJobTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCloudSchedulerJobTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudSchedulerJobTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudSchedulerJobTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleCloudSchedulerJob extends cdktf.TerraformResource {
  ...
  * @param options GoogleCloudSchedulerJobConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleCloudSchedulerJobConfig) {
    super(scope, id, {
  ...
  private _appEngineHttpTarget = new GoogleCloudSchedulerJobAppEngineHttpTargetOutputReference(this, "app_engine_http_target");
  public get appEngineHttpTarget() {
    return this._appEngineHttpTarget;
  }
  public putAppEngineHttpTarget(value: GoogleCloudSchedulerJobAppEngineHttpTarget) {
  ...
  private _httpTarget = new GoogleCloudSchedulerJobHttpTargetOutputReference(this, "http_target");
  public get httpTarget() {
    return this._httpTarget;
  }
  public putHttpTarget(value: GoogleCloudSchedulerJobHttpTarget) {
  ...
  private _pubsubTarget = new GoogleCloudSchedulerJobPubsubTargetOutputReference(this, "pubsub_target");
  public get pubsubTarget() {
    return this._pubsubTarget;
  }
  public putPubsubTarget(value: GoogleCloudSchedulerJobPubsubTarget) {
  ...
  private _retryConfig = new GoogleCloudSchedulerJobRetryConfigOutputReference(this, "retry_config");
  public get retryConfig() {
    return this._retryConfig;
  }
  public putRetryConfig(value: GoogleCloudSchedulerJobRetryConfig) {
  ...
  private _timeouts = new GoogleCloudSchedulerJobTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleCloudSchedulerJobTimeouts) {
