// https://www.terraform.io/docs/providers/google-beta/r/google_compute_target_https_proxy
...
export function googleComputeTargetHttpsProxyTimeoutsToTerraform(struct?: GoogleComputeTargetHttpsProxyTimeoutsOutputReference | GoogleComputeTargetHttpsProxyTimeouts | cdktf.IResolvable): any {
...
export class GoogleComputeTargetHttpsProxyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeTargetHttpsProxyTimeouts | undefined {
  ...
  public set internalValue(value: GoogleComputeTargetHttpsProxyTimeouts | undefined) {
    if (value === undefined) {
...
export class GoogleComputeTargetHttpsProxy extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeTargetHttpsProxyConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleComputeTargetHttpsProxyTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleComputeTargetHttpsProxyTimeouts) {
