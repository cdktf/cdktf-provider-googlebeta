...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.16.0/docs/resources/google_compute_http_health_check
...
export interface GoogleComputeHttpHealthCheckConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly timeouts?: GoogleComputeHttpHealthCheckTimeouts;
}
export interface GoogleComputeHttpHealthCheckTimeouts {
  /**
...
export class GoogleComputeHttpHealthCheck extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeHttpHealthCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.16.0/docs/resources/google_compute_http_health_check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.16.0/docs/resources/google_compute_http_health_check google_compute_http_health_check} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleComputeHttpHealthCheckConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeHttpHealthCheckConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleComputeHttpHealthCheckTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleComputeHttpHealthCheckTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleComputeHttpHealthCheckTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleComputeHttpHealthCheckTimeouts",
      },
    };
