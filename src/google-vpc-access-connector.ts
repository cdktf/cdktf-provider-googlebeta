// https://www.terraform.io/docs/providers/google-beta/r/google_vpc_access_connector
...
export class GoogleVpcAccessConnectorSubnetOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleVpcAccessConnectorSubnet | undefined {
  ...
  public set internalValue(value: GoogleVpcAccessConnectorSubnet | undefined) {
    if (value === undefined) {
...
export function googleVpcAccessConnectorTimeoutsToTerraform(struct?: GoogleVpcAccessConnectorTimeoutsOutputReference | GoogleVpcAccessConnectorTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleVpcAccessConnectorTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleVpcAccessConnectorTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleVpcAccessConnectorTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleVpcAccessConnector extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleVpcAccessConnectorConfig) {
    super(scope, id, {
  ...
  private _subnet = new GoogleVpcAccessConnectorSubnetOutputReference(this, "subnet");
  public get subnet() {
    return this._subnet;
  }
  public putSubnet(value: GoogleVpcAccessConnectorSubnet) {
  ...
  private _timeouts = new GoogleVpcAccessConnectorTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleVpcAccessConnectorTimeouts) {
