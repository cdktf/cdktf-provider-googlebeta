...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_data_catalog_taxonomy_iam_member
...
export interface GoogleDataCatalogTaxonomyIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleDataCatalogTaxonomyIamMemberCondition;
}
export interface GoogleDataCatalogTaxonomyIamMemberCondition {
  /**
...
export function googleDataCatalogTaxonomyIamMemberConditionToTerraform(struct?: GoogleDataCatalogTaxonomyIamMemberConditionOutputReference | GoogleDataCatalogTaxonomyIamMemberCondition): any {
...
export function googleDataCatalogTaxonomyIamMemberConditionToHclTerraform(struct?: GoogleDataCatalogTaxonomyIamMemberConditionOutputReference | GoogleDataCatalogTaxonomyIamMemberCondition): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleDataCatalogTaxonomyIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataCatalogTaxonomyIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleDataCatalogTaxonomyIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleDataCatalogTaxonomyIamMember extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleDataCatalogTaxonomyIamMember to import
  * @param importFromId The id of the existing GoogleDataCatalogTaxonomyIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_data_catalog_taxonomy_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.25.0/docs/resources/google_data_catalog_taxonomy_iam_member google_data_catalog_taxonomy_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleDataCatalogTaxonomyIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleDataCatalogTaxonomyIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleDataCatalogTaxonomyIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleDataCatalogTaxonomyIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleDataCatalogTaxonomyIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleDataCatalogTaxonomyIamMemberConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleDataCatalogTaxonomyIamMemberConditionList",
      },
    };
