// https://www.terraform.io/docs/providers/google-beta/r/google_bigquery_job
...
export function googleBigqueryJobCopyToTerraform(struct?: GoogleBigqueryJobCopyOutputReference | GoogleBigqueryJobCopy): any {
  ...
  return {
    ...
    source_tables: cdktf.listMapper(googleBigqueryJobCopySourceTablesToTerraform)(struct!.sourceTables),
  }
}
...
export class GoogleBigqueryJobCopyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _sourceTables?: GoogleBigqueryJobCopySourceTables[] | cdktf.IResolvable; 
  public get sourceTables() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('source_tables');
  }
  public set sourceTables(value: GoogleBigqueryJobCopySourceTables[] | cdktf.IResolvable) {
...
export function googleBigqueryJobQueryToTerraform(struct?: GoogleBigqueryJobQueryOutputReference | GoogleBigqueryJobQuery): any {
  ...
  return {
    ...
    user_defined_function_resources: cdktf.listMapper(googleBigqueryJobQueryUserDefinedFunctionResourcesToTerraform)(struct!.userDefinedFunctionResources),
  }
}
...
export class GoogleBigqueryJobQueryOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _userDefinedFunctionResources?: GoogleBigqueryJobQueryUserDefinedFunctionResources[] | cdktf.IResolvable; 
  public get userDefinedFunctionResources() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('user_defined_function_resources');
  }
  public set userDefinedFunctionResources(value: GoogleBigqueryJobQueryUserDefinedFunctionResources[] | cdktf.IResolvable) {
...
export function googleBigqueryJobTimeoutsToTerraform(struct?: GoogleBigqueryJobTimeoutsOutputReference | GoogleBigqueryJobTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleBigqueryJobTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigqueryJobTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleBigqueryJobTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
