// https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_sql_user
...
export class GoogleSqlUserPasswordPolicyStatusOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSqlUserPasswordPolicyStatus | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleSqlUserPasswordPolicyStatus | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class GoogleSqlUserPasswordPolicyStatusList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleSqlUserPasswordPolicyStatusOutputReference {
    return new GoogleSqlUserPasswordPolicyStatusOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleSqlUserPasswordPolicyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSqlUserPasswordPolicy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleSqlUserPasswordPolicy | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _status = new GoogleSqlUserPasswordPolicyStatusList(this, "status", false);
  public get status() {
    return this._status;
  }
}
...
export class GoogleSqlUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleSqlUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_sql_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_sql_user google_sql_user} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _passwordPolicy = new GoogleSqlUserPasswordPolicyOutputReference(this, "password_policy");
  public get passwordPolicy() {
    return this._passwordPolicy;
  }
  public putPasswordPolicy(value: GoogleSqlUserPasswordPolicy) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      password_policy: {
        value: googleSqlUserPasswordPolicyToHclTerraform(this._passwordPolicy.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleSqlUserPasswordPolicyList",
      },
      timeouts: {
        value: googleSqlUserTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleSqlUserTimeouts",
      },
    };
