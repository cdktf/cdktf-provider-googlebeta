...
export class GoogleBigtableInstance extends cdktf.TerraformResource {
  ...
  */
  ...
  private _cluster?: GoogleBigtableInstanceCluster[] | cdktf.IResolvable; 
  public get cluster() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('cluster');
  }
  public set cluster(value: GoogleBigtableInstanceCluster[] | cdktf.IResolvable) {
    this._cluster = value;
  }
  public resetCluster() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      cluster: cdktf.listMapper(googleBigtableInstanceClusterToTerraform)(this._cluster),
    };
  }
}
