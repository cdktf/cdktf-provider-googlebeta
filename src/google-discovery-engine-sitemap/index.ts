// https://registry.terraform.io/providers/hashicorp/google-beta/6.28.0/docs/resources/google_discovery_engine_sitemap
...
export class GoogleDiscoveryEngineSitemap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDiscoveryEngineSitemap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.28.0/docs/resources/google_discovery_engine_sitemap#import import section} in the documentation of this resource for the id to use
