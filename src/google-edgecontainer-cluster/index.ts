...
// https://registry.terraform.io/providers/hashicorp/google-beta/5.37.0/docs/resources/google_edgecontainer_cluster
...
export class GoogleEdgecontainerCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleEdgecontainerCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.37.0/docs/resources/google_edgecontainer_cluster#import import section} in the documentation of this resource for the id to use
