...
export class GoogleStorageBucketTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleStorageBucketTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleStorageBucketTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleStorageBucket extends cdktf.TerraformResource {
  ...
  */
  ...
  private _cors?: GoogleStorageBucketCors[] | cdktf.IResolvable; 
  public get cors() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('cors');
  }
  public set cors(value: GoogleStorageBucketCors[] | cdktf.IResolvable) {
    this._cors = value;
  }
  public resetCors() {
  ...
  private _lifecycleRule?: GoogleStorageBucketLifecycleRule[] | cdktf.IResolvable; 
  public get lifecycleRule() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('lifecycle_rule');
  }
  public set lifecycleRule(value: GoogleStorageBucketLifecycleRule[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      cors: cdktf.listMapper(googleStorageBucketCorsToTerraform)(this._cors),
      encryption: googleStorageBucketEncryptionToTerraform(this._encryption.internalValue),
      lifecycle_rule: cdktf.listMapper(googleStorageBucketLifecycleRuleToTerraform)(this._lifecycleRule),
