...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_memorystore_instance
...
export class GoogleMemorystoreInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleMemorystoreInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_memorystore_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_memorystore_instance google_memorystore_instance} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleMemorystoreInstanceConfig) {
    ...
    this._allowFewerZonesDeployment = config.allowFewerZonesDeployment;
  ...
  public resetAllowFewerZonesDeployment() {
    this._allowFewerZonesDeployment = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get allowFewerZonesDeploymentInput() {
    return this._allowFewerZonesDeployment;
  }
