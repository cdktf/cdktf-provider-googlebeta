// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_tasks_queue
...
export function googleCloudTasksQueueTimeoutsToTerraform(struct?: GoogleCloudTasksQueueTimeoutsOutputReference | GoogleCloudTasksQueueTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCloudTasksQueueTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudTasksQueueTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudTasksQueueTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
