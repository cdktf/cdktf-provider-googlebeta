// https://registry.terraform.io/providers/hashicorp/google-beta/5.32.0/docs/data-sources/google_filestore_instance
...
export class DataGoogleFilestoreInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleFilestoreInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.32.0/docs/data-sources/google_filestore_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.32.0/docs/data-sources/google_filestore_instance google_filestore_instance} Data Source
  *
  * @param scope The scope in which to define this construct
