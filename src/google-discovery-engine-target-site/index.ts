// https://registry.terraform.io/providers/hashicorp/google-beta/6.19.0/docs/resources/google_discovery_engine_target_site
...
export interface GoogleDiscoveryEngineTargetSiteConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly timeouts?: GoogleDiscoveryEngineTargetSiteTimeouts;
}
export interface GoogleDiscoveryEngineTargetSiteFailureReasonQuotaFailure {
}
...
export class GoogleDiscoveryEngineTargetSiteFailureReasonQuotaFailureOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDiscoveryEngineTargetSiteFailureReasonQuotaFailure | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleDiscoveryEngineTargetSiteFailureReasonQuotaFailure | undefined) {
    if (value === undefined) {
...
export class GoogleDiscoveryEngineTargetSiteFailureReasonQuotaFailureList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleDiscoveryEngineTargetSiteFailureReasonQuotaFailureOutputReference {
    return new GoogleDiscoveryEngineTargetSiteFailureReasonQuotaFailureOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleDiscoveryEngineTargetSiteFailureReason {
}
...
export class GoogleDiscoveryEngineTargetSiteFailureReasonOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDiscoveryEngineTargetSiteFailureReason | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleDiscoveryEngineTargetSiteFailureReason | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _quotaFailure = new GoogleDiscoveryEngineTargetSiteFailureReasonQuotaFailureList(this, "quota_failure", false);
...
export class GoogleDiscoveryEngineTargetSiteFailureReasonList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleDiscoveryEngineTargetSiteFailureReasonOutputReference {
    return new GoogleDiscoveryEngineTargetSiteFailureReasonOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleDiscoveryEngineTargetSiteSiteVerificationInfo {
}
...
export class GoogleDiscoveryEngineTargetSiteSiteVerificationInfoOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDiscoveryEngineTargetSiteSiteVerificationInfo | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleDiscoveryEngineTargetSiteSiteVerificationInfo | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class GoogleDiscoveryEngineTargetSiteSiteVerificationInfoList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleDiscoveryEngineTargetSiteSiteVerificationInfoOutputReference {
    return new GoogleDiscoveryEngineTargetSiteSiteVerificationInfoOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleDiscoveryEngineTargetSiteTimeouts {
  /**
...
export class GoogleDiscoveryEngineTargetSite extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDiscoveryEngineTargetSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.19.0/docs/resources/google_discovery_engine_target_site#import import section} in the documentation of this resource for the id to use
  ...
  * @param options GoogleDiscoveryEngineTargetSiteConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleDiscoveryEngineTargetSiteConfig) {
    super(scope, id, {
  ...
  private _failureReason = new GoogleDiscoveryEngineTargetSiteFailureReasonList(this, "failure_reason", false);
  ...
  private _siteVerificationInfo = new GoogleDiscoveryEngineTargetSiteSiteVerificationInfoList(this, "site_verification_info", false);
  ...
  private _timeouts = new GoogleDiscoveryEngineTargetSiteTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleDiscoveryEngineTargetSiteTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleDiscoveryEngineTargetSiteTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleDiscoveryEngineTargetSiteTimeouts",
      },
    };
