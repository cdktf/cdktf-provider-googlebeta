...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_scc_v2_folder_scc_big_query_export
...
export class GoogleSccV2FolderSccBigQueryExport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleSccV2FolderSccBigQueryExport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_scc_v2_folder_scc_big_query_export#import import section} in the documentation of this resource for the id to use
