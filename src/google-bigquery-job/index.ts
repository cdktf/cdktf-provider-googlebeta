// https://registry.terraform.io/providers/hashicorp/google-beta/5.33.0/docs/resources/google_bigquery_job
...
export class GoogleBigqueryJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleBigqueryJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.33.0/docs/resources/google_bigquery_job#import import section} in the documentation of this resource for the id to use
