...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership
...
export interface GoogleCloudIdentityGroupMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#create_ignore_already_exists GoogleCloudIdentityGroupMembership#create_ignore_already_exists}
  */
  readonly createIgnoreAlreadyExists?: boolean | cdktf.IResolvable;
  /**
  * The name of the Group to create this membership in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#group GoogleCloudIdentityGroupMembership#group}
  */
  readonly group: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#id GoogleCloudIdentityGroupMembership#id}
  *
  ...
  * member_key block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#member_key GoogleCloudIdentityGroupMembership#member_key}
  */
  readonly memberKey?: GoogleCloudIdentityGroupMembershipMemberKey;
  /**
  * preferred_member_key block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#preferred_member_key GoogleCloudIdentityGroupMembership#preferred_member_key}
  */
  readonly preferredMemberKey?: GoogleCloudIdentityGroupMembershipPreferredMemberKey;
  /**
  * roles block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#roles GoogleCloudIdentityGroupMembership#roles}
  */
  readonly roles: GoogleCloudIdentityGroupMembershipRoles[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#timeouts GoogleCloudIdentityGroupMembership#timeouts}
  */
...
export interface GoogleCloudIdentityGroupMembershipMemberKey {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#namespace GoogleCloudIdentityGroupMembership#namespace}
  */
...
export interface GoogleCloudIdentityGroupMembershipRolesExpiryDetail {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#expire_time GoogleCloudIdentityGroupMembership#expire_time}
  */
...
export class GoogleCloudIdentityGroupMembershipRolesExpiryDetailOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleCloudIdentityGroupMembershipRolesExpiryDetail | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleCloudIdentityGroupMembershipRolesExpiryDetail | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleCloudIdentityGroupMembershipRoles {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#name GoogleCloudIdentityGroupMembership#name}
  */
  readonly name: string;
  /**
  * expiry_detail block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#expiry_detail GoogleCloudIdentityGroupMembership#expiry_detail}
  */
...
export function googleCloudIdentityGroupMembershipRolesToHclTerraform(struct?: GoogleCloudIdentityGroupMembershipRoles | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    expiry_detail: {
      value: googleCloudIdentityGroupMembershipRolesExpiryDetailToHclTerraform(struct!.expiryDetail),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleCloudIdentityGroupMembershipRolesExpiryDetailList",
    },
  };
...
export class GoogleCloudIdentityGroupMembershipRolesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _expiryDetail = new GoogleCloudIdentityGroupMembershipRolesExpiryDetailOutputReference(this, "expiry_detail");
  public get expiryDetail() {
    return this._expiryDetail;
  }
  public putExpiryDetail(value: GoogleCloudIdentityGroupMembershipRolesExpiryDetail) {
...
export interface GoogleCloudIdentityGroupMembershipTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#create GoogleCloudIdentityGroupMembership#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#delete GoogleCloudIdentityGroupMembership#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#update GoogleCloudIdentityGroupMembership#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership google_cloud_identity_group_membership}
*/
export class GoogleCloudIdentityGroupMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleCloudIdentityGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.49.1/docs/resources/google_cloud_identity_group_membership google_cloud_identity_group_membership} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      member_key: {
        value: googleCloudIdentityGroupMembershipMemberKeyToHclTerraform(this._memberKey.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleCloudIdentityGroupMembershipMemberKeyList",
      },
      preferred_member_key: {
        value: googleCloudIdentityGroupMembershipPreferredMemberKeyToHclTerraform(this._preferredMemberKey.internalValue),
        isBlock: true,
        type: "list",
      ...
      timeouts: {
        value: googleCloudIdentityGroupMembershipTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleCloudIdentityGroupMembershipTimeouts",
      },
    };
