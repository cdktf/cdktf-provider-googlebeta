...
export class GoogleAccessContextManagerServicePerimeterResourceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleAccessContextManagerServicePerimeterResourceTimeouts | undefined {
  ...
  public set internalValue(value: GoogleAccessContextManagerServicePerimeterResourceTimeouts | undefined) {
    if (value === undefined) {
