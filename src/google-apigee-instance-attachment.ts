...
export class GoogleApigeeInstanceAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleApigeeInstanceAttachmentTimeouts | undefined {
  ...
  public set internalValue(value: GoogleApigeeInstanceAttachmentTimeouts | undefined) {
    if (value === undefined) {
