...
export interface GoogleRedisInstancePersistenceConfig {
  /**
...
export function googleRedisInstancePersistenceConfigToTerraform(struct?: GoogleRedisInstancePersistenceConfigOutputReference | GoogleRedisInstancePersistenceConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleRedisInstancePersistenceConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleRedisInstancePersistenceConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleRedisInstancePersistenceConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleRedisInstance extends cdktf.TerraformResource {
  ...
  */
  ...
  private _persistenceConfig = new GoogleRedisInstancePersistenceConfigOutputReference(this, "persistence_config");
  public get persistenceConfig() {
    return this._persistenceConfig;
  }
  public putPersistenceConfig(value: GoogleRedisInstancePersistenceConfig) {
