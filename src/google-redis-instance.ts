...
export class GoogleRedisInstanceMaintenancePolicyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _weeklyMaintenanceWindow?: GoogleRedisInstanceMaintenancePolicyWeeklyMaintenanceWindow[] | cdktf.IResolvable; 
  public get weeklyMaintenanceWindow() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('weekly_maintenance_window');
  }
  public set weeklyMaintenanceWindow(value: GoogleRedisInstanceMaintenancePolicyWeeklyMaintenanceWindow[] | cdktf.IResolvable) {
...
export class GoogleRedisInstanceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleRedisInstanceTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleRedisInstanceTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
