// https://www.terraform.io/docs/providers/google-beta/r/google_billing_account_iam_member
...
export interface GoogleBillingAccountIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleBillingAccountIamMemberCondition;
}
export interface GoogleBillingAccountIamMemberCondition {
  /**
...
export function googleBillingAccountIamMemberConditionToTerraform(struct?: GoogleBillingAccountIamMemberConditionOutputReference | GoogleBillingAccountIamMemberCondition): any {
...
export class GoogleBillingAccountIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBillingAccountIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleBillingAccountIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleBillingAccountIamMember extends cdktf.TerraformResource {
  ...
  * @param options GoogleBillingAccountIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleBillingAccountIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleBillingAccountIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleBillingAccountIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleBillingAccountIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
