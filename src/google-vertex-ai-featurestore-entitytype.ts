...
export class GoogleVertexAiFeaturestoreEntitytypeTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleVertexAiFeaturestoreEntitytypeTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleVertexAiFeaturestoreEntitytypeTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
